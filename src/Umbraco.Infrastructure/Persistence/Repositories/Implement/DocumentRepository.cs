...
public class DocumentRepository : ContentRepositoryBase<int, IContent, DocumentRepository>, IDocumentRepository
{
    ...
    protected override void PersistNewItem(IContent entity)
    {
        ...
        var calculateSortOrder = (entity is { HasIdentity: false, SortOrder: 0 } && entity.IsPropertyDirty(nameof(entity.SortOrder)) == false) // SortOrder was not updated from it's default value
