...
public class NodeDto
{
    ...
    [Index(IndexTypes.NonClustered, Name = "IX_" + TableName + "_ParentId", ForColumns = "parentID,nodeObjectType", IncludeColumns = "trashed,nodeUser,level,path,sortOrder,uniqueID,text,createDate")]
