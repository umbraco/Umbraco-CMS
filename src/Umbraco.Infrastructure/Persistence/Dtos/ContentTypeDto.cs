...
internal class ContentTypeDto
{
    ...
    [Index(IndexTypes.NonClustered, Name = "IX_cmsContentType_nodeId", IncludeColumns = "nodeId", ForColumns = "alias,icon,thumbnail,isContainer,variations,allowAtRoot,isElement")]
