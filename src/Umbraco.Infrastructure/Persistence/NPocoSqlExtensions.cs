...
public static class NPocoSqlExtensions
{
    ...
    /// <returns>The Sql statement.</returns>
    public static Sql<ISqlContext> Where<TDto1, TDto2>(this Sql<ISqlContext> sql,
        Expression<Func<TDto1, TDto2, bool>> predicate, string? alias1 = null, string? alias2 = null)
    {
    ...
    /// <returns>The Sql statement.</returns>
    public static Sql<ISqlContext> WhereIn<TDto>(this Sql<ISqlContext> sql, Expression<Func<TDto, object?>> field,
        IEnumerable? values)
    {
    ...
    /// <returns>The Sql statement.</returns>
    public static Sql<ISqlContext> WhereIn<TDto>(this Sql<ISqlContext> sql, Expression<Func<TDto, object?>> field,
        Sql<ISqlContext>? values) => WhereIn(sql, field, values, false, null);

    public static Sql<ISqlContext> WhereIn<TDto>(this Sql<ISqlContext> sql, Expression<Func<TDto, object?>> field,
        Sql<ISqlContext>? values, string tableAlias) => sql.WhereIn(field, values, false, tableAlias);


    public static Sql<ISqlContext> WhereLike<TDto>(this Sql<ISqlContext> sql,
        Expression<Func<TDto, object?>> fieldSelector, Sql<ISqlContext>? valuesSql)
    {
    ...
    public static Sql<ISqlContext> WhereLike<TDto>(this Sql<ISqlContext> sql,
        Expression<Func<TDto, object?>> fieldSelector, string likeValue)
    {
        var fieldName = sql.SqlContext.SqlSyntax.GetFieldName(fieldSelector);
    ...
    /// <param name="values">The values.</param>
    /// <returns>The Sql statement.</returns>
    public static Sql<ISqlContext> WhereNotIn<TDto>(this Sql<ISqlContext> sql, Expression<Func<TDto, object?>> field,
        IEnumerable values)
    {
        var fieldName = sql.SqlContext.SqlSyntax.GetFieldName(field);
    ...
    /// <returns>The Sql statement.</returns>
    public static Sql<ISqlContext> WhereNotIn<TDto>(this Sql<ISqlContext> sql, Expression<Func<TDto, object?>> field,
        Sql<ISqlContext> values) => sql.WhereIn(field, values, true);
    ...
    /// <param name="values">The values.</param>
    /// <returns>The Sql statement.</returns>
    public static Sql WhereAnyIn<TDto>(this Sql<ISqlContext> sql, Expression<Func<TDto, object?>>[] fields,
        IEnumerable values)
    {
    ...
    private static Sql<ISqlContext> WhereIn<T>(this Sql<ISqlContext> sql, Expression<Func<T, object?>> fieldSelector,
        Sql? valuesSql, bool not) => WhereIn(sql, fieldSelector, valuesSql, not, null);

    private static Sql<ISqlContext> WhereIn<T>(this Sql<ISqlContext> sql, Expression<Func<T, object?>> fieldSelector,
        Sql? valuesSql, bool not, string? tableAlias)
    {
    ...
    /// <returns>The Sql statement.</returns>
    public static Sql<ISqlContext> WhereAny(this Sql<ISqlContext> sql,
        params Func<Sql<ISqlContext>, Sql<ISqlContext>>[] predicates)
    {
    ...
    /// <returns>The Sql statement.</returns>
    public static Sql<ISqlContext> WhereNotNull<TDto>(this Sql<ISqlContext> sql, Expression<Func<TDto, object?>> field,
        string? tableAlias = null) => sql.WhereNull(field, tableAlias, true);
    ...
    /// <returns>The Sql statement.</returns>
    public static Sql<ISqlContext> WhereNull<TDto>(this Sql<ISqlContext> sql, Expression<Func<TDto, object?>> field,
        string? tableAlias = null, bool not = false)
    {
    ...
    public static Sql<ISqlContext> OrderBy<TDto>(this Sql<ISqlContext> sql, Expression<Func<TDto, object?>> field) =>
        sql.OrderBy("(" + sql.SqlContext.SqlSyntax.GetFieldName(field) + ")");
    ...
    /// <returns>The Sql statement.</returns>
    public static Sql<ISqlContext> OrderBy<TDto>(this Sql<ISqlContext> sql,
    ...
    /// <param name="field">An expression specifying the field.</param>
    /// <returns>The Sql statement.</returns>
    public static Sql<ISqlContext> OrderByDescending<TDto>(this Sql<ISqlContext> sql,
        Expression<Func<TDto, object?>> field) => sql.OrderByDescending(sql.SqlContext.SqlSyntax.GetFieldName(field));
    ...
    public static Sql<ISqlContext> OrderByDescending(this Sql<ISqlContext> sql, params string?[] fields) =>
        sql.Append("ORDER BY " + string.Join(", ", fields.Select(x => x + " DESC")));
    ...
    public static Sql<ISqlContext> GroupBy<TDto>(this Sql<ISqlContext> sql, Expression<Func<TDto, object?>> field) =>
        sql.GroupBy(sql.SqlContext.SqlSyntax.GetFieldName(field));
    ...
    /// <param name="fields">Expression specifying the fields.</param>
    /// <returns>The Sql statement.</returns>
    public static Sql<ISqlContext> GroupBy<TDto>(this Sql<ISqlContext> sql,
        params Expression<Func<TDto, object?>>[] fields)
    {
        ISqlSyntaxProvider sqlSyntax = sql.SqlContext.SqlSyntax;
        var columns = fields.Length == 0
    ...
    /// <param name="fields">Expressions specifying the fields.</param>
    /// <returns>The Sql statement.</returns>
    public static Sql<ISqlContext> AndBy<TDto>(this Sql<ISqlContext> sql,
        params Expression<Func<TDto, object?>>[] fields)
    {
        ISqlSyntaxProvider sqlSyntax = sql.SqlContext.SqlSyntax;
        var columns = fields.Length == 0
    ...
    /// <param name="fields">Expressions specifying the fields.</param>
    /// <returns>The Sql statement.</returns>
    public static Sql<ISqlContext> AndByDescending<TDto>(this Sql<ISqlContext> sql,
        params Expression<Func<TDto, object?>>[] fields)
    {
        ISqlSyntaxProvider sqlSyntax = sql.SqlContext.SqlSyntax;
        var columns = fields.Length == 0
    ...
    public static Sql<ISqlContext>.SqlJoinClause<ISqlContext> InnerJoin<TDto>(this Sql<ISqlContext> sql,
        string? alias = null)
    {
        Type type = typeof(TDto);
        var tableName = type.GetTableName();
    ...
    /// <param name="alias">An optional alias for the joined table.</param>
    /// <returns>A SqlJoin statement.</returns>
    public static Sql<ISqlContext>.SqlJoinClause<ISqlContext> InnerJoin(this Sql<ISqlContext> sql,
        Sql<ISqlContext> nestedSelect, string? alias = null)
    {
    ...
    /// <param name="alias">An optional alias for the joined table.</param>
    /// <returns>A SqlJoin statement.</returns>
    public static Sql<ISqlContext>.SqlJoinClause<ISqlContext> LeftJoin<TDto>(this Sql<ISqlContext> sql,
        string? alias = null)
    {
        Type type = typeof(TDto);
        var tableName = type.GetTableName();
    ...
    /// <param name="alias">An optional alias for the joined table.</param>
    /// <returns>A SqlJoin statement.</returns>
    public static Sql<ISqlContext>.SqlJoinClause<ISqlContext> LeftJoin(this Sql<ISqlContext> sql,
        Sql<ISqlContext> nestedSelect, string? alias = null)
    {
        var join = $"({nestedSelect.SQL})";
        if (alias is not null)
    ...
    /// <param name="alias">An optional alias for the joined table.</param>
    /// <returns>A SqlJoin statement.</returns>
    public static Sql<ISqlContext>.SqlJoinClause<ISqlContext> RightJoin<TDto>(this Sql<ISqlContext> sql,
        string? alias = null)
    {
        Type type = typeof(TDto);
        var tableName = type.GetTableName();
    ...
    /// <returns>The Sql statement.</returns>
    public static Sql<ISqlContext> On(this Sql<ISqlContext>.SqlJoinClause<ISqlContext> sqlJoin,
    ...
    /// <returns>The Sql statement.</returns>
    public static Sql<ISqlContext> On<TDto1, TDto2>(this Sql<ISqlContext>.SqlJoinClause<ISqlContext> sqlJoin,
        Expression<Func<TDto1, TDto2, bool>> predicate, string? aliasLeft = null, string? aliasRight = null)
    {
    ...
    /// <returns>The Sql statement.</returns>
    public static Sql<ISqlContext> On<TDto1, TDto2, TDto3>(this Sql<ISqlContext>.SqlJoinClause<ISqlContext> sqlJoin,
        Expression<Func<TDto1, TDto2, TDto3, bool>> predicate, string? aliasLeft = null, string? aliasRight = null,
        string? aliasOther = null)
    {
        var expresionist =
            new PocoToSqlExpressionVisitor<TDto1, TDto2, TDto3>(sqlJoin.SqlContext, aliasLeft, aliasRight, aliasOther);
        var onExpression = expresionist.Visit(predicate);
        return sqlJoin.On(onExpression, expresionist.GetSqlParameters());
    }
    ...
    /// </remarks>
    public static Sql<ISqlContext> SelectCount<TDto>(this Sql<ISqlContext> sql,
        params Expression<Func<TDto, object?>>[] fields)
    ...
    ///     <para>If <paramref name="fields" /> is empty, all columns are counted.</para>
    /// </remarks>
    public static Sql<ISqlContext> SelectCount<TDto>(this Sql<ISqlContext> sql, string? alias,
        params Expression<Func<TDto, object?>>[] fields)
    {
        if (sql == null)
        {
    ...
    /// </remarks>
    public static Sql<ISqlContext> Select<TDto>(this Sql<ISqlContext> sql,
        params Expression<Func<TDto, object?>>[] fields)
    {
        if (sql == null)
        {
    ...
    ///     <para>If <paramref name="fields" /> is empty, all columns are selected.</para>
    /// </remarks>
    public static Sql<ISqlContext> SelectDistinct<TDto>(this Sql<ISqlContext> sql,
        params Expression<Func<TDto, object?>>[] fields)
    {
        if (sql == null)
        {
    ...
    ///     <para>If <paramref name="fields" /> is empty, all columns are selected.</para>
    /// </remarks>
    public static Sql<ISqlContext> Select<TDto>(this Sql<ISqlContext> sql, string tableAlias,
        params Expression<Func<TDto, object?>>[] fields)
    {
        if (sql == null)
        {
        ...
        return sql.Select(sql.GetColumns(tableAlias, columnExpressions: fields));
    }
    ...
    ///     <para>If <paramref name="fields" /> is empty, all columns are selected.</para>
    /// </remarks>
    public static Sql<ISqlContext> AndSelect<TDto>(this Sql<ISqlContext> sql,
        params Expression<Func<TDto, object?>>[] fields)
    {
        if (sql == null)
        {
    ...
    ///     <para>If <paramref name="fields" /> is empty, all columns are selected.</para>
    /// </remarks>
    public static Sql<ISqlContext> AndSelect<TDto>(this Sql<ISqlContext> sql, string tableAlias,
        params Expression<Func<TDto, object?>>[] fields)
    {
        if (sql == null)
        {
        ...
        return sql.Append(", " + string.Join(", ", sql.GetColumns(tableAlias, columnExpressions: fields)));
    }
    ...
    ///     <para>If <paramref name="fields" /> is empty, all columns are counted.</para>
    /// </remarks>
    public static Sql<ISqlContext> AndSelectCount<TDto>(this Sql<ISqlContext> sql,
        params Expression<Func<TDto, object?>>[] fields)
    ...
    ///     <para>If <paramref name="fields" /> is empty, all columns are counted.</para>
    /// </remarks>
    public static Sql<ISqlContext> AndSelectCount<TDto>(this Sql<ISqlContext> sql, string? alias = null,
        params Expression<Func<TDto, object?>>[] fields)
    {
        if (sql == null)
        {
    ...
    /// <returns>The Sql statement.</returns>
    /// <remarks>
    ///     The <paramref name="sqlexpr" /> expression applies to the Sql statement before the reference selection
    ...
    public class SqlRef<TDto>
    {
        ...
        public SqlRef<TDto> Select<TRefDto>(Expression<Func<TDto, TRefDto>> field,
        ...
        /// </remarks>
        public SqlRef<TDto> Select<TRefDto>(Expression<Func<TDto, List<TRefDto>>> field,
            Func<SqlRef<TRefDto>, SqlRef<TRefDto>>? reference = null)
            => Select(field, null, reference);
        ...
        private SqlRef<TDto> Select<TRefDto>(PropertyInfo? propertyInfo, string? tableAlias,
            Func<SqlRef<TRefDto>, SqlRef<TRefDto>>? nested = null)
        {
    ...
    ///     Gets fields for a Dto.
    /// </summary>
    public static string ColumnsForInsert<TDto>(this Sql<ISqlContext> sql,
        params Expression<Func<TDto, object?>>[]? fields)
    {
        if (sql == null)
        {
    ...
    ///     <para>If <paramref name="fields" /> is empty, all fields are selected.</para>
    /// </remarks>
    public static string Columns<TDto>(this Sql<ISqlContext> sql, string alias,
        params Expression<Func<TDto, object?>>[] fields)
    {
        if (sql == null)
        {
    ...
    public class SqlUpd<TDto>
    {
        ...
        public SqlUpd(ISqlContext sqlContext) => _sqlContext = sqlContext;

        public List<Tuple<string, object?>> SetExpressions { get; } = new();
    ...
    private static string[] GetColumns<TDto>(this Sql<ISqlContext> sql, string? tableAlias = null,
        string? referenceName = null, Expression<Func<TDto, object?>>[]? columnExpressions = null,
        bool withAlias = true, bool forInsert = false)
    {
        ...
        string? GetAlias(PocoColumn column)
        {
            ...
            return withAlias
                ? string.IsNullOrEmpty(column.ColumnAlias) ? column.MemberInfoKey : column.ColumnAlias
                : null;
        }

        return queryColumns
            .Select(x => sql.SqlContext.SqlSyntax.GetColumn(sql.SqlContext.DatabaseType, tableName, x.Value.ColumnName,
                GetAlias(x.Value)!, referenceName, forInsert))
            .ToArray();
    }
    ...
    public static void ToText(this Sql sql, StringBuilder text) => ToText(sql.SQL, sql.Arguments, text);
