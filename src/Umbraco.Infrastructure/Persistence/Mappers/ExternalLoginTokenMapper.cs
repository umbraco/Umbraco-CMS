...
public sealed class ExternalLoginTokenMapper : BaseMapper
{
    ...
    {
        DefineMap<IdentityUserToken, ExternalLoginTokenDto>(nameof(IdentityUserToken.Id),
            nameof(ExternalLoginTokenDto.Id));
        DefineMap<IdentityUserToken, ExternalLoginTokenDto>(nameof(IdentityUserToken.CreateDate),
            nameof(ExternalLoginTokenDto.CreateDate));
        DefineMap<IdentityUserToken, ExternalLoginTokenDto>(nameof(IdentityUserToken.Name),
            nameof(ExternalLoginTokenDto.Name));
        DefineMap<IdentityUserToken, ExternalLoginTokenDto>(nameof(IdentityUserToken.Value),
