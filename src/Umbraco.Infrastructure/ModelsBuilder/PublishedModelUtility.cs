...
public static class PublishedModelUtility
{
    ...
    public static IPublishedContentType? GetModelContentType(IPublishedSnapshotAccessor publishedSnapshotAccessor,
    ...
    public static IPublishedPropertyType? GetModelPropertyType<TModel, TValue>(IPublishedContentType contentType,
