...
public static class LoggerConfigExtensions
{
    ...
    public static LoggerConfiguration MinimalConfiguration(
        ...
        MinimalConfiguration(logConfig, hostingEnvironment, loggingConfiguration, configuration, out _);
        ...
        out UmbracoFileConfiguration umbFileConfiguration)
    {
        ...
        logConfig.MinimumLevel
            ...
            .Enrich.WithThreadId()
            .Enrich
            .WithProperty("ApplicationId", hostingEnvironment.ApplicationId) // Updated later by ApplicationIdEnricher
        ...
        logConfig.WriteTo.UmbracoFile(
            umbracoFileConfiguration.GetPath(loggingConfiguration.LogDirectory),
