...
internal sealed class AppPluginsPackageManifestReader : PackageManifestReader
{
    ...
    /// </summary>
    /// <param name="packageManifestFileProviderFactory">A factory used to create <see cref="Microsoft.Extensions.FileProviders.IFileProvider"/> instances that provide access to package manifest files.</param>
