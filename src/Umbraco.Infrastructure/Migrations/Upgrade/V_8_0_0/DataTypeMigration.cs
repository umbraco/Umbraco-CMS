        ...
        public override void Migrate()
        {
            ...
            foreach (var group in dtos)
            {
                ...
                if (newAlias == null)
                {
                    ...
                    {
                        _logger.LogWarning<DataTypeMigration>(
                ...
                else if (!_propertyEditors.TryGet(newAlias, out var propertyEditor))
                {
                    ...
                    {
                        _logger.LogWarning<DataTypeMigration>("Skipping validation of configuration for data type {NodeId} : {NewEditorAlias} (was: {EditorAlias})"
                ...
                else
                {
                    ...
                    {
                        _logger.LogWarning<DataTypeMigration>(e, "Failed to validate configuration for data type {NodeId} : {NewEditorAlias} (was: {EditorAlias})."
