...
public class AddDictionaryDto : AsyncMigrationBase
{
    private readonly IEFCoreMigrationExecutor _migrationExecutor;

    public AddDictionaryDto(
    ...
    protected override async Task MigrateAsync()
    {
        ...
        await _migrationExecutor.ExecuteSingleMigrationAsync(EFCoreMigration.AddDictionaryDto);
    }
}
