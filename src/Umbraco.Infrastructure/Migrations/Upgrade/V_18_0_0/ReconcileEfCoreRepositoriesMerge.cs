...
public class ReconcileEfCoreRepositoriesMerge : AsyncMigrationBase
{
    private readonly IEFCoreMigrationExecutor _migrationExecutor;

    public ReconcileEfCoreRepositoriesMerge(
    ...
    protected override async Task MigrateAsync()
    {
        ...
        await _migrationExecutor.ExecuteSingleMigrationAsync(EFCoreMigration.ReconcileEfCoreRepositoriesMerge);
    }
}
