...
public class AddContentTypeDtosBasic : AsyncMigrationBase
{
    private readonly IEFCoreMigrationExecutor _migrationExecutor;

    public AddContentTypeDtosBasic(
    ...
    protected override async Task MigrateAsync()
    {
        ...
        await _migrationExecutor.ExecuteSingleMigrationAsync(EFCoreMigration.AddContentTypeDtosBasic);
    }
}
