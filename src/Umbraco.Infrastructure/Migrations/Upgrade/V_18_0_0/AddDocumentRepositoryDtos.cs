...
public class AddDocumentRepositoryDtos : AsyncMigrationBase
{
    private readonly IEFCoreMigrationExecutor _migrationExecutor;

    public AddDocumentRepositoryDtos(
    ...
    protected override async Task MigrateAsync()
    {
        ...
        await _migrationExecutor.ExecuteSingleMigrationAsync(EFCoreMigration.AddDocumentRepositoryDtos);
    }
}
