...
public class AddContentVersionCleanupPolicyDto : AsyncMigrationBase
{
    private readonly IEFCoreMigrationExecutor _migrationExecutor;

    public AddContentVersionCleanupPolicyDto(
    ...
    protected override async Task MigrateAsync()
    {
        ...
        await _migrationExecutor.ExecuteSingleMigrationAsync(EFCoreMigration.AddContentVersionCleanupPolicyDto);
    }
}
