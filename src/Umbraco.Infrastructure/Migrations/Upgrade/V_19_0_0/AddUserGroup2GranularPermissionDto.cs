...
public class AddUserGroup2GranularPermissionDto : AsyncMigrationBase
{
    private readonly IEFCoreMigrationExecutor _migrationExecutor;

    public AddUserGroup2GranularPermissionDto(
    ...
    protected override async Task MigrateAsync()
    {
        ...
        await _migrationExecutor.ExecuteSingleMigrationAsync(EFCoreMigration.AddUserGroup2GranularPermissionDto);
    }
}
