    ...
    private void CreateUserGroupData()
    {
        _database.Insert(
            ...
            new UserGroupDto
            {
                ...
                Name = "Administrators",
                Description = "Users with access to all sections",
                CreateDate = DateTime.UtcNow,
                UpdateDate = DateTime.UtcNow,
                Icon = "icon-medal",
        ...
        _database.Insert(
            ...
            new UserGroupDto
            {
                ...
                Name = "Writers",
                Description = "Users with access to write content",
                CreateDate = DateTime.UtcNow,
                UpdateDate = DateTime.UtcNow,
                Icon = "icon-edit",
                HasAccessToAllLanguages = true,
        ...
        _database.Insert(
            ...
            new UserGroupDto
            {
                ...
                Name = "Editors",
                Description = "Users can create, edit, and manage content and media within the CMS",
                CreateDate = DateTime.UtcNow,
                UpdateDate = DateTime.UtcNow,
                Icon = "icon-tools",
                HasAccessToAllLanguages = true,
        ...
        _database.Insert(
            ...
            new UserGroupDto
            {
                ...
                Name = "Translators",
                Description = "Users with access to translation features",
                CreateDate = DateTime.UtcNow,
                UpdateDate = DateTime.UtcNow,
                Icon = "icon-globe",
                HasAccessToAllLanguages = true,
        ...
        _database.Insert(
            ...
            new UserGroupDto
            {
                ...
                Name = "Sensitive data",
                Description = "Users with access to sensitive data",
                CreateDate = DateTime.UtcNow,
                UpdateDate = DateTime.UtcNow,
                Icon = "icon-lock",
