...
/// </summary>
public abstract class UnscopedAsyncMigrationBase : AsyncMigrationBase
{
    /// <summary>
    /// Initializes a new instance of the <see cref="UnscopedAsyncMigrationBase" /> class.
    /// </summary>
    /// <param name="context">A migration context.</param>
    protected UnscopedAsyncMigrationBase(IMigrationContext context)
        : base(context)
    { }

    /// <summary>
    /// <para>Scope the database used by the migration builder.</para>
    /// <para>This is used with <see cref="UnscopedAsyncMigrationBase"/> when you need to execute something before the scope is created
