...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="SingleDropDownConfigurationEditor"/> class.
    /// </summary>
    ...
    public SingleDropDownConfigurationEditor(IIOHelper ioHelper, IConfigurationEditorJsonSerializer configurationEditorJsonSerializer)
        : base(ioHelper)
    {
