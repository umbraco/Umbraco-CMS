...
namespace Umbraco.Web.PropertyEditors
{
    ...
    public class MultiUrlPickerPropertyEditor : DataEditor
    {
        ...
        public MultiUrlPickerPropertyEditor(ILoggerFactory loggerFactory, Lazy<IEntityService> entityService, IPublishedSnapshotAccessor publishedSnapshotAccessor, IDataTypeService dataTypeService, ILocalizationService localizationService, ILocalizedTextService localizedTextService, IIOHelper ioHelper, IShortStringHelper shortStringHelper, IUmbracoContextAccessor umbracoContextAccessor, IPublishedUrlProvider publishedUrlProvider)
