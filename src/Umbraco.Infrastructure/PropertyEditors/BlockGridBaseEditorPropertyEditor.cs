...
{
    /// <summary>
    /// Abstract class for block editor based editors, well temporary suited for Block Grid Editor... (I have highlighted differences with comments in code. see "Change:")
    /// </summary>
    public abstract class BlockGridBaseEditorPropertyEditor : DataEditor
    {
        public const string ContentTypeKeyPropertyKey = "contentTypeKey";
        public const string UdiPropertyKey = "udi";

        public BlockGridBaseEditorPropertyEditor(
