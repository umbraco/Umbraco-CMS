...
public abstract class RecurringHostedServiceBase : IHostedService, IDisposable
{
    ...
    public Task StartAsync(CancellationToken cancellationToken)
    {
        ...
        {
            _timer = new Timer(ExecuteAsync, null, (long)_delay.TotalMilliseconds, (long)_period.TotalMilliseconds);
        }
    ...
    public async void ExecuteAsync(object? state)
    {
        ...
        finally
        {
            ...
            _timer?.Change((long)_period.TotalMilliseconds, (long)_period.TotalMilliseconds);
        }
    }
