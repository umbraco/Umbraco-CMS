...
var CodeMirror = (function(){
  ...
  // UMBRACO ADD: We need to test for IE9!
  var internetExplorer = document.selection && window.ActiveXObject && /MSIE/.test(navigator.userAgent) && parseInt(navigator.userAgent.substring(navigator.userAgent.indexOf('MSIE')+5, navigator.userAgent.indexOf('MSIE')+6)) <= 8;
  ...
  CodeMirror.prototype = {
    ...
    focus: function() {
      this.win.focus();
      if (this.editor.selectionSnapshot && internetExplorer) // IE hack
