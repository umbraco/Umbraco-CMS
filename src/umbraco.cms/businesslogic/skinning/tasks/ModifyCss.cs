...
namespace umbraco.cms.businesslogic.skinning.tasks
{
    public class ModifyCss : TaskType
    {
        ...
        {
            string[] filecontents = File.ReadAllLines(IOHelper.MapPath(SystemDirectories.Css) + "/" + TargetFile);
            ...
            System.IO.StreamWriter file = new System.IO.StreamWriter(IOHelper.MapPath(SystemDirectories.Css) + "/" + TargetFile);
