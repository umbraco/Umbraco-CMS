...
namespace umbraco.cms.businesslogic.language
{
    ...
    public class Item
    {
        ...
        public static string Text(Guid key, int languageId)
        {
            ...
            var item = Current.Services.LocalizationService.GetDictionaryItemById(key);
            if (item != null)
            {
        ...
        {
            var lang = Current.Services.LocalizationService.GetLanguageById(languageId);
            if (lang == null) return;
            ...
            if (item != null)
            {
                ...
                Current.Services.LocalizationService.Save(item);
            }
        }
        ...
        {
            var found = Current.Services.LocalizationService.GetDictionaryItemById(key);
            if (found != null)
            {
                Current.Services.LocalizationService.Delete(found);
            }
        }
        ...
        public static void RemoveByLanguage(int languageId)
        {
            ...
            if (lang != null)
            {
                Current.Services.LocalizationService.Delete(lang);
            }
        }
    }
}