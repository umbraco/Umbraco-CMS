...
namespace Umbraco.Web.Common.Runtime.Profiler
{
    public class WebProfiler : IProfiler
    {
        ...
        //TODO register and inject WebProfilerProvider?
        public WebProfiler(IHttpContextAccessor httpContextAccessor, IRequestCache requestCache)
        {
            // create our own provider, which can provide a profiler even during boot
            _provider = new WebProfilerProvider(requestCache);
