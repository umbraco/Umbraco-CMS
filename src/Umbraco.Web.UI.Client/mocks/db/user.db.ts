...
import type { UmbMockUserModel } from '../data/mock-data-set.types.js';
...
class UmbUserMockDB extends UmbEntityMockDbBase<UmbMockUserModel> {
	...
	calculateStartNodes(id: string): CalculatedUserStartNodesResponseModel {
		...
		return {
			...
			documentBlueprintStartNodeIds: user.documentBlueprintStartNodeIds,
			...
			hasDocumentBlueprintRootAccess: user.hasDocumentBlueprintRootAccess,
	...
	getCurrentUser(): CurrentUserResponseModel {
		...
		return {
			...
			documentBlueprintStartNodeIds: firstUser.documentBlueprintStartNodeIds,
			...
			hasDocumentBlueprintRootAccess: firstUser.hasDocumentBlueprintRootAccess,
...
const createMockMapper = (item: CreateUserRequestModel): UmbMockUserModel => {
	return {
		...
		mediaStartNodeIds: [],
		documentBlueprintStartNodeIds: [],
		elementStartNodeIds: [],
		hasDocumentRootAccess: false,
		hasMediaRootAccess: false,
		hasDocumentBlueprintRootAccess: false,
...
const detailResponseMapper = (item: UmbMockUserModel): UserResponseModel => {
	return {
		...
		documentBlueprintStartNodeIds: item.documentBlueprintStartNodeIds,
		...
		hasDocumentBlueprintRootAccess: item.hasDocumentBlueprintRootAccess,
