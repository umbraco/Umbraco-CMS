...
export const data: Array<UmbMockDataTypeModel> = [
		...
		values: [
			...
			},
			{
				...
				value: [
					[
						['Umb.Tiptap.Toolbar.SourceEditor'],
						['Umb.Tiptap.Toolbar.StyleSelect', 'Umb.Tiptap.Toolbar.Bold', 'Umb.Tiptap.Toolbar.Italic'],
						['Umb.Tiptap.Toolbar.Link', 'Umb.Tiptap.Toolbar.Unlink'],
		...
		values: [
			{
				...
				value: [
					[
						['Umb.Tiptap.Toolbar.SourceEditor', 'Umb.Tiptap.Toolbar.Undo', 'Umb.Tiptap.Toolbar.Redo'],
						[
						...
						['Umb.Tiptap.Toolbar.CharacterMap', 'Umb.Tiptap.Toolbar.ClearFormatting'],
					...
					[
						...
						['Umb.Tiptap.Toolbar.BulletList', 'Umb.Tiptap.Toolbar.OrderedList', 'Umb.Tiptap.Toolbar.Blockquote'],
						['Umb.Tiptap.Toolbar.Subscript', 'Umb.Tiptap.Toolbar.Superscript'],
						['Umb.Tiptap.Toolbar.CodeBlock', 'Umb.Tiptap.Toolbar.HorizontalRule'],
						['Umb.Tiptap.Toolbar.TextDirectionRtl', 'Umb.Tiptap.Toolbar.TextDirectionLtr'],
						['Umb.Tiptap.Toolbar.TextIndent', 'Umb.Tiptap.Toolbar.TextOutdent', 'Umb.Tiptap.Toolbar.TextOutdent'],
						[
						...
						querySteps: [
							{
								...
								anyOfDocTypeKeys: ['651c932b-232d-42b3-a52e-c1399fcff9bc'],
							},
						],
					},
				},
	...
	},
	{
		...
		values: [
			...
			},
			{
				alias: 'filter',
				value:
					'015bc281-7410-40e2-81b5-b8f7c963bd61,41f34bb7-fd63-442f-8dcb-142df4246310,13c10f78-bf14-411d-9444-751e4bd1b178,9cff8f66-0e13-4617-ab9b-9f845ecc5e24',
			},
			{
				alias: 'minNumber',
				value: 2,
	...
	},
	{
		...
		values: [
			...
			{
				alias: 'stylesheets',
				value: ['/fonts.css', '/rte-styles.css'],
			},
			{
				alias: 'toolbar',
				value: [[['Umb.Tiptap.Toolbar.StyleSelect', 'Umb.Tiptap.Toolbar.Bold', 'Umb.Tiptap.Toolbar.Italic']]],
			},
		],
	},
	{
	...
	},
	{
		...
		values: [
			...
			{
				alias: 'stylesheets',
				value: ['/css/fonts.css', '/css/rte-styles.css'],
			},
			{
				alias: 'toolbar',
				value: [
		...
		values: [
			{
				...
				value: [
					...
					},
					{
						...
						forceHideContentEditorInOverlay: false,
						label:
							'Document: {umbContentName: link}; Media: {umbContentName: mediaPicker}; URL: {umbLink: multiUrlPicker}; ${tiptapRte.markup}',
					},
				],
			},
			{
						...
						querySteps: [
							{
								...
								alias: 'NearestDescendantOrSelf',
								anyOfDocTypeKeys: ['7184285e-9709-4e13-8c72-1fe52f024b28'],
							},
						],
					},
				},
		...
		values: [
			{
				...
				value: [
					...
					[
						...
						['Umb.Tiptap.Toolbar.TextOutdent', 'Umb.Tiptap.Toolbar.TextIndent'],
						['Umb.Tiptap.Toolbar.TextDirectionRtl', 'Umb.Tiptap.Toolbar.TextDirectionLtr'],
						[
							'Umb.Tiptap.Toolbar.Table',
							'Umb.Tiptap.Toolbar.MediaPicker',
			...
			{
				alias: 'statusbar',
				value: [['Umb.Tiptap.Statusbar.ElementPath'], ['Umb.Tiptap.Statusbar.WordCount']],
			},
		],
	},
	{
