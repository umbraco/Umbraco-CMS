...
import { ADMIN_USER_GROUP_ID, ENGLISH_EDITORS_USER_GROUP_ID } from './user-group.data.js';
...
export const data: Array<UmbMockUserModel> = [
	...
	{
		id: 'variant-documents-english-editor-user-id',
		name: 'English Editor',
		email: 'english-editor@example.com',
		userName: '',
		isAdmin: false,
		kind: UserKindModel.DEFAULT,
		state: UserStateModel.ACTIVE,
		...
		hasDocumentRootAccess: true,
		hasMediaRootAccess: true,
		userGroupIds: [{ id: ENGLISH_EDITORS_USER_GROUP_ID }],
		flags: [],
	},
];
