...
@customElement('umb-umbraco-welcome-dashboard')
export class UmbUmbracoWelcomeDashboardElement extends UmbLitElement {
	#infoLinks = [
		{
...
export default UmbUmbracoWelcomeDashboardElement;

declare global {
	interface HTMLElementTagNameMap {
		'umb-umbraco-welcome-dashboard': UmbUmbracoWelcomeDashboardElement;
	}
}
