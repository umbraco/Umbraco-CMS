import { UmbDocumentBlueprintTreePickerDataSource } from '../picker-data-source/document-blueprint-tree.picker-data-source.js';
...
@customElement('umb-input-document-blueprint')
...
declare global {
	interface HTMLElementTagNameMap {
		'umb-input-document-blueprint': UmbInputDocumentBlueprintElement;
	}
}
