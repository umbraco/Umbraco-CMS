...
import { UmbDocumentTypeTreeServerDataSource } from './server-data-source/document-type.tree.server.data-source.js';
	...
	implements UmbApi
{
	constructor(host: UmbControllerHost) {
		super(host, UmbDocumentTypeTreeServerDataSource);
	}
