...
export const manifests: Array<UmbExtensionManifest> = [
	...
	{
		type: 'workspaceAction',
		alias: 'Umb.WorkspaceAction.DocumentType.SchemaLockdown',
		name: 'Document Type Schema Lockdown Workspace Action',
	...
	},
	{
		...
		alias: 'Umb.WorkspaceInfoApp.DocumentType.SchemaLockdown',
		name: 'Document Type Schema Lockdown Notice',
