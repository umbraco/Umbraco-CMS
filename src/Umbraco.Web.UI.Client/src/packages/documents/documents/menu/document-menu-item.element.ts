...
import type { UmbDocumentTreeItemModel, UmbDocumentTreeRootModel } from '../tree/types.js';
...
export class UmbDocumentMenuItemElement extends UmbLitElement implements UmbMenuItemElement {
...
export { UmbDocumentMenuItemElement as element };
