...
import { UmbPublishingAwareSplitViewVariantSelectorElement } from '@umbraco-cms/backoffice/content';

@customElement('umb-document-workspace-split-view-variant-selector')
export class UmbDocumentWorkspaceSplitViewVariantSelectorElement extends UmbPublishingAwareSplitViewVariantSelectorElement<UmbDocumentVariantOptionModel> {
