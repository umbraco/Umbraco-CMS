...
export class UmbTemplateTreeItemTableCollectionViewElement extends UmbLitElement {
	...
	#createTableItems(items: Array<UmbTemplateTreeItemModel>) {
		this._tableItems = items.map((item) => {
			const editPath = UMB_EDIT_TEMPLATE_WORKSPACE_PATH_PATTERN.generateAbsolute({ unique: item.unique });
...
export { UmbTemplateTreeItemTableCollectionViewElement as element };
