...
import type { UmbElementSaveModalData, UmbElementSaveModalValue } from './element-save-modal.token.js';
...
import '../shared/element-variant-language-picker.element.js';

@customElement('umb-element-save-modal')
export class UmbElementSaveModalElement extends UmbModalBaseElement<UmbElementSaveModalData, UmbElementSaveModalValue> {
...
export default UmbElementSaveModalElement;

declare global {
	interface HTMLElementTagNameMap {
		'umb-element-save-modal': UmbElementSaveModalElement;
	}
}
