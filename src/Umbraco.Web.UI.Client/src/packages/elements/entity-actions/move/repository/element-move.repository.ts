import { UmbMoveElementServerDataSource } from './element-move.server.data-source.js';
import { UMB_NOTIFICATION_CONTEXT } from '@umbraco-cms/backoffice/notification';
import { UmbRepositoryBase } from '@umbraco-cms/backoffice/repository';
import type { UmbMoveRepository, UmbMoveToRequestArgs } from '@umbraco-cms/backoffice/tree';

export class UmbMoveElementRepository extends UmbRepositoryBase implements UmbMoveRepository {
...
export { UmbMoveElementRepository as api };
