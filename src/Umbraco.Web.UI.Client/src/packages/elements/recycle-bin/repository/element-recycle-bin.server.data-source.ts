...
export class UmbElementRecycleBinServerDataSource implements UmbRecycleBinDataSource {
	...
	trash(args: UmbRecycleBinTrashRequestArgs) {
		return tryExecute(this.#host, ElementService.putElementByIdMoveToRecycleBin({ path: { id: args.unique } }));
	}
