import type { UmbInputMemberTypeElement } from '../../components/index.js';
...
export class UmbPropertyEditorUIMemberTypePickerElement extends UmbLitElement implements UmbPropertyEditorUiElement {
	...
	#onChange(event: CustomEvent & { target: UmbInputMemberTypeElement }) {
	...
	override render() {
		return html`
			<umb-input-member-type .min=${this._min} .max=${this._max} .value=${this.value} @change=${this.#onChange}>
