...
/**
 * Move Member Type Folder Server Data Source
 * @class UmbMoveMemberTypeFolderServerDataSource
 */
export class UmbMoveMemberTypeFolderServerDataSource implements UmbMoveDataSource {
	#host: UmbControllerHost;

	/**
	 * Creates an instance of UmbMoveMemberTypeFolderServerDataSource.
	 * @param {UmbControllerHost} host - The controller host for this controller to be appended to
	 * @memberof UmbMoveMemberTypeFolderServerDataSource
	 */
	...
	async moveTo(args: UmbMoveToRequestArgs) {
		...
		return tryExecute(
			this.#host,
			MemberTypeService.putMemberTypeFolderByIdMove({
				path: { id: args.unique },
				body: {
