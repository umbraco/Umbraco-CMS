...
export const UMB_CREATE_MEMBER_GROUP_WORKSPACE_PATH_PATTERN = new UmbPathPattern(
	'create',
	UMB_MEMBER_GROUP_WORKSPACE_PATH,
);

export const UMB_EDIT_MEMBER_GROUP_WORKSPACE_PATH_PATTERN = new UmbPathPattern<{ unique: string }>(
	'edit/:unique',
	UMB_MEMBER_GROUP_WORKSPACE_PATH,
);
