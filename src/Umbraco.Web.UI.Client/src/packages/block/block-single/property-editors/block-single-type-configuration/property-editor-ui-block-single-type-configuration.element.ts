...
/**
 * @element umb-property-editor-ui-block-single-type-configuration
 */
@customElement('umb-property-editor-ui-block-single-type-configuration')
export class UmbPropertyEditorUIBlockSingleBlockConfigurationElement
	...
	implements UmbPropertyEditorUiElement
{
	...
	constructor() {
		...
		this.#blockTypeWorkspaceModalRegistration = new UmbModalRouteRegistrationController(this, UMB_WORKSPACE_MODAL)
			.addAdditionalPath(UMB_BLOCK_SINGLE_TYPE)
			.onSetup(() => {
				return { data: { entityType: UMB_BLOCK_SINGLE_TYPE, preset: {} }, modal: { size: 'large' } };
			})
...
export default UmbPropertyEditorUIBlockSingleBlockConfigurationElement;

declare global {
	interface HTMLElementTagNameMap {
		'umb-property-editor-ui-block-single-type-configuration': UmbPropertyEditorUIBlockSingleBlockConfigurationElement;
	}
}
