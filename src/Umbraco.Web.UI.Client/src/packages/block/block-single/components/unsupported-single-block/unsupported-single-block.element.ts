...
/**
 * @element umb-unsupported-single-block
 */
@customElement('umb-unsupported-single-block')
export class UmbUnsupportedSingleBlockElement extends UmbLitElement {
	override render() {
		return html`
			<div id="host">
				<div id="open-part">
...
export default UmbUnsupportedSingleBlockElement;

declare global {
	interface HTMLElementTagNameMap {
		'umb-unsupported-single-block': UmbUnsupportedSingleBlockElement;
	}
}
