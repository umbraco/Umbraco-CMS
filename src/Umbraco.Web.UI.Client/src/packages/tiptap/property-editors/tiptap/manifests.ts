...
_Drag and drop the available actions onto the statusbar areas._`,
					...
					{
						alias: 'maxDimensions',
						label: '#tiptap_maxDimensions',
						description: '{#tiptap_config_maxDimensions_description}',
						propertyEditorUiAlias: 'Umb.PropertyEditorUI.Dimensions',
						weight: 30,
					},
					{
						alias: 'minDimensions',
						label: '#tiptap_minDimensions',
						description: '{#tiptap_config_minDimensions_description}',
						propertyEditorUiAlias: 'Umb.PropertyEditorUI.Dimensions',
						weight: 31,
					},
					{
