import { UmbTiptapBlockToBlockRteClipboardPastePropertyValueTranslator } from './block-to-block-rte-paste-translator.js';
...
export const manifest: UmbExtensionManifest = {
	...
	api: UmbTiptapBlockToBlockRteClipboardPastePropertyValueTranslator,
