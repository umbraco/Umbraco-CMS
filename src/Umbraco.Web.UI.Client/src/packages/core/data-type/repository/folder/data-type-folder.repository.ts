...
export class UmbDataTypeFolderRepository extends UmbFolderRepositoryBase {
	constructor(host: UmbControllerHost) {
		super(host, UmbDataTypeFolderServerDataSource, UMB_DATA_TYPE_TREE_STORE_CONTEXT, folderToDataTypeFolder);
	}
}

const folderToDataTypeTreeItemFolder = (folder: UmbFolderModel): FileSystemTreeItemPresentationModel => {
	return {
		id: folder.unique,
		name: folder.name,
