...
export class DocumentBlueprintService {
    ...
    /**
     * Gets a collection of document blueprint folder items.
     *
     * Gets a collection of document blueprint folder items identified by the provided Ids.
     */
    public static getItemDocumentBlueprintFolder<ThrowOnError extends boolean = true>(options?: Options<GetItemDocumentBlueprintFolderData, ThrowOnError>): RequestResult<GetItemDocumentBlueprintFolderResponses, GetItemDocumentBlueprintFolderErrors, ThrowOnError> {
        return (options?.client ?? client).get<GetItemDocumentBlueprintFolderResponses, GetItemDocumentBlueprintFolderErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
...
export class DocumentTypeService {
    ...
    /**
     * Gets document types allowed for document blueprints.
     *
     * Gets a collection of document types that a document blueprint can be created for.
     */
    public static getDocumentTypeAllowedForBlueprint<ThrowOnError extends boolean = true>(options?: Options<GetDocumentTypeAllowedForBlueprintData, ThrowOnError>): RequestResult<GetDocumentTypeAllowedForBlueprintResponses, GetDocumentTypeAllowedForBlueprintErrors, ThrowOnError> {
        return (options?.client ?? client).get<GetDocumentTypeAllowedForBlueprintResponses, GetDocumentTypeAllowedForBlueprintErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
...
export class SearchService {
    public static getSearchIndexes<ThrowOnError extends boolean = true>(options?: Options<GetSearchIndexesData, ThrowOnError>): RequestResult<GetSearchIndexesResponses, GetSearchIndexesErrors, ThrowOnError> {
        return (options?.client ?? client).get<GetSearchIndexesResponses, GetSearchIndexesErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
    ...
    public static getSearchIndexesByIndexAlias<ThrowOnError extends boolean = true>(options: Options<GetSearchIndexesByIndexAliasData, ThrowOnError>): RequestResult<GetSearchIndexesByIndexAliasResponses, GetSearchIndexesByIndexAliasErrors, ThrowOnError> {
        return (options.client ?? client).get<GetSearchIndexesByIndexAliasResponses, GetSearchIndexesByIndexAliasErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
    ...
    public static putSearchRebuild<ThrowOnError extends boolean = true>(options?: Options<PutSearchRebuildData, ThrowOnError>): RequestResult<PutSearchRebuildResponses, PutSearchRebuildErrors, ThrowOnError> {
        return (options?.client ?? client).put<PutSearchRebuildResponses, PutSearchRebuildErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
    ...
    public static postSearchSearch<ThrowOnError extends boolean = true>(options: Options<PostSearchSearchData, ThrowOnError>): RequestResult<PostSearchSearchResponses, PostSearchSearchErrors, ThrowOnError> {
        return (options.client ?? client).post<PostSearchSearchResponses, PostSearchSearchErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
