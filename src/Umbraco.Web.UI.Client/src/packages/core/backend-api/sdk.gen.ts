...
export class DocumentService {
    ...
    /**
     * Gets the elements referenced by a document that are not fully published.
     *
     * Gets a paginated collection of elements directly referenced by the document identified by the provided Id, that are draft, have pending changes, or are scheduled for a future publish.
     *
     * NOTE: hand-authored stand-in for this operation, pending a real `/umb-update-openapi` regeneration
     * against a live backend (see CLAUDE.md "Updating OpenApi.json").
     */
    public static getDocumentByIdReferencedElementsWithPendingChanges<ThrowOnError extends boolean = true>(options: Options<GetDocumentByIdReferencedElementsWithPendingChangesData, ThrowOnError>): RequestResult<GetDocumentByIdReferencedElementsWithPendingChangesResponses, GetDocumentByIdReferencedElementsWithPendingChangesErrors, ThrowOnError> {
        return (options.client ?? client).get<GetDocumentByIdReferencedElementsWithPendingChangesResponses, GetDocumentByIdReferencedElementsWithPendingChangesErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
...
export class ElementService {
    ...
    /**
     * Gets the elements referenced by an element that are not fully published.
     *
     * Gets a paginated collection of elements directly referenced by the element identified by the provided Id, that are draft, have pending changes, or are scheduled for a future publish.
     *
     * NOTE: hand-authored stand-in for this operation, pending a real `/umb-update-openapi` regeneration
     * against a live backend (see CLAUDE.md "Updating OpenApi.json").
     */
    public static getElementByIdReferencedElementsWithPendingChanges<ThrowOnError extends boolean = true>(options: Options<GetElementByIdReferencedElementsWithPendingChangesData, ThrowOnError>): RequestResult<GetElementByIdReferencedElementsWithPendingChangesResponses, GetElementByIdReferencedElementsWithPendingChangesErrors, ThrowOnError> {
        return (options.client ?? client).get<GetElementByIdReferencedElementsWithPendingChangesResponses, GetElementByIdReferencedElementsWithPendingChangesErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
