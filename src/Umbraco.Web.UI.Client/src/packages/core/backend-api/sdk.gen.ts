...
export class DocumentService {
     ...
     */
    public static putDocumentByIdValidate<ThrowOnError extends boolean = true>(options: Options<PutDocumentByIdValidateData, ThrowOnError>) {
