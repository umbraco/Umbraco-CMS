...
export class VisualEditorService {
    /**
     * Renders a document with unsaved visual editor values.
     */
    public static postVisualEditorRender<ThrowOnError extends boolean = true>(options: Options<PostVisualEditorRenderData, ThrowOnError>) {
        return (options.client ?? client).post<PostVisualEditorRenderResponses, PostVisualEditorRenderErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
