...
export class ElementService {
     ...
     *
     * Creates a new Library element from a nested element currently held in a block property on a document, media item, member or another element, publishing the cultures it is currently live in as far as validation allows.
     */
    public static postElementFromBlock<ThrowOnError extends boolean = true>(options: Options<PostElementFromBlockData, ThrowOnError>): RequestResult<PostElementFromBlockResponses, PostElementFromBlockErrors, ThrowOnError> {
        return (options.client ?? client).post<PostElementFromBlockResponses, PostElementFromBlockErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
