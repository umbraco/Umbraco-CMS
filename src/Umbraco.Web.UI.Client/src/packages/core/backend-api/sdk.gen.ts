...
export class DataTypeService {
    ...
    public static getDataTypeByIdReferences<ThrowOnError extends boolean = true>(options: Options<GetDataTypeByIdReferencesData, ThrowOnError>) {
        return (options.client ?? client).get<GetDataTypeByIdReferencesResponses, GetDataTypeByIdReferencesErrors, ThrowOnError>({
            security: [
                {
                    scheme: 'bearer',
                    type: 'http'
...
export class TemplateService {
    ...
    public static postTemplateForDocumentType<ThrowOnError extends boolean = true>(options?: Options<PostTemplateForDocumentTypeData, ThrowOnError>) {
        return (options?.client ?? client).post<PostTemplateForDocumentTypeResponses, PostTemplateForDocumentTypeErrors, ThrowOnError>({
            security: [
                {
                    scheme: 'bearer',
                    type: 'http'
