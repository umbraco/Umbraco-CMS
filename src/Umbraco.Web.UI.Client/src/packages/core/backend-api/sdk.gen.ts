...
export class DictionaryService {
    ...
    /**
     * Searches dictionary items.
     *
     * Searches dictionary items by the provided query with pagination support.
     */
    public static getItemDictionarySearch<ThrowOnError extends boolean = true>(options?: Options<GetItemDictionarySearchData, ThrowOnError>) {
        return (options?.client ?? client).get<GetItemDictionarySearchResponses, GetItemDictionarySearchErrors, ThrowOnError>({
            security: [{ scheme: 'bearer', type: 'http' }],
