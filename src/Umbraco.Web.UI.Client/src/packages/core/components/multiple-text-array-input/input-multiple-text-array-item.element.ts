...
/**
 * @element umb-input-multiple-text-array-item
 */
@customElement('umb-input-multiple-text-array-item')
export class UmbInputMultipleTextArrayItemElement extends UUIFormControlWithBasicsMixin(UmbLitElement, '') {
	/**
	 * Disables the input
	 * @type {boolean}
	 * @attr
...
export default UmbInputMultipleTextArrayItemElement;

declare global {
	interface HTMLElementTagNameMap {
		'umb-input-multiple-text-array-item': UmbInputMultipleTextArrayItemElement;
	}
}
