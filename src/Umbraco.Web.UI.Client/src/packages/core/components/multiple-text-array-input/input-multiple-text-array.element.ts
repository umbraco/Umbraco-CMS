import type { UmbInputMultipleTextArrayItemElement } from './input-multiple-text-array-item.element.js';
...
/**
 * @element umb-input-multiple-text-array
 */
@customElement('umb-input-multiple-text-array')
export class UmbInputMultipleTextArrayElement extends UmbFormControlMixin<undefined | string, typeof UmbLitElement>(
	UmbLitElement,
	undefined,
) {
	#sorter = new UmbSorterController(this, {
		...
		identifier: 'Umb.SorterIdentifier.MultipleTextArray',
		itemSelector: 'umb-input-multiple-text-array-item',
	...
	*/
	...
	#onInput(event: UmbInputEvent, currentIndex: number) {
		...
		const target = event.currentTarget as UmbInputMultipleTextArrayItemElement;
	...
	async #focusNewItem() {
		...
		const items = this.shadowRoot?.querySelectorAll(
			'umb-input-multiple-text-array-item',
		) as NodeListOf<UmbInputMultipleTextArrayItemElement>;
...
export default UmbInputMultipleTextArrayElement;

declare global {
	interface HTMLElementTagNameMap {
		'umb-input-multiple-text-array': UmbInputMultipleTextArrayElement;
	}
}
