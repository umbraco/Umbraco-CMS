...
describe('UmbValueSummaryExtensionElement', () => {
	...
	it('should be defined', async () => {
		element = await fixture(html`<umb-value-summary-extension></umb-value-summary-extension>`);
		expect(element).to.be.instanceOf(UmbValueSummaryExtensionElement);
	});

	it('should accept valueType and value properties', async () => {
		element = await fixture(html`<umb-value-summary-extension .valueType=${'test'} .value=${'hello'}></umb-value-summary-extension>`);
	...
	it('should render nothing without valueType', async () => {
		element = await fixture(html`<umb-value-summary-extension .value=${'hello'}></umb-value-summary-extension>`);
	...
	it('should render extension-with-api-slot when valueType is set', async () => {
		element = await fixture(
			html`<umb-value-summary-extension .valueType=${'Umb.Test.Slot'} .value=${'hello'}></umb-value-summary-extension>`,
		);
