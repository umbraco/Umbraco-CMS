 ...
 */
@customElement('umb-auth-view')
export class UmbAuthViewElement extends UmbLitElement {
	@property({ attribute: false })
	userLoginState: UmbUserLoginState = 'loggedOut';
...
export default UmbAuthViewElement;
