			...
			(args) => {
				...
				if (this.#isUserWaitingForIndexUpdate(indexAlias)) {
					...
					this.#notificationContext?.peek('positive', {
						data: {
							title: this.#localize.term('searchManagement_rebuildCompletedTitle'),
							message: this.#localize.term('searchManagement_rebuildCompletedMessage', indexAlias),
						},
					});
				}
			},
...
export default UmbSearchContext;
