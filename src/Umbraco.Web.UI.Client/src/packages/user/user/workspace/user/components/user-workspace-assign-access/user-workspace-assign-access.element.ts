...
export class UmbUserWorkspaceAssignAccessElement extends UmbLitElement {
	...
	constructor() {
		...
		this.#observeDatasetProperty<UmbStartNodeAccessValue>('documentBlueprintAccess', (value) =>
			value ? this.#workspaceContext?.setDocumentBlueprintAccess(value) : undefined,
		);
		...
		this.consumeContext(UMB_USER_WORKSPACE_CONTEXT, (instance) => {
			...
			this.observe(
				...
				([rootAccess, startNodes]) =>
					this.#dataset.setPropertyValue('documentBlueprintAccess', {
						rootAccess: rootAccess ?? false,
						startNodes: startNodes ?? [],
					}),
