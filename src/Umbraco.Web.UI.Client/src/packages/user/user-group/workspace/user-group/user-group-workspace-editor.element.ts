...
import './components/user-group-ui-user-permission-list.element.js';
				...
				<umb-stack>
					...
					<uui-box>
						...
						<umb-property-layout label="Permissions">
							<umb-user-group-ui-user-permission-list slot="editor"></umb-user-group-ui-user-permission-list>
						</umb-property-layout>
