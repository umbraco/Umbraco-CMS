	...
	implements UmbDetailDataSource<UmbUserGroupDetailModel>
{
	...
	async createScaffold() {
		const data: UmbUserGroupDetailModel = {
			...
			documentBlueprintStartNode: null,
	...
	async read(unique: string): Promise<UmbDataSourceResponse<UmbUserGroupDetailModel>> {
		...
		const userGroup: UmbUserGroupDetailModel = {
			...
			documentBlueprintRootAccess: data.documentBlueprintRootAccess,
			documentBlueprintStartNode: data.documentBlueprintStartNode ? { unique: data.documentBlueprintStartNode.id } : null,
	...
	async create(model: UmbUserGroupDetailModel): Promise<UmbDataSourceResponse<UmbUserGroupDetailModel>> {
		...
		const body: CreateUserGroupRequestModel = {
			...
			documentBlueprintRootAccess: model.documentBlueprintRootAccess,
			documentBlueprintStartNode: model.documentBlueprintStartNode ? { id: model.documentBlueprintStartNode.unique } : null,
