...
import { manifest as documentBlueprintAccessManifest } from './document-blueprint-access/document-blueprint-access.condition.manifest.js';
...
export const manifests = [allowMfaManifest, documentBlueprintAccessManifest, groupManifest, isAdminManifest];
