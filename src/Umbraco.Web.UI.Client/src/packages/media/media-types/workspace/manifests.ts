...
export const manifests: Array<UmbExtensionManifest> = [
	...
	{
		type: 'workspaceAction',
		alias: 'Umb.WorkspaceAction.MediaType.SchemaLockdown',
		name: 'Media Type Schema Lockdown Workspace Action',
	...
	},
	{
		...
		alias: 'Umb.WorkspaceInfoApp.MediaType.SchemaLockdown',
		name: 'Media Type Schema Lockdown Notice',
