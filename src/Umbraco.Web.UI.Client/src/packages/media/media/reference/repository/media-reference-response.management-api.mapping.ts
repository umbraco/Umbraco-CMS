...
import type { IReferenceResponseModelMediaReferenceResponseModel as MediaReferenceResponseModel } from '@umbraco-cms/backoffice/external/backend-api';
...
export class UmbMediaReferenceResponseManagementApiDataMapping
	...
	implements UmbDataSourceDataMapping<MediaReferenceResponseModel, UmbMediaReferenceModel>
{
