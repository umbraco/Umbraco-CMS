...
import type { MediaTypePropertyReferenceResponseModel } from '@umbraco-cms/backoffice/external/backend-api';
...
export class UmbMediaTypePropertyTypeReferenceResponseManagementApiDataMapping
	...
	implements UmbDataSourceDataMapping<MediaTypePropertyReferenceResponseModel, UmbMediaTypePropertyTypeReferenceModel>
{
	async map(data: MediaTypePropertyReferenceResponseModel): Promise<UmbMediaTypePropertyTypeReferenceModel> {
		return {
			alias: data.alias!,
			mediaType: {
