...
@customElement('umb-media-picker-grid-collection-view')
export class UmbMediaPickerGridCollectionViewElement extends UmbLitElement {
	@state()
	private _items: Array<UmbMediaPickerCollectionItemModel> = [];
	...
	#renderCard(item: UmbMediaPickerCollectionItemModel) {
...
export default UmbMediaPickerGridCollectionViewElement;

declare global {
	interface HTMLElementTagNameMap {
		'umb-media-picker-grid-collection-view': UmbMediaPickerGridCollectionViewElement;
	}
}
