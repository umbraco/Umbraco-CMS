...
import './column-layouts/media-picker-table-column-name.element.js';

@customElement('umb-media-picker-table-collection-view')
export class UmbMediaPickerTableCollectionViewElement extends UmbLitElement {
	@state()
	...
	#createTableItems(items: Array<UmbMediaPickerCollectionItemModel>) {
	...
	#getPropertyValueByAlias(sortOrder: number, item: UmbMediaPickerCollectionItemModel, alias: string) {
		switch (alias) {
			case 'createDate':
...
export default UmbMediaPickerTableCollectionViewElement;

declare global {
	interface HTMLElementTagNameMap {
		'umb-media-picker-table-collection-view': UmbMediaPickerTableCollectionViewElement;
	}
}
