...
/**
 * There is one URL picker property editor UI per number of links a picker holds, so that the type a URL picker
...
{
	/**
	 * Whether the editor holds more than one link.
	 */
	...
	protected override firstUpdated() {
		if (this._min && this._max && this._min > this._max) {
			console.warn(
				`Property '${this._label}' (URL Picker) has been misconfigured, 'min' is greater than 'max'. Please correct your data type configuration.`,
				this,
			);
		}
