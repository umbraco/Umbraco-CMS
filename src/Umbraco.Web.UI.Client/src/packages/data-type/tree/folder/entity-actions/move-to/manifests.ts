...
import { UMB_MOVE_DATA_TYPE_FOLDER_REPOSITORY_ALIAS } from './repository/constants.js';
...
export const manifests: Array<UmbExtensionManifest> = [
	{
		type: 'entityAction',
		kind: 'moveTo',
		alias: 'Umb.EntityAction.DataType.Folder.MoveTo',
		name: 'Move Data Type Folder Entity Action',
		forEntityTypes: [UMB_DATA_TYPE_FOLDER_ENTITY_TYPE],
		meta: {
			treeRepositoryAlias: UMB_DATA_TYPE_TREE_REPOSITORY_ALIAS,
			moveRepositoryAlias: UMB_MOVE_DATA_TYPE_FOLDER_REPOSITORY_ALIAS,
