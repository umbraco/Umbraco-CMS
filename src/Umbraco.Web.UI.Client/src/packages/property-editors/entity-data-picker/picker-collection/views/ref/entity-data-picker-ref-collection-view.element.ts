...
@customElement('umb-entity-data-picker-ref-collection-view')
export class UmbEntityDataPickerRefCollectionViewElement extends UmbLitElement {
	@state()
...
export { UmbEntityDataPickerRefCollectionViewElement as element };

declare global {
	interface HTMLElementTagNameMap {
		'umb-entity-data-picker-ref-collection-view': UmbEntityDataPickerRefCollectionViewElement;
	}
}
