...
import { css, html, map, nothing, property, state, when } from '@umbraco-cms/backoffice/external/lit';
...
/**
 * There is one dropdown property editor UI per number of values it holds, so that the type a dropdown property
...
{
	/**
	 * Whether the editor holds more than one of the configured values.
	 */
