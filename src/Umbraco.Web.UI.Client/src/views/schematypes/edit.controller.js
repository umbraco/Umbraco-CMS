/**
 * @ngdoc controller
 * @name Umbraco.Editors.SchemaType.EditController
 * @function
 *
 * @description
 * The controller for the schema type editor
 */
(function () {
    "use strict";

    function SchemaTypesEditController($scope, $routeParams, schemaTypeResource, dataTypeResource, editorState, contentEditingHelper, formHelper, navigationService, iconHelper, contentTypeHelper, notificationsService, $filter, $q, localizationService, overlayHelper, eventsService) {
        ...
        vm.page.navigation = [
			{
			    ...
			    "view": "views/schematypes/views/design/design.html",
			    "active": true
			}
        ];
        ...
        if ($routeParams.create) {
            ...
            schemaTypeResource.getScaffold($routeParams.id)
                .then(function(dt) {
                    init(dt);
        ...
        function loadSchemaType() {
            vm.page.loading = true;

            schemaTypeResource.getById($routeParams.id).then(function(dt) {
                init(dt);
        ...
        function save() {
            ...
            if(overlayHelper.getNumberOfOverlays() === 0) {
                ...
                contentEditingHelper.contentEditorPerformSave({
                    ...
                    saveMethod: schemaTypeResource.save,
                    scope: $scope,
        ...
        function syncTreeNode(dt, path, initialLoad) {
            navigationService.syncTree({ tree: "schematypes", path: path.split(","), forceReload: initialLoad !== true }).then(function(syncArgs) {
    ...
    angular.module("umbraco").controller("Umbraco.Editors.SchemaTypes.EditController", SchemaTypesEditController);
})();
