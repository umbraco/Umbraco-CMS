/**
 * @ngdoc controller
 * @name Umbraco.Editors.BlockRTE.BlockConfigurationOverlayController
 * @function
 *
 * @description
...
(function () {
    ...
    angular.module("umbraco").controller("Umbraco.PropertyEditors.BlockRTE.BlockConfigurationOverlayController", BlockConfigurationOverlayController);
