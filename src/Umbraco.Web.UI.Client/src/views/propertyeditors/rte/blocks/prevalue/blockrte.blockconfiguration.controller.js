/**
 * @ngdoc controller
 * @name Umbraco.Editors.BlockRTE.BlockConfigurationController
 * @function
 *
 * @description
...
(function () {
        ...
        vm.openBlockOverlay = function (block) {
            ...
            if (elementType) {
                ...
                const overlayModel = {
                    ...
                    view: "views/propertyeditors/rte/blocks/prevalue/blockrte.blockconfiguration.overlay.html",
                    size: "small",
    ...
    angular.module("umbraco").controller("Umbraco.PropertyEditors.BlockRTE.BlockConfigurationController", BlockConfigurationController);
