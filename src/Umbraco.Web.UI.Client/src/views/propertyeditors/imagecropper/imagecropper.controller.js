...
angular.module('umbraco')
    ...
    function ($rootScope, $routeParams, $scope, $log, mediaHelper, entityResource, cropperHelper, $timeout, editorState, umbRequestHelper, fileManager, angularHelper) {
        ...
        //Makes sure that the values are compatibile with the swaped property editor
        function propertyValueSwap() {
            if (angular.isString($scope.model.value)) {
