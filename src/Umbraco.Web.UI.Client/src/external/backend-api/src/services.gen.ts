...
export class UserService {
     ...
     * @throws ApiError
     */
    public static postCurrentUserByIdChangePassword(data: PostCurrentUserChangePasswordData): CancelablePromise<PostCurrentUserChangePasswordResponse> {
        return __request(OpenAPI, {
            method: 'POST',
