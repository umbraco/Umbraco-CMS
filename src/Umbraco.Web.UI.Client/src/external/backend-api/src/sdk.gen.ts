...
export class DocumentService {
     ...
     * @throws ApiError
     */
    public static getDocumentByIdPublishWithDescendantsStatusByTaskId(data: GetDocumentByIdPublishWithDescendantsStatusByTaskIdData): CancelablePromise<GetDocumentByIdPublishWithDescendantsStatusByTaskIdResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/umbraco/management/api/v1/document/{id}/publish-with-descendants/status/{taskId}',
            path: {
                id: data.id,
                taskId: data.taskId
            },
