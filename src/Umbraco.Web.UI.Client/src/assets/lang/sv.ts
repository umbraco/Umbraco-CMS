...
export default {
	...
	actions: {
		...
		copyTo: 'Kopiera till',
		create: 'Skapa',
		createFor: (name: string) => (name ? `Skapa för ${name}` : 'Skapa'),
	...
	actionDescriptions: {
		assignDomain: 'Ger behörighet att redigera språk och värdnamn för ett dokument',
		auditTrail: 'Ger behörighet att visa ett dokuments historik',
		browse: 'Ger behörighet att visa ett dokument',
		changeDocType: 'Ger behörighet att ändra dokumenttyp för ett dokument',
		copy: 'Ger behörighet att kopiera ett dokument',
		create: 'Ger behörighet att skapa ett dokument',
		delete: 'Ger behörighet att ta bort ett dokument',
		move: 'Ger behörighet att flytta ett dokument',
		protect: 'Ger behörighet att ange och ändra åtkomstbegränsningar för ett dokument',
		publish: 'Ger behörighet att publicera ett dokument',
		unpublish: 'Ger behörighet att avpublicera ett dokument',
		read: 'Ger behörighet att läsa ett dokument',
		rights: 'Ger behörighet att ändra behörigheter för ett dokument',
		rollback: 'Ger behörighet att återställa ett dokument till en tidigare version',
		sendtopublish: 'Ger behörighet att skicka ett dokument för godkännande före publicering',
		sendToTranslate: 'Ger behörighet att skicka ett dokument för översättning',
		sort: 'Ger behörighet att ändra sorteringsordningen för dokument',
		translate: 'Ger behörighet att översätta ett dokument',
		update: 'Ger behörighet att spara ändringar i ett dokument',
		createblueprint: 'Ger behörighet att skapa en innehållsmall',
		notify: 'Ger behörighet att konfigurera notifieringar för dokument',
	},
	assignDomain: {
	...
	blockEditor: {
		actionEnterSortMode: 'Sorteringsläge',
	...
	codefile: {
		createFolderIllegalChars: 'Mappnamnet får inte innehålla ogiltiga tecken.',
		deleteItemFailed: 'Det gick inte att ta bort objektet: %0%',
	},
	collection: {
		noItemsTitle: 'Inga objekt',
		addCollectionConfiguration: 'Lägg till samling',
		cardViewLabel: 'Kort',
	...
	content: {
		...
		noItemsToShow: 'Det finns inga objekt att visa',
	...
	login: {
		...
		forgottenPasswordInstruction:
			'Ett e-postmeddelande kommer att skickas till den angivna adressen med en länk för att återställa ditt lösenord',
		requestPasswordResetConfirmation:
			'Ett e-postmeddelande med instruktioner för lösenordsåterställning kommer att skickas till den angivna adressen om den matchar våra uppgifter',
		...
		userInviteWelcomeMessage:
			'Hej och välkommen till Umbraco! Inom bara 1 minut är du redo att börja, vi behöver bara att du ställer in ett lösenord.',
		userInviteExpiredMessage:
			'Välkommen till Umbraco! Tyvärr har din inbjudan gått ut. Vänligen kontakta din administratör och be dem skicka den igen.',
	...
	media: {
		...
		disallowedFileExtension: (extension: string) =>
			`Det går inte att ladda upp .${extension}-filer eftersom ingen mediatyp stöder den filtypen`,
		disallowedMediaTypeNotAllowedHere: (extension: string, mediaTypeName: string) =>
			`Det går inte att ladda upp .${extension}-filer här eftersom mediatypen ${mediaTypeName} inte är tillåten på den här platsen`,
		disallowedMediaTypesNotAllowedHere: (extension: string, mediaTypeNames: string) =>
			`Det går inte att ladda upp .${extension}-filer här eftersom de tillhörande mediatyperna (${mediaTypeNames}) inte är tillåtna på den här platsen`,
		disallowedMediaType: "Det går inte att ladda upp filen eftersom mediatypen med aliaset '%0%' inte är tillåten här",
		invalidFileName: 'Det går inte att ladda upp filen eftersom filnamnet är ogiltigt',
		invalidFileSize: 'Det går inte att ladda upp filen eftersom den är för stor',
		maxFileSize: 'Maximal filstorlek är',
		mediaRoot: 'Rotnod för media',
		createFolderFailed: 'Det gick inte att skapa en mapp under det överordnade objektet med id %0%',
		renameFolderFailed: 'Det gick inte att byta namn på mappen med id %0%',
		dragAndDropYourFilesIntoTheArea: 'Drag och släpp dina filer i denna yta',
		fileSecurityValidationFailure: 'En eller flera säkerhetskontroller av filen misslyckades',
		moveToSameFolderFailed: 'Ursprungsmappen och målmappen får inte vara samma mapp',
		uploadNotAllowed: 'Uppladdning är inte tillåten på den här platsen.',
		uploadValidationFailed: (mediaTypeName: string) =>
			`Mediatypen ${mediaTypeName} har en eller flera obligatoriska egenskaper. Filer av den typen måste laddas upp en i taget via menyn 'Skapa'`,
	},
	member: {
	...
	contentType: {
		copyFailed: 'Det gick inte att kopiera innehållstypen',
		moveFailed: 'Det gick inte att flytta innehållstypen',
		contentTypes: 'Innehållstyper',
	},
	mediaType: {
		copyFailed: 'Det gick inte att kopiera mediatypen',
		moveFailed: 'Det gick inte att flytta mediatypen',
		autoPickMediaType: 'Välj automatiskt',
	},
	memberType: {
		copyFailed: 'Det gick inte att kopiera medlemstypen',
	},
	moveOrCopy: {
	...
	references: {
		itemHasNoReferences: 'Det här objektet har inga referenser.',
		labelUsedByItems: 'Refereras av',
