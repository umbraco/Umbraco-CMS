...
export default {
	...
	assignDomain: {
		...
		setDomains: 'Domæner',
		addCurrent: 'Tilføj nuværende domæne',
	},
	buttons: {
	...
	auditTrails: {
		...
		contentversionpreventcleanup: 'Oprydning deaktiveret for version: %0%',
		contentversionenablecleanup: 'Oprydning aktiveret for version: %0%',
		smallContentVersionPreventCleanup: 'Gem',
		smallContentVersionEnableCleanup: 'Gem',
	},
	codefile: {
	...
	member: {
		...
		duplicateMemberLogin: 'Der findes allerede et medlem med dette login',
		memberHasGroup: "Medlemmet er allerede i gruppen '%0%'",
		memberHasPassword: 'Medlemmet har allerede angivet en adgangskode',
		memberLockoutNotEnabled: 'Spærring er ikke aktiveret for dette medlem',
		memberNotInGroup: "Medlemmet er ikke i gruppen '%0%'",
	...
	create: {
		...
		noDocumentTypesAllowedAtRoot:
			'Der er ingen tilladte dokumenttyper tilgængelige for at lave indhold her. Du skal tillade dette i <strong>Dokumenttyper</strong> inde i sektionen <strong>Indstillinger</strong>, ved at ændre <strong>Tillad på rodniveau</strong> indstillingen under <strong>Struktur</strong>.',
		noMediaTypes:
			'Der kunne ikke findes nogen tilladte mediatyper. Du skal tillade disse i indstillinger under <strong>Mediatyper</strong>.',
	...
	defaultdialogs: {
		...
		linknewwindow: 'Åbn i nyt vindue?',
		...
		openInNewWindow: 'Åbn linket i et nyt vindue eller fane',
	...
	renamecontainer: {
		...
		folderWasRenamed: '%0% blev omdøbt til %1%',
	},
	editdatatype: {
	...
	packager: {
		...
		packageMetaData: 'Pakke metadata',
		...
		packageUninstallConfirm: 'Bekræft afinstallering',
		...
		packageMigrationsRun: 'Kør afventende pakkemigreringer',
	...
	dynamicRoot: {
		...
		originParentDesc: 'Den overliggende node af kilden i denne redigeringssession',
		originCurrentTitle: 'Nuværende',
		originCurrentDesc: 'Kildenoden for denne redigeringssession',
	...
	mediaPicker: {
		...
		trashed: 'Slettet',
		openMedia: 'Åbn i mediebiblioteket',
		...
		openMediaPicker: 'Åbn medievælger',
	},
	relatedlinks: {
	...
	rollback: {
		...
		pagination: 'Viser version %0% til %1% af %2% versioner',
		versions: 'Versioner',
	...
	settings: {
		...
		importDocumentTypeHelp:
			'For at importere en dokumenttype, find ".udt"-filen på din computer ved at\n      klikke på "Gennemse"-knappen og klik "Import" (Du vil blive bedt om bekræftelse i næste trin)\n    ',
		...
		noPropertiesDefinedOnTab:
			'Der er ikke defineret nogen egenskaber på denne fane. Klik på linket "tilføj en ny egenskab"\n      øverst for at oprette en ny egenskab.\n    ',
	},
	sort: {
		...
		sortByFieldHeadline: 'Sortér efter felt',
		sortByFieldSentence: 'Sortér alle underelementer efter',
		sortByFieldDirectionLabel: 'Retning',
		sortByFieldAscending: 'Stigende',
		sortByFieldDescending: 'Faldende',
	...
	speechBubbles: {
		...
		folderUploadNotAllowed:
			'Denne fil uploades som en del af en mappe, men det er ikke tilladt at oprette en ny mappe her',
		folderCreationNotAllowed: 'Det er ikke tilladt at oprette en ny mappe her',
		memberGroupNameDuplicate: 'Der findes allerede en anden medlemsgruppe med samme navn',
		dictionaryItemExportedSuccess: 'Ordbogselement(er) blev eksporteret til en fil',
		dictionaryItemExportedError: 'Der opstod en fejl under eksporten af ordbogselementet/-elementerne',
		dictionaryItemImported: 'Følgende ordbogselement(er) er blevet importeret!',
		preventCleanupEnableError: 'Der opstod en fejl under aktivering af versionsoprydning for %0%',
		preventCleanupDisableError: 'Der opstod en fejl under deaktivering af versionsoprydning for %0%',
	...
	grid: {
		...
		clickToInsertMacro: 'Klik for at indsætte makro',
		warning: 'Advarsel',
		warningText:
	...
	languages: {
		...
		none: 'ingen',
		culture: 'ISO-kode',
		invariantPropertyUnlockHelp: '<strong>%0%</strong> deles på tværs af sprog og segmenter.',
		invariantCulturePropertyUnlockHelp: '<strong>%0%</strong> deles på tværs af alle sprog.',
		invariantSegmentPropertyUnlockHelp: '<strong>%0%</strong> deles på tværs af alle segmenter.',
		invariantLanguageProperty: 'Delt: Sprog',
		invariantSegmentProperty: 'Delt: Segmenter',
	},
	macro: {
	...
	templateEditor: {
		addDefaultValue: 'Tilføj standardværdi',
	...
	user: {
		...
		profile: 'Profil',
		searchAllChildren: 'Søg alle underliggende noder',
		...
		duplicateLogin: 'Der findes allerede en bruger med dette login',
		nameRequired: 'Påkrævet - indtast et navn for denne bruger',
		passwordRequiresDigit: "Adgangskoden skal indeholde mindst ét tal ('0'-'9')",
		passwordRequiresLower: "Adgangskoden skal indeholde mindst ét lille bogstav ('a'-'z')",
		passwordRequiresNonAlphanumeric: 'Adgangskoden skal indeholde mindst ét tegn, der ikke er alfanumerisk',
		passwordRequiresUniqueChars: 'Adgangskoden skal indeholde mindst %0% forskellige tegn',
		passwordRequiresUpper: "Adgangskoden skal indeholde mindst ét stort bogstav ('A'-'Z')",
		passwordTooShort: 'Adgangskoden skal være på mindst %0% tegn',
		userHasPassword: 'Brugeren har allerede angivet en adgangskode',
		userHasGroup: "Brugeren er allerede i gruppen '%0%'",
		userLockoutNotEnabled: 'Spærring er ikke aktiveret for denne bruger',
		userNotInGroup: "Brugeren er ikke i gruppen '%0%'",
	},
	validation: {
	...
	visuallyHiddenTexts: {
		...
		openBackofficeSearch: 'Åbn backoffice søgning',
		openCloseBackofficeHelp: 'Åbn/Luk backoffice hjælp',
		openCloseBackofficeProfileOptions: 'Åbn/Luk dine profilindstillinger',
		...
		newPartialViewMacro: 'Delvist View Makro',
		newMember: 'Medlem',
		...
		dictionaryListCaption: 'Ordbogselementer',
		...
		maxAmount: 'Maksimalt antal',
		contextDialogDescription: 'Udfør handlingen %0% på noden %1%',
	...
	references: {
		...
		labelUsedByMediaTypes: 'Brugt i medietyper',
		labelUsedByMemberTypes: 'Brugt i medlemstyper',
		...
		labelUsedByDocumentTypes: 'Brugt i dokumenttyper',
	...
	logViewer: {
		...
		searchOurUmbraco: 'Søg på Umbraco forummet',
		searchThisMessageOnOurUmbracoForumsAndDocs: 'Søg efter denne besked på Umbraco forummet',
		searchOurUmbracoWithGoogle: 'Søg på Umbraco forummet med Google',
		searchOurUmbracoForumsUsingGoogle: 'Søg på Umbraco forummet med Google',
		searchUmbracoDocs: 'Søg i Umbraco dokumentationen',
		searchThisMessageInUmbracoDocs: 'Søg efter denne besked i Umbraco dokumentationen',
		...
		pollingInterval: (seconds: number) => `Hver ${seconds} sekunder`,
		pollingActive: (seconds: number) => `Henter hver ${seconds}s`,
		noResults: 'Beklager, vi kan ikke finde det du leder efter.',
		sortLogs: 'Sorter logbeskeder',
		loadingLogs: 'Indlæser logbeskeder...',
		searchLogs: 'Søg logbeskeder',
		searchLogsPlaceholder: 'Søg logbeskeder...',
		searchFor: 'Søg efter %0%',
		findLogsWith: 'Find logbeskeder med %0%',
		query: 'Forespørgsel',
		searchName: 'Søgenavn',
		startPolling: 'Start overvågning',
		choosePollingInterval: 'Vælg opdateringsinterval',
		selectLogLevels: 'Vælg logtyper',
		all: 'Alle',
		from: 'Fra',
		to: 'Til',
		unableToViewLogs: 'Kan ikke vise logfiler',
		...
		viewLogsLabel: 'Vis %0% logbeskeder',
	},
	clipboard: {
		...
		confirmClearDescription: 'Er du sikker på at du vil rydde udklipsholderen?',
		confirmPasteHeadline: 'Indsæt fra udklipsholderen',
	...
	preview: {
		...
		openWebsiteTitle: 'Åbn forhåndsvisning i nyt vindue',
	...
	tiptap: {
		...
		extGroup_formatting: 'Tekstformatering',
		extGroup_interactive: 'Inaktive elementer',
		extGroup_media: 'Medier',
		extGroup_structure: 'Indholdsstruktur',
