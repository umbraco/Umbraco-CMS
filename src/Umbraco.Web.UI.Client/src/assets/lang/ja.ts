...
export default {
	actions: {
		...
		copyTo: '複製先',
		create: '新規作成',
		createFor: (name: string) => (name ? `${name} 用の項目を作成` : '新規作成'),
	...
	buttons: {
		...
		styleShow: 'スタイルの表示',
		tableInsert: '表の挿入',
		confirmActionCancel: 'キャンセル',
	},
	collection: {
		noItemsTitle: '項目がありません',
		addCollectionConfiguration: 'コレクションを追加',
	},
	content: {
		isPublished: '公開されました',
		about: 'このページについて',
	...
	prompt: {
		...
		unsavedChanges: '未保存の変更を破棄',
		unsavedChangesWarning: 'このページを離れてもよろしいですか？未保存の変更があります。',
		confirmListViewPublish: '公開すると、選択した項目が公開されます。',
		confirmListViewUnpublish: '非公開にすると、選択した項目とそのすべての子項目が公開されなくなります。',
		confirmPublish: '公開すると、このコンテンツと公開済みの子項目が公開されます。',
		confirmUnpublish: '非公開にすると、このコンテンツは公開されなくなります。',
		doctypeChangeWarning: '未保存の変更があります。ドキュメントタイプを変更すると、変更は破棄されます。',
	},
	bulk: {
		done: '完了',
		deletedItem: '%0% 件の項目を削除しました',
		deletedItems: '%0% 件の項目を削除しました',
		deletedItemOfItem: '%1% 件中 %0% 件の項目を削除しました',
		deletedItemOfItems: '%1% 件中 %0% 件の項目を削除しました',
		publishedItem: '%0% 件の項目を公開しました',
		publishedItems: '%0% 件の項目を公開しました',
		publishedItemOfItem: '%1% 件中 %0% 件の項目を公開しました',
		publishedItemOfItems: '%1% 件中 %0% 件の項目を公開しました',
		unpublishedItem: '%0% 件の項目を非公開にしました',
		unpublishedItems: '%0% 件の項目を非公開にしました',
		unpublishedItemOfItem: '%1% 件中 %0% 件の項目を非公開にしました',
		unpublishedItemOfItems: '%1% 件中 %0% 件の項目を非公開にしました',
		movedItem: '%0% 件の項目を移動しました',
		movedItems: '%0% 件の項目を移動しました',
		movedItemOfItem: '%1% 件中 %0% 件の項目を移動しました',
		movedItemOfItems: '%1% 件中 %0% 件の項目を移動しました',
		copiedItem: '%0% 件の項目をコピーしました',
	...
	defaultdialogs: {
		...
		confirmdelete: (name: string) => `${name ? `<strong>${name}</strong> を` : ''}削除しますか？`,
		confirmdisable: '無効にしますか？',
		confirmlogout: 'ログアウトしますか？',
		confirmSure: '本当にいいですか？',
		confirmTrash: (name: string) => `<strong>${name}</strong> をごみ箱に移動しますか？`,
		cut: '切り取り',
	...
	placeholders: {
		...
		label: 'ラベル...',
		enterDescription: '概要を入力してください...',
		search: '検索する...',
		filter: '条件で絞り込む...',
		enterTags: '入力してタグを追加 (各タグの後に Enter を押してください)...',
		enterAlias: 'エイリアスを入力してください...',
	},
	editcontenttype: {
	...
	contentTypeEditor: {
		...
		addTab: 'タブを追加',
		deleteTab: 'タブを削除',
		displaySettingsHeadline: '外観',
		displaySettingsLabelOnLeft: 'ラベルを左に表示',
		displaySettingsLabelOnTop: 'ラベルを上に表示 (全幅)',
		confirmDeleteTabMessage: 'タブ <strong>%0%</strong> を削除しますか？',
		confirmDeleteGroupMessage: 'グループ <strong>%0%</strong> を削除しますか？',
		confirmDeletePropertyMessage: 'プロパティ <strong>%0%</strong> を削除しますか？',
		confirmDeleteTabNotice: 'このタブの下にある項目もすべて削除されます。',
		confirmDeleteGroupNotice: 'このグループの下にある項目もすべて削除されます。',
	},
	templateEditor: {
	...
	validation: {
		validation: '検証',
		validateNothing: '検証なし',
		validateAsEmail: 'メールで検証',
		validateAsNumber: '数値で検証',
		validateAsUrl: 'URL で検証',
		validationPattern: '検証のパターン',
		enterCustomValidation: '... またはカスタム検証を入力',
		fieldIsMandatory: '必須フィールドです',
		mandatoryMessageLabel: 'フィードバック メッセージ',
		invalidDate: '無効な日付です',
		invalidNumber: '数値ではありません',
		invalidNumberStepSize: '有効な数値のステップ サイズではありません',
		invalidEmail: '無効なメール アドレスです',
		invalidNull: '値を null にすることはできません',
		invalidEmpty: '値を空にすることはできません',
