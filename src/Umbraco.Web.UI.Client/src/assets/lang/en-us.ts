...
export default {
	...
	user: {
		...
		mediastartnodehelp: 'Limit the media library to a specific item',
		mediastartnodes: 'Media access',
		mediastartnodeshelp: 'Limit the media library to specific items',
		modules: 'Sections',
		...
		startnodehelp: 'Limit the content tree to a specific item',
		startnodes: 'Content access',
		startnodeshelp: 'Limit the content tree to specific items',
		updateDate: 'Updated',
