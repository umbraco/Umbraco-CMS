/** 
* Origin File: https://github.com/umbraco/Umbraco-CMS/tree/v13/contrib/src/Umbraco.Core/EmbeddedResources/Lang/zh.xml 
...
export default{
	...
	content: {
		...
		scheduledPublishDocumentation: "<a href=\"https://docs.umbraco.com/umbraco-cms/fundamentals/data/scheduled-publishing#timezones\" target=\"_blank\" rel=\"noopener\">这是什么意思？</a>",
	},
	media: {
		clickToUpload: "点击上传",
	...
	defaultdialogs: {
		...
		regexSearchError: "<a target='_blank' rel='noopener' href='http://regexlib.com'>regexlib.com</a>的服务暂时出现问题。",
	...
	installer: {
		...
		databaseText: "完成本步，需要配置一个正确的连接字符串（“connection string”）。<br />\n      如有必要，请联系您的系统管理员。\n      如果您是本机安装，请使用管理员账号。",
		...
		permissionsAlmostPerfect: "<strong>您当前的安全设置满足要求!</strong><br /><br />\n        您可以毫无问题的运行系统，但您不能安装系统所推荐的扩展包的完整功能。",
		permissionsHowtoResolve: "如何解决",
		permissionsHowtoResolveLink: "点击阅读文字版",
		permissionsHowtoResolveText: "观看我们的<strong>视频教程</strong> ",
		permissionsMaybeAnIssue: "<strong>您当前的安全设置有问题！</strong>\n      <br/><br />\n      您可以毫无问题的运行系统，但您不能新建文件夹、也不能安装系统所推荐的包的完整功能。    ",
		permissionsNotReady: "<strong>您当前的安全设置不适合于系统!</strong>\n          <br /><br />\n         您需要修改系统访问权限。",
		permissionsPerfect: "<strong>您当前的权限设置正确！</strong><br /><br />\n             您可以运行系统并安装其它扩展包！",
		...
		theEndInstallSuccess: "您想要<strong>立即开始</strong>请点“运行系统”<br />如果您是<strong>新手</strong>, 您可以得到相当丰富的学习资源。",
		theEndOpenUmbraco: "<h3>运行系统</h3>\n管理您的网站, 运行后台添加内容，\n也可以添加模板和功能。",
		Unavailable: "无法连接到数据库。",
		Version3: "系统版本 3",
		Version4: "系统版本 4",
		watch: "观看",
		welcomeIntro: "本向导将指引您完成配置和安装（或升级安装）系统\n<br /><br />\n按 <strong>“下一步”</strong>进入向导。",
	},
	language: {
		cultureCode: "语言代码",
		displayName: "语言名称",
	...
	login: {
		...
		resetPasswordEmailCopyFormat: "<p>您的用户名登录到 Umbraco 后台是: <strong>%0%</strong></p><p>点击 <a href=\"%1%\"><strong>这里</strong></a> 重置密码，或复制链接粘贴到您的浏览器访问:</p><p><em>%1%</em></p>",
	},
	main: {
		dashboard: "仪表板",
		sections: "区域",
	...
	publish: {
		...
		publishHelp: "点 <em>确定</em> 发布 <strong>%0%</strong><br/><br />\n       要发布当前页和所有子页，请选中 <em>全部发布</em> 发布所有子页。\n     ",
	},
	colorpicker: {
	...
	settings: {
		...
		importDocumentTypeHelp: "要导入文档类型，请点击“浏览”按钮，再点击“导入”，然后在您电脑上查找 \".udt\"文件导入（下一页中需要您再次确认）",
		newtabname: "新建选项卡标题",
		nodetype: "节点类型",
		objecttype: "类型",
		stylesheet: "样式表",
	...
	contentTypeEditor: {
		...
		compositionsDescription: "从现有文档类型继承选项卡和属性。如果存在同名的选项卡, 则新选项卡将添加到当前文档类型或合并。",
