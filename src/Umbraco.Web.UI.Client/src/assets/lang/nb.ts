...
export default {
	...
	login: {
		...
		forgottenPasswordInstruction:
			'En e-post vil bli sendt til den angitte adressen med en lenke for å tilbakestille passordet ditt',
		requestPasswordResetConfirmation:
			'En e-post med instruksjoner for tilbakestilling av passordet vil bli sendt til den angitte adressen hvis den samsvarer med våre opplysninger',
		...
		userInviteWelcomeMessage:
			'Hei og velkommen til Umbraco! Om bare 1 minutt er du klar til å starte, vi trenger bare at du setter et passord.',
		userInviteExpiredMessage:
			'Velkommen til Umbraco! Dessverre har invitasjonen din utløpt. Kontakt administratoren din og be dem sende den på nytt.',
