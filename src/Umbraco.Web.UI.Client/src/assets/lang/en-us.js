export default {
	...
	"dialogs": {
		...
		"deployTransferNowDescription": "<p>You are about to transfer <em>%0%</em> directly to %1%, without adding it to the queue.</p>",
		"deployAddToQueueHeadline": "<h4 class=\"bold\">Queue <em>%0%</em> for transfer to <em>%1%</em></h4>",
		"deployAddToQueueDescription": "<p>This will put <em class=\"bold\">%0%</em> in the queue for the next transfer, nothing will be transfered yet.</p>",
		"deployAddToQueueCultureDescription": "<p>Select language to include in transfer:</p>",
		"deployAddToQueueChildPageDescription": "<p>Should all items below <em class=\"bold\">%0%</em> be included in the transfer?</p>",
		...
		"deployAddToQueueDone": "<h5>Changes have been queued</h5><p>When you are ready to transfer your full set of changes, go to the <a href=\"#/content?dashboard=deploy\">workspace dashboard</a> to start the transfer.</p>",
