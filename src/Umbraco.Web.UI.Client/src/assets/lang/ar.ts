...
export default {
	...
	rollback: {
		...
		diffHelp: '<del>النص الأحمر</del> سيتم حذفه في الإصدار المحدد، <ins>النص الأخضر</ins> سيتم إضافته.',
		showDiff: 'عرض الاختلافات بين الإصدار الحالي (المسودة) والإصدار المحدد.',
	...
	sort: {
		...
		sortByFieldHeadline: 'الفرز حسب الحقل',
		sortByFieldSentence: 'فرز جميع العناصر الفرعية حسب',
		sortByFieldDirectionLabel: 'الاتجاه',
		sortByFieldAscending: 'تصاعدي',
		sortByFieldDescending: 'تنازلي',
		sortByFieldNameOption: 'الاسم',
	...
	logViewer: {
		...
		polling: 'استطلاع',
		pollingInterval: (seconds: number) => `كل ${seconds} ثانية`,
		pollingActive: (seconds: number) => `استطلاع كل ${seconds} ثانية`,
	},
	clipboard: {
	...
	settingsDashboard: {
		...
		communityDescription: 'اطرح سؤالاً في منتدى مجتمعنا.',
