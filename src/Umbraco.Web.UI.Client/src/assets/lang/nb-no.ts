...
export default {
	...
	content: {
		...
		languagesToSchedule: 'Hvilke språk vil du tidsplanlegge?',
	...
	blockEditor: {
		...
		allowBlockInRoot: 'Tillat i rot',
		allowBlockInRootHelp: 'Gjør denne blokken tilgjengelig i rotdelen av oppsettet.',
		allowedBlockColumns: 'Tilgjengelige kolonnebredder',
		allowedBlockColumnsHelp: 'Definer de forskjellige antall kolonner denne blokken kan strekke seg over. Dette hindrer ikke blokker i å plasseres i områder med mindre kolonnebredde.',
		...
		areaAliasHelp: 'Når du bruker GetBlockGridHTML() for å gjengi blokkrutenettet, vil aliaset bli gjengitt i markeringen som et \'data-area-alias\'-attributt. Bruk aliasattributtet for å målrette elementet for området. Eksempel: .umb-block-grid__area[data-area-alias="MyAreaAlias"] { ... }',
		...
		areasConfigurationsHelp: "For å aktivere nesting av blokker innenfor denne blokken, definer ett eller flere områder. Områder følger oppsettet definert av deres egne rutenettkolonnekonfigurasjon. 'Kolonnebredde' og 'radbredde' for hvert område kan justeres ved å bruke skaleringshåndtaket nederst i høyre hjørne av det valgte området.'",
		areasLayoutColumns: 'Rutenettkolonner for områder',
		areasLayoutColumnsHelp: 'Definer hvor mange kolonner som vil være tilgjengelige for områder. Hvis ikke definert, vil antall kolonner definert for hele oppsettet bli brukt.',
		...
		getSampleDescription: 'Dette vil legge til grunnleggende blokker og hjelpe deg å komme i gang med blokkrutenett-redigereren. Du får blokker for overskrift, rik tekst, bilde, samt en oppsett for to kolonner.',
		...
		headlineAddSettingsElementType: 'Knytt til en innstillings-ElementType',
		...
		propertyEditorNotSupported: "Egenskap '%0%' bruker redigerer '%1%' som ikke støttes i blokker.",
