/** 
* Origin File: https://github.com/umbraco/Umbraco-CMS/tree/v13/contrib/src/Umbraco.Core/EmbeddedResources/Lang/nl.xml 
...
export default{
	...
	contentTypeEditor: {
		...
		memberCanEditDescription: "Toestaan dat deze eigenschap kan worden gewijzigd door het lid op zijn profiel\n      pagina.\n    ",
		isSensitiveData: "Omvat gevoelige gegevens",
		isSensitiveDataDescription: "Verberg deze eigenschap voor de content editor die geen toegang heeft tot\n      het bekijken van gevoelige informatie.\n    ",
		showOnMemberProfile: "Toon in het profiel van leden",
		showOnMemberProfileDescription: "Toelaten dat deze eigenschap wordt getoond op de profiel pagina van het\n      lid.\n    ",
	...
	healthcheck: {
		...
		scheduledHealthCheckEmailBody: "<html><body><p>Resultaten van de geplande Umbraco Health Checks uitgevoerd op %0% op %1%:</p>%2%</body></html>",
