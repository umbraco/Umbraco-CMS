...
export default {
	...
	blockEditor: {
		...
		blockVariantConfigurationNotSupported:
			'One or more Block Types of this Block Editor is using a Element-Type that is configured to Vary By Culture or Vary By Segment. This is not supported on a Document that does not vary by Culture or Segment.',
	},
