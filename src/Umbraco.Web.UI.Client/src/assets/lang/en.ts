/**
 * Origin File: https://github.com/umbraco/Umbraco-CMS/tree/v13/contrib/src/Umbraco.Core/EmbeddedResources/Lang/en.xml
...
export default {
	actions: {
		...
		toggleHideUnavailable: 'Hide unavailable options',
