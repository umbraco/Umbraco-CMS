...
export default {
	...
	globalSearch: {
		dataTypeGlobalSearch: 'Data Type Global Search',
		dictionaryGlobalSearch: 'Dictionary Global Search',
		documentGlobalSearch: 'Document Global Search',
		documentTypeGlobalSearch: 'Document Type Global Search',
		documents: 'Documents',
		elementGlobalSearch: 'Element Global Search',
		mediaGlobalSearch: 'Media Global Search',
		mediaTypeGlobalSearch: 'Media Type Global Search',
		memberGlobalSearch: 'Member Global Search',
		memberTypeGlobalSearch: 'Member Type Global Search',
		navigateSearchProviders: 'Navigate search providers',
		navigateSearchResults: 'Navigate search results',
		templateGlobalSearch: 'Template Global Search',
	},
	headers: {
		page: 'Page',
	},
	...
	logViewer: {
		...
		polling: 'Polling',
		pollingInterval: (seconds: number) => `Every ${seconds} seconds`,
		pollingActive: (seconds: number) => `Polling every ${seconds}s`,
		noResults: 'Sorry, we cannot find what you are looking for.',
		sortLogs: 'Sort logs',
		loadingLogs: 'Loading log messages...',
		searchLogs: 'Search logs',
		searchLogsPlaceholder: 'Search logs...',
		searchFor: 'Search for %0%',
		findLogsWith: 'Find logs with %0%',
		query: 'Query',
		searchName: 'Search name',
		startPolling: 'Start polling',
		choosePollingInterval: 'Choose polling interval',
		selectLogLevels: 'Select log levels',
		all: 'All',
		from: 'From',
		to: 'To',
		unableToViewLogs: 'Unable to view logs',
		logFileTooLarge: "Today's log file is too large to be viewed and would cause performance problems.",
		narrowDateRangeOrOpenManually:
