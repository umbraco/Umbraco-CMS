...
export default {
	...
	general: {
		...
		reorderMoveUpPosition: (position: string, total: string) => `Move up (${position} of ${total})`,
		reorderMoveDown: 'Move down',
		reorderMoveDownPosition: (position: string, total: string) => `Move down (${position} of ${total})`,
		rename: 'Rename',
		renew: 'Renew',
		required: 'Required',
		reset: 'Reset',
