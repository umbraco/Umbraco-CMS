...
export default {
	...
	buttons: {
		...
		linkInsert: 'Inserir Ligação',
		linkLocal: 'Inserir ligação local (âncora)',
	...
	content: {
		...
		alternativeUrls: 'Ligações Alternativas',
		...
		mediaLinks: 'Ligação para itens de multimédia',
		...
		noMediaLink: 'Este item de multimédia não tem ligações',
	...
	media: {
		...
		renameFolderFailed: 'Falha ao renomear a pasta com o id %0%',
	...
	create: {
		...
		newStyleSheetFile: 'Nova Folha de Estilos',
	},
	dashboard: {
	...
	defaultdialogs: {
		...
		insertAnchor: 'Inserir ligação local',
		...
		link: 'Ligação',
		linkinternal: 'Ligação interna',
		linklocaltip: 'Ao usar ligações locais, insira "#" à frente da ligação',
		...
		linkToPage: 'Ligação para o documento',
		openInNewWindow: 'Abre a ligação numa nova janela ou separador',
		linkToMedia: 'Ligação para multimédia',
		...
		selectLink: 'Configurar ligação',
		addLink: 'Adicionar Ligação',
		updateLink: 'Atualizar Ligação',
	...
	general: {
		...
		current: 'atual',
		embed: 'Incorporar',
		addEditLink: 'Adicionar/Editar Ligação',
	...
	installer: {
		...
		databaseErrorWebConfig:
			'Não foi possível guardar o ficheiro web.config. Por favor, modifique a cadeia de ligação manualmente.',
		...
		databaseNotFound:
			'<p>Base de dados não encontrada! Por favor, verifique se a informação na "cadeia de ligação" do ficheiro "web.config" está correta.</p><p>Para prosseguir, por favor edite o ficheiro "web.config" (usando o Visual Studio ou o seu editor de texto favorito), desloque-se até ao final, adicione a cadeia de ligação para a sua base de dados na chave chamada "UmbracoDbDSN" e guarde o ficheiro.</p><p>Clique no botão <strong>tentar novamente</strong> quando terminar.<br /><a href="https://our.umbraco.com/documentation/Reference/Config/webconfig/" target="_blank" rel="noopener">Mais informação sobre como editar o web.config aqui</a>.</p>',
		databaseText:
			'Para completar este passo, deve saber alguma informação sobre o seu servidor de base de dados ("cadeia de ligação").<br />   Por favor, contacte o seu ISP, se necessário.   Se estiver a instalar numa máquina ou servidor local, poderá precisar de informação do seu administrador de sistema.',
		databaseUpgrade:
		...
		permissionsResolveFolderIssuesLink:
			'Siga esta ligação para mais informação sobre problemas com ASP.NET e criação de pastas',
	...
	settings: {
		...
		noPropertiesDefinedOnTab:
			'Nenhuma propriedade definida neste separador. Clique na ligação "adicionar uma nova propriedade" no topo para criar uma nova propriedade.',
	...
	speechBubbles: {
		...
		cssErrorHeader: 'Folha de estilos não guardada',
		cssSavedHeader: 'Folha de estilos guardada',
		cssSavedText: 'Folha de estilos guardada sem erros',
		...
		editStylesheetPropertySaved: 'Propriedade da Folha de Estilos Guardada',
		editStylesheetSaved: 'Folha de estilos guardada',
	...
	stylesheet: {
		...
		editorRulesHelp: 'Defina os estilos que devem estar disponíveis no editor de texto rico para esta folha de estilos',
		editstylesheet: 'Editar folha de estilos',
		editstylesheetproperty: 'Editar propriedade da folha de estilos',
	...
	user: {
		...
		userinviteWelcomeMessage:
			'Olá e bem-vindo ao Umbraco! Em apenas 1 minuto estará pronto, só precisamos que configure uma palavra-passe e adicione uma imagem para o seu avatar.',
		userinviteExpiredMessage:
			'Bem-vindo ao Umbraco! Infelizmente, o seu convite expirou. Por favor, contacte o seu administrador e peça-lhe para o reenviar.',
	...
	references: {
		...
		deleteWarning:
			'Este item ou os seus descendentes estão a ser usados. A eliminação pode levar a ligações quebradas no seu website.',
		unpublishWarning:
			'Este item ou os seus descendentes estão a ser usados. A despublicação pode levar a ligações quebradas no seu website. Por favor, tome as medidas apropriadas.',
	...
	startupDashboard: {
		fallbackHeadline: 'Bem-vindo ao CMS Amigável',
		fallbackDescription:
	...
	blockEditor: {
		...
		headlineAddCustomStylesheet: 'Selecionar folha de estilos',
		headlineAddThumbnail: 'Escolher miniatura',
		labelcreateNewElementType: 'Criar novo Tipo de Elemento',
		labelCustomStylesheet: 'Folha de estilos personalizada',
		addCustomStylesheet: 'Adicionar folha de estilos',
		...
		defaultLayoutStylesheet: 'Folha de Estilos de Layout Predefinida',
	...
	rte: {
		...
		config_overlaySize_description: 'Selecione a largura da sobreposição (seletor de ligação).',
	},
	tiptap: {
		anchor: 'Âncora',
