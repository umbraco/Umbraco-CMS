export default {
	...
	"dialogs": {
		...
		"deployTransferNowDescription": "<p>Du er ved at igangsætte overførsel af <em>%0%</em> direkte til %1%, uden at tilføje til køen.</p>",
		"deployAddToQueueHeadline": "<h4 class=\"bold\">Sæt <em>%0%</em> i køen for overførsel til <em>%1%</em></h4>",
		"deployAddToQueueDescription": "<p>Denne handling sætter <em class=\"bold\">%0%</em> i køen til næste overførsel, intet vil blive overført endnu.</p>",
		"deployAddToQueueChildPageDescription": "<p>Skal alle underliggende sider af <em class=\"bold\">%0%</em> inkluderes i denne overførsel?</p>",
		"deployIncludeChildPages": "Inkluder underliggende sider",
		"deployAddToQueueDone": "<h5>Ændringer er lagt i køen</h5><p>Når du er klar til at overfører gå til <a href=\"#/content?dashboard=deploy\">arbejdsområde siden</a> for at starte overførselen.</p>",
		...
		"deployAddToQueueReleaseDateDescription": "<p>The published or unpublished status will be transferred along with the content. To schedule the update for publishing in the future, please set a date:</p>",
