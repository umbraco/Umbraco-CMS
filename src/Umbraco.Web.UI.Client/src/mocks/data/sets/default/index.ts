// Default mock data set - re-exports all entity data
...
export { data as user, mfaLoginProviders } from './user.data.js';
...
export { logs } from './logs.data.js';
export { auditLogs } from './audit-log.data.js';
export {
	healthGroups,
