...
export const data: Array<UmbMockElementModel> = [
	...
	{
		ancestors: [],
		id: 'element-with-pending-changes-id',
		...
		variants: [
			{
				...
				id: 'element-with-pending-changes',
		...
		values: [
			{
				...
				culture: null,
				segment: null,
				value: 'This element has unpublished changes.',
			},
		],
		flags: [],
		noAccess: false,
	...
	{
		ancestors: [],
		id: 'element-with-scheduled-publish-id',
		createDate: '2024-01-17T08:00:00.000Z',
		parent: null,
		documentType: {
			id: '4f68ba66-6fb2-4778-83b8-6ab4ca3a7c5c',
		...
		variants: [
			{
				...
				publishDate: '2024-01-17T08:00:00.000Z',
				id: 'element-with-scheduled-publish',
		...
		values: [
			{
				...
				culture: null,
				segment: null,
				value: 'This element has a scheduled publish date.',
			},
		],
		flags: [{ alias: 'Umb.ScheduledForPublish' }],
		noAccess: false,
