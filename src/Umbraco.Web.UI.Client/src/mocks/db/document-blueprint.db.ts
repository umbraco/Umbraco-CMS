import { data } from '../data/document-blueprint/document-blueprint.data.js';
import type { UmbMockDocumentBlueprintModel } from '../data/document-blueprint/document-blueprint.data.js';
