...
.factory('dialogService', function ($rootScope, $compile, $http, $timeout, $q, $templateCache, appState, eventsService) {
    ...
    function openDialog(options) {
        ...
        dialog.element = $('<div hm-swiperight="swipeHide($event)" hm-manager-options="{ cssProps: { \'user-select\': \'auto\' } }" data-backdrop="false"></div>');
        ...
        if (dialog.iframe) {
            var html = $("<iframe src='" + dialog.template + "' class='auto-expand' style='border: none; margin-top: 100px; width: 100%; height: calc(100% - 100px);'></iframe>");
