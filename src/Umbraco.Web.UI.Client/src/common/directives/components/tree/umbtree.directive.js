    ...
    return {
        ...
        compile: function (element, attrs) {
            ...
            template += '<div data-element="tree-root" ng-class="getNodeCssClass(tree.root)" ng-hide="hideheader" on-right-click="altSelect(tree.root, $event)">' +
                ...
                '<a data-element="tree-item-options" class="umb-options" ng-hide="tree.root.isContainer || !tree.root.menuUrl" ng-click="options(tree.root, $event)" hm-swiperight="options(tree.root, $event)" hm-manager-options="{ cssProps: { \'user-select\': \'auto\' } }"><i></i><i></i><i></i></a>' +
                '</div>';
            template += '<ul>' +
