    ...
    return {
        ...
        compile: function (element, attrs) {
            ...
            template += '<ul ui-sortable="sortableOptions" class="item" ng-model="tree.root.children">' +
                '<umb-tree-item ng-repeat="child in tree.root.children" enablelistviewexpand="{{enablelistviewexpand}}" eventhandler="eventhandler" node="child" current-node="currentNode" tree="this" section="{{section}}" ng-animate="animation()" sortable-options="sortableOptions"></umb-tree-item>' +
                '</ul>' +
                '</li>' +
                '</ul>';
