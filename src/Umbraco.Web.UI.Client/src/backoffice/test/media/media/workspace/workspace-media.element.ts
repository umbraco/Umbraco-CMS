	...
	private _registerWorkspaceViews() {
		const dashboards: Array<ManifestWorkspaceView | ManifestWorkspaceViewCollection> = [
			...
			},
			{
				...
				loader: () =>
					import(
						'../../../../test/core/components/workspace/workspace-content/views/edit/workspace-view-content-edit.element'
					),
				weight: 200,
				meta: {
					workspaces: ['Umb.Workspace.Media'],
			...
			},
			{
				...
				loader: () =>
					import(
						'../../../../test/core/components/workspace/workspace-content/views/info/workspace-view-content-info.element'
					),
				weight: 100,
				meta: {
					workspaces: ['Umb.Workspace.Media'],
