...
<<<<<<< HEAD:src/backoffice/users/users/collection/views/table/user-collection-table-view.element.ts
...
>>>>>>> main:src/backoffice/users/users/collection/views/table/user-table-collection-view.element.ts
