export const foundConsts = [
	...
	},
	{
		...
		consts: [
			...
			'UMB_BLOCK_GRID_AREA_TYPE_WORKSPACE_ALIAS',
			'UMB_BLOCK_GRID_TYPE',
			'UMB_BLOCK_GRID',
			'UMB_BLOCK_GRID_ENTRIES_CONTEXT',
			'UMB_BLOCK_GRID_ENTRY_CONTEXT',
			'UMB_BLOCK_GRID_MANAGER_CONTEXT',
			'UMB_BLOCK_GRID_DEFAULT_LAYOUT_STYLESHEET',
			'UMB_BLOCK_GRID_AREA_TYPE_ENTRIES_CONTEXT',
	...
	},
	{
		...
		consts: [
			'UMB_BLOCK_LIST_TYPE',
			'UMB_BLOCK_LIST',
			'UMB_BLOCK_LIST_ENTRIES_CONTEXT',
	...
	},
	{
		...
		consts: [
			...
			'UMB_BLOCK_ELEMENT_PROPERTY_DATASET_CONTEXT',
	...
	},
	{
		...
		consts: [
			...
			'UMB_CURRENT_USER_EXTERNAL_LOGIN_MODAL',
			'UMB_CURRENT_USER_HISTORY_STORE_CONTEXT',
			'UMB_CURRENT_USER_MODAL',
			'UMB_CURRENT_USER_MFA_MODAL',
			'UMB_CURRENT_USER_MFA_DISABLE_PROVIDER_MODAL',
			'UMB_CURRENT_USER_MFA_ENABLE_PROVIDER_MODAL',
	...
	},
	{
		...
		consts: [
			'UMB_DATA_TYPE_COLLECTION_ALIAS',
			'UMB_DATA_TYPE_COLLECTION_REPOSITORY_ALIAS',
			'UMB_DATA_TYPE_CREATE_OPTIONS_MODAL',
			'UMB_DUPLICATE_DATA_TYPE_REPOSITORY_ALIAS',
			'UMB_MOVE_DATA_TYPE_REPOSITORY_ALIAS',
			...
			'UMB_DATA_TYPE_ROOT_WORKSPACE_PATH',
			'UMB_CREATE_DATA_TYPE_WORKSPACE_PATH_PATTERN',
			'UMB_DATA_TYPE_REFERENCE_REPOSITORY_ALIAS',
			'UMB_DATA_TYPE_DETAIL_REPOSITORY_ALIAS',
			'UMB_DATA_TYPE_DETAIL_STORE_ALIAS',
			'UMB_DATA_TYPE_DETAIL_STORE_CONTEXT',
			'UMB_DATA_TYPE_ITEM_REPOSITORY_ALIAS',
			'UMB_DATA_TYPE_STORE_ALIAS',
			'UMB_DATA_TYPE_ITEM_STORE_CONTEXT',
			'UMB_DATA_TYPE_TREE_REPOSITORY_ALIAS',
			'UMB_DATA_TYPE_TREE_STORE_ALIAS',
			'UMB_DATA_TYPE_TREE_ALIAS',
			'UMB_DATA_TYPE_TREE_STORE_CONTEXT',
			'UMB_DATA_TYPE_FOLDER_REPOSITORY_ALIAS',
			'UMB_DATA_TYPE_FOLDER_STORE_ALIAS',
			'UMB_DATA_TYPE_FOLDER_STORE_CONTEXT',
			'UMB_DATA_TYPE_FOLDER_WORKSPACE_ALIAS',
			'UMB_DATA_TYPE_FOLDER_WORKSPACE_CONTEXT',
			'UMB_DATA_TYPE_WORKSPACE_ALIAS',
	...
	},
	{
		...
		consts: [
			'UMB_DICTIONARY_COLLECTION_ALIAS',
			'UMB_DICTIONARY_COLLECTION_REPOSITORY_ALIAS',
			'UMB_DICTIONARY_TABLE_COLLECTION_VIEW_ALIAS',
			'UMB_DICTIONARY_OVERVIEW_DASHBOARD_PATHNAME',
			'UMB_DICTIONARY_OVERVIEW_DASHBOARD_PATH',
			'UMB_EXPORT_DICTIONARY_MODAL',
			'UMB_IMPORT_DICTIONARY_MODAL',
			'UMB_MOVE_DICTIONARY_REPOSITORY_ALIAS',
			...
			'UMB_DICTIONARY_DETAIL_STORE_ALIAS',
			...
			'UMB_DICTIONARY_STORE_ALIAS',
			'UMB_DICTIONARY_ITEM_STORE_CONTEXT',
			'UMB_DICTIONARY_SEARCH_PROVIDER_ALIAS',
			'UMB_DICTIONARY_TREE_REPOSITORY_ALIAS',
			'UMB_DICTIONARY_TREE_STORE_ALIAS',
			'UMB_DICTIONARY_TREE_ALIAS',
			'UMB_DICTIONARY_TREE_STORE_CONTEXT',
			'UMB_DICTIONARY_WORKSPACE_CONTEXT',
			'UMB_DICTIONARY_WORKSPACE_ALIAS',
			'UMB_DICTIONARY_WORKSPACE_PATH',
	...
	},
	{
		...
		consts: [
			...
			'UMB_DOCUMENT_BLUEPRINT_PROPERTY_DATASET_CONTEXT',
			'UMB_DOCUMENT_BLUEPRINT_DETAIL_STORE_CONTEXT',
			...
			'UMB_DOCUMENT_BLUEPRINT_STORE_ALIAS',
			...
			'UMB_DOCUMENT_BLUEPRINT_FOLDER_STORE_CONTEXT',
			'UMB_DOCUMENT_BLUEPRINT_FOLDER_WORKSPACE_ALIAS',
			'UMB_DOCUMENT_BLUEPRINT_FOLDER_WORKSPACE_CONTEXT',
			'UMB_DOCUMENT_BLUEPRINT_WORKSPACE_CONTEXT',
			'UMB_DOCUMENT_BLUEPRINT_WORKSPACE_ALIAS',
		],
	},
	{
		path: '@umbraco-cms/backoffice/document-type',
		consts: [
			'UMB_DOCUMENT_TYPE_CREATE_OPTIONS_MODAL',
			'UMB_DUPLICATE_DOCUMENT_TYPE_REPOSITORY_ALIAS',
			'UMB_EXPORT_DOCUMENT_TYPE_REPOSITORY_ALIAS',
			'UMB_DOCUMENT_TYPE_IMPORT_MODAL',
			'UMB_DOCUMENT_TYPE_IMPORT_REPOSITORY_ALIAS',
			'UMB_MOVE_DOCUMENT_TYPE_REPOSITORY_ALIAS',
			...
			'UMB_DOCUMENT_TYPE_COMPOSITION_REPOSITORY_ALIAS',
			'UMB_DOCUMENT_TYPE_DETAIL_STORE_CONTEXT',
			'UMB_DOCUMENT_TYPE_DETAIL_REPOSITORY_ALIAS',
			'UMB_DOCUMENT_TYPE_DETAIL_STORE_ALIAS',
			'UMB_DOCUMENT_TYPE_ITEM_STORE_CONTEXT',
			'UMB_DOCUMENT_TYPE_ITEM_REPOSITORY_ALIAS',
			'UMB_DOCUMENT_TYPE_ITEM_STORE_ALIAS',
			'UMB_DOCUMENT_TYPE_STRUCTURE_REPOSITORY_ALIAS',
			'UMB_DOCUMENT_TYPE_SEARCH_PROVIDER_ALIAS',
			...
			'UMB_DOCUMENT_TYPE_FOLDER_STORE_ALIAS',
			'UMB_DOCUMENT_TYPE_FOLDER_STORE_CONTEXT',
			'UMB_DOCUMENT_TYPE_FOLDER_WORKSPACE_ALIAS',
			'UMB_DOCUMENT_TYPE_FOLDER_WORKSPACE_CONTEXT',
			'UMB_DOCUMENT_TYPE_FOLDER_WORKSPACE_PATH',
			'UMB_EDIT_DOCUMENT_TYPE_FOLDER_WORKSPACE_PATH_PATTERN',
			'UMB_DOCUMENT_TYPE_TREE_ITEM_CHILDREN_COLLECTION_ALIAS',
			'UMB_DOCUMENT_TYPE_TREE_ITEM_CHILDREN_COLLECTION_REPOSITORY_ALIAS',
			'UMB_DOCUMENT_TYPE_WORKSPACE_ALIAS',
	...
	},
	{
		...
		consts: [
			'UMB_DOCUMENT_COLLECTION_CONTEXT',
			'UMB_DOCUMENT_COLLECTION_ALIAS',
			'UMB_DOCUMENT_COLLECTION_REPOSITORY_ALIAS',
			'UMB_DOCUMENT_GRID_COLLECTION_VIEW_ALIAS',
			'UMB_DOCUMENT_TABLE_COLLECTION_VIEW_ALIAS',
			'UMB_DOCUMENT_CREATE_OPTIONS_MODAL',
			'UMB_CREATE_BLUEPRINT_MODAL',
			'UMB_DOCUMENT_CREATE_BLUEPRINT_REPOSITORY_ALIAS',
			'UMB_CULTURE_AND_HOSTNAMES_MODAL',
			...
			'UMB_DOCUMENT_NOTIFICATIONS_MODAL',
			'UMB_DOCUMENT_NOTIFICATIONS_MODAL_ALIAS',
			'UMB_DOCUMENT_NOTIFICATIONS_REPOSITORY_ALIAS',
			'UMB_PUBLIC_ACCESS_MODAL',
			'UMB_DOCUMENT_PUBLIC_ACCESS_REPOSITORY_ALIAS',
			...
			'UMB_DOCUMENT_DETAIL_STORE_CONTEXT',
			'UMB_DOCUMENT_DETAIL_REPOSITORY_ALIAS',
			'UMB_DOCUMENT_DETAIL_STORE_ALIAS',
			'UMB_DOCUMENT_ITEM_STORE_CONTEXT',
			'UMB_DOCUMENT_ITEM_REPOSITORY_ALIAS',
			'UMB_DOCUMENT_STORE_ALIAS',
			'UMB_DOCUMENT_PUBLISHING_REPOSITORY_ALIAS',
			'UMB_DOCUMENT_URL_REPOSITORY_ALIAS',
			'UMB_DOCUMENT_URL_STORE_ALIAS',
			'UMB_DOCUMENT_URL_STORE_CONTEXT',
			'UMB_DOCUMENT_VALIDATION_REPOSITORY_ALIAS',
			'UMB_ROLLBACK_MODAL_ALIAS',
			'UMB_ROLLBACK_MODAL',
			'UMB_ROLLBACK_REPOSITORY_ALIAS',
			'UMB_DOCUMENT_SEARCH_PROVIDER_ALIAS',
			'UMB_DOCUMENT_TREE_STORE_CONTEXT',
			...
			'UMB_DOCUMENT_PERMISSION_REPOSITORY_ALIAS',
	...
	},
	{
		...
		consts: [
			...
			'UMB_ENTITY_CREATE_OPTION_ACTION_LIST_MODAL',
			'UMB_ENTITY_ACTION_DEFAULT_KIND_MANIFEST',
		],
	},
	{
	...
	},
	{
		...
		consts: [
			...
			'UMB_LANGUAGE_COLLECTION_REPOSITORY_ALIAS',
			'UMB_LANGUAGE_TABLE_COLLECTION_VIEW_ALIAS',
			'UMB_LANGUAGE_ENTITY_TYPE',
			'UMB_LANGUAGE_ROOT_ENTITY_TYPE',
			'UMB_APP_LANGUAGE_CONTEXT',
			'UMB_LANGUAGE_PICKER_MODAL',
			'UMB_LANGUAGE_WORKSPACE_PATH',
			'UMB_CREATE_LANGUAGE_WORKSPACE_PATH_PATTERN',
			'UMB_EDIT_LANGUAGE_WORKSPACE_PATH_PATTERN',
			'UMB_LANGUAGE_ACCESS_WORKSPACE_CONTEXT',
			'UMB_LANGUAGE_DETAIL_REPOSITORY_ALIAS',
			'UMB_LANGUAGE_DETAIL_STORE_ALIAS',
			'UMB_LANGUAGE_DETAIL_STORE_CONTEXT',
			'UMB_LANGUAGE_ITEM_REPOSITORY_ALIAS',
			'UMB_LANGUAGE_STORE_ALIAS',
			'UMB_LANGUAGE_ITEM_STORE_CONTEXT',
			'UMB_LANGUAGE_WORKSPACE_ALIAS',
			'UMB_LANGUAGE_WORKSPACE_CONTEXT',
			'UMB_LANGUAGE_WORKSPACE_MODAL',
			'UMB_LANGUAGE_ROOT_WORKSPACE_ALIAS',
	...
	},
	{
		...
		consts: [
			'UMB_MEDIA_TYPE_CREATE_OPTIONS_MODAL',
			'UMB_DUPLICATE_MEDIA_TYPE_REPOSITORY_ALIAS',
			'UMB_EXPORT_MEDIA_TYPE_REPOSITORY_ALIAS',
			'UMB_MEDIA_TYPE_IMPORT_MODAL',
			'UMB_MEDIA_TYPE_IMPORT_REPOSITORY_ALIAS',
			'UMB_MOVE_MEDIA_TYPE_REPOSITORY_ALIAS',
			'UMB_MEDIA_TYPE_ENTITY_TYPE',
			'UMB_MEDIA_TYPE_ROOT_ENTITY_TYPE',
			'UMB_MEDIA_TYPE_FOLDER_ENTITY_TYPE',
			'UMB_MEDIA_TYPE_COMPOSITION_REPOSITORY_ALIAS',
			...
			'UMB_MEDIA_TYPE_ITEM_STORE_CONTEXT',
			'UMB_MEDIA_TYPE_STRUCTURE_REPOSITORY_ALIAS',
			'UMB_MEDIA_TYPE_TREE_REPOSITORY_ALIAS',
			'UMB_MEDIA_TYPE_TREE_STORE_ALIAS',
			'UMB_MEDIA_TYPE_TREE_ALIAS',
			'UMB_MEDIA_TYPE_FOLDER_REPOSITORY_ALIAS',
			'UMB_MEDIA_TYPE_FOLDER_STORE_ALIAS',
			'UMB_MEDIA_TYPE_FOLDER_STORE_CONTEXT',
			'UMB_MEDIA_TYPE_FOLDER_WORKSPACE_ALIAS',
			'UMB_MEDIA_TYPE_FOLDER_WORKSPACE_CONTEXT',
			'UMB_MEDIA_TYPE_PICKER_MODAL',
			'UMB_MEDIA_TYPE_TREE_STORE_CONTEXT',
			'UMB_MEDIA_TYPE_WORKSPACE_ALIAS',
			'UMB_MEDIA_TYPE_WORKSPACE_CONTEXT',
		],
	},
	{
		...
		consts: [
			...
			'UMB_MEDIA_COLLECTION_CONTEXT',
			'UMB_MEDIA_COLLECTION_REPOSITORY_ALIAS',
			'UMB_MEDIA_GRID_COLLECTION_VIEW_ALIAS',
			'UMB_MEDIA_TABLE_COLLECTION_VIEW_ALIAS',
			'UMB_DROPZONE_MEDIA_TYPE_PICKER_MODAL',
			'UMB_MEDIA_CREATE_OPTIONS_MODAL',
			'UMB_MOVE_MEDIA_REPOSITORY_ALIAS',
			'UMB_SORT_CHILDREN_OF_MEDIA_REPOSITORY_ALIAS',
			'UMB_BULK_MOVE_MEDIA_REPOSITORY_ALIAS',
			'UMB_BULK_TRASH_MEDIA_REPOSITORY_ALIAS',
			...
			'UMB_CREATE_MEDIA_WORKSPACE_PATH_PATTERN',
			'UMB_EDIT_MEDIA_WORKSPACE_PATH_PATTERN',
			'UMB_MEDIA_VARIANT_CONTEXT',
			'UMB_MEDIA_RECYCLE_BIN_ROOT_ENTITY_TYPE',
			...
			'UMB_MEDIA_RECYCLE_BIN_TREE_STORE_CONTEXT',
			'UMB_MEDIA_REFERENCE_REPOSITORY_ALIAS',
			'UMB_MEDIA_DETAIL_REPOSITORY_ALIAS',
			'UMB_MEDIA_DETAIL_STORE_ALIAS',
			'UMB_MEDIA_DETAIL_STORE_CONTEXT',
			'UMB_MEDIA_ITEM_REPOSITORY_ALIAS',
			'UMB_MEDIA_STORE_ALIAS',
			'UMB_MEDIA_ITEM_STORE_CONTEXT',
			'UMB_MEDIA_URL_REPOSITORY_ALIAS',
			'UMB_MEDIA_URL_STORE_ALIAS',
			'UMB_MEDIA_URL_STORE_CONTEXT',
			'UMB_MEDIA_VALIDATION_REPOSITORY_ALIAS',
			'UMB_MEDIA_TREE_REPOSITORY_ALIAS',
			'UMB_MEDIA_TREE_STORE_ALIAS',
			'UMB_MEDIA_TREE_ALIAS',
			'UMB_MEDIA_TREE_PICKER_MODAL',
			'UMB_MEDIA_TREE_STORE_CONTEXT',
			'UMB_MEMBER_DETAIL_MODEL_VARIANT_SCAFFOLD',
			'UMB_MEDIA_WORKSPACE_ALIAS',
	...
	},
	{
		...
		consts: [
			'UMB_MEMBER_GROUP_COLLECTION_ALIAS',
			'UMB_MEMBER_GROUP_COLLECTION_REPOSITORY_ALIAS',
			'UMB_MEMBER_GROUP_TABLE_COLLECTION_VIEW_ALIAS',
			'UMB_MEMBER_GROUP_PICKER_MODAL',
			'UMB_MEMBER_GROUP_ROOT_ENTITY_TYPE',
			'UMB_MEMBER_GROUP_ENTITY_TYPE',
			'UMB_MEMBER_GROUP_WORKSPACE_PATH',
			'UMB_MEMBER_GROUP_ROOT_WORKSPACE_PATH',
			'UMB_MEMBER_GROUP_DETAIL_REPOSITORY_ALIAS',
			'UMB_MEMBER_GROUP_DETAIL_STORE_ALIAS',
			'UMB_MEMBER_GROUP_DETAIL_STORE_CONTEXT',
			'UMB_MEMBER_GROUP_ITEM_REPOSITORY_ALIAS',
			'UMB_MEMBER_GROUP_STORE_ALIAS',
			'UMB_MEMBER_GROUP_ITEM_STORE_CONTEXT',
			'UMB_MEMBER_GROUP_WORKSPACE_ALIAS',
			'UMB_MEMBER_GROUP_WORKSPACE_CONTEXT',
			'UMB_MEMBER_GROUP_ROOT_WORKSPACE_ALIAS',
		],
	},
	{
		path: '@umbraco-cms/backoffice/member-type',
		consts: [
			'UMB_DUPLICATE_MEMBER_TYPE_REPOSITORY_ALIAS',
			'UMB_MEMBER_TYPE_ROOT_ENTITY_TYPE',
			'UMB_MEMBER_TYPE_ENTITY_TYPE',
			'UMB_MEMBER_TYPE_PICKER_MODAL',
			'UMB_MEMBER_TYPE_COMPOSITION_REPOSITORY_ALIAS',
			'UMB_MEMBER_TYPE_DETAIL_REPOSITORY_ALIAS',
			'UMB_MEMBER_TYPE_DETAIL_STORE_ALIAS',
			'UMB_MEMBER_TYPE_DETAIL_STORE_CONTEXT',
			'UMB_MEMBER_TYPE_ITEM_REPOSITORY_ALIAS',
			'UMB_MEMBER_TYPE_STORE_ALIAS',
			'UMB_MEMBER_TYPE_ITEM_STORE_CONTEXT',
			'UMB_MEMBER_TYPE_TREE_REPOSITORY_ALIAS',
			'UMB_MEMBER_TYPE_TREE_STORE_ALIAS',
			'UMB_MEMBER_TYPE_TREE_ALIAS',
			'UMB_MEMBER_TYPE_TREE_STORE_CONTEXT',
			'UMB_MEMBER_TYPE_WORKSPACE_ALIAS',
			'UMB_MEMBER_TYPE_WORKSPACE_CONTEXT',
		],
	},
	{
		...
		consts: [
			...
			'UMB_MEMBER_TABLE_COLLECTION_VIEW_ALIAS',
			'UMB_MEMBER_PICKER_MODAL',
			'UMB_MEMBER_CREATE_OPTIONS_MODAL',
			'UMB_MEMBER_ENTITY_TYPE',
			'UMB_MEMBER_ROOT_ENTITY_TYPE',
			'UMB_MEMBER_WORKSPACE_PATH',
			'UMB_MEMBER_ROOT_WORKSPACE_PATH',
			'UMB_CREATE_MEMBER_WORKSPACE_PATH_PATTERN',
			'UMB_MEMBER_VARIANT_CONTEXT',
			'UMB_MEMBER_DETAIL_REPOSITORY_ALIAS',
			'UMB_MEMBER_DETAIL_STORE_ALIAS',
			'UMB_MEMBER_DETAIL_STORE_CONTEXT',
			'UMB_MEMBER_ITEM_REPOSITORY_ALIAS',
			'UMB_MEMBER_STORE_ALIAS',
			'UMB_MEMBER_ITEM_STORE_CONTEXT',
			'UMB_MEMBER_SEARCH_PROVIDER_ALIAS',
			'UMB_MEMBER_DETAIL_MODEL_VARIANT_SCAFFOLD',
			'UMB_MEMBER_WORKSPACE_ALIAS',
			'UMB_MEMBER_WORKSPACE_CONTEXT',
	...
	},
	{
		...
		consts: [
			...
			'UMB_PARTIAL_VIEW_FROM_SNIPPET_MODAL',
			'UMB_RENAME_PARTIAL_VIEW_REPOSITORY_ALIAS',
			'UMB_RENAME_PARTIAL_VIEW_ENTITY_ACTION_ALIAS',
			...
			'UMB_PARTIAL_VIEW_ITEM_STORE_ALIAS',
			'UMB_PARTIAL_VIEW_ITEM_STORE_CONTEXT',
			'UMB_PARTIAL_VIEW_DETAIL_REPOSITORY_ALIAS',
			'UMB_PARTIAL_VIEW_DETAIL_STORE_ALIAS',
			...
			'UMB_PARTIAL_VIEW_FOLDER_STORE_ALIAS',
			'UMB_PARTIAL_VIEW_FOLDER_STORE_CONTEXT',
			'UMB_PARTIAL_VIEW_FOLDER_WORKSPACE_ALIAS',
			'UMB_PARTIAL_VIEW_FOLDER_WORKSPACE_CONTEXT',
	...
	},
	{
		...
		consts: [
			...
			'UMB_PROPERTY_TYPE_ENTITY_TYPE',
			'UMB_PROPERTY_TYPE_WORKSPACE_PATH',
	...
	},
	{
		...
		consts: [
			...
			'UMB_NAMEABLE_PROPERTY_DATASET_CONTEXT',
			'UMB_PROPERTY_DATASET_CONTEXT',
			'UMB_UNSUPPORTED_EDITOR_SCHEMA_ALIASES',
		],
	},
	{
	...
	},
	{
		...
		consts: [
			...
			'UMB_RELATION_TYPE_ROOT_ENTITY_TYPE',
			'UMB_RELATION_TYPE_ENTITY_TYPE',
			'UMB_RELATION_TYPE_DETAIL_REPOSITORY_ALIAS',
			'UMB_RELATION_TYPE_DETAIL_STORE_ALIAS',
			'UMB_RELATION_TYPE_DETAIL_STORE_CONTEXT',
			'UMB_RELATION_TYPE_WORKSPACE_ALIAS',
			'UMB_RELATION_TYPE_WORKSPACE_CONTEXT',
		],
	},
	{
	...
	},
	{
		...
		consts: [
			...
			'UMB_DELETE_SCRIPT_ENTITY_ACTION_ALIAS',
			'UMB_RENAME_SCRIPT_REPOSITORY_ALIAS',
			'UMB_RENAME_SCRIPT_ENTITY_ACTION_ALIAS',
			'UMB_SCRIPT_ENTITY_TYPE',
			'UMB_SCRIPT_ROOT_ENTITY_TYPE',
			'UMB_SCRIPT_FOLDER_ENTITY_TYPE',
			'UMB_SCRIPT_MENU_ITEM_ALIAS',
			'UMB_SCRIPT_PICKER_MODAL',
			'UMB_SCRIPT_ITEM_REPOSITORY_ALIAS',
			'UMB_SCRIPT_ITEM_STORE_ALIAS',
			'UMB_SCRIPT_ITEM_STORE_CONTEXT',
			'UMB_SCRIPT_DETAIL_REPOSITORY_ALIAS',
			'UMB_SCRIPT_DETAIL_STORE_ALIAS',
			'UMB_SCRIPT_DETAIL_STORE_CONTEXT',
			'UMB_DELETE_SCRIPT_FOLDER_ENTITY_ACTION_ALIAS',
			'UMB_SCRIPT_FOLDER_REPOSITORY_ALIAS',
			'UMB_SCRIPT_FOLDER_STORE_ALIAS',
			'UMB_SCRIPT_FOLDER_STORE_CONTEXT',
			'UMB_SCRIPT_FOLDER_WORKSPACE_ALIAS',
			'UMB_SCRIPT_FOLDER_WORKSPACE_CONTEXT',
			'UMB_SCRIPT_TREE_REPOSITORY_ALIAS',
			'UMB_SCRIPT_TREE_STORE_ALIAS',
			'UMB_SCRIPT_TREE_ALIAS',
			'UMB_SCRIPT_TREE_STORE_CONTEXT',
			'UMB_SCRIPT_WORKSPACE_ALIAS',
			'UMB_SAVE_SCRIPT_WORKSPACE_ACTION_ALIAS',
			'UMB_SCRIPT_WORKSPACE_CONTEXT',
		],
	},
	{
	...
	},
	{
		...
		consts: [
			...
			'UMB_SECTION_ITEM_REPOSITORY_ALIAS',
			'UMB_SECTION_PICKER_MODAL',
	...
	},
	{
		...
		consts: [
			'UMB_ADVANCED_SETTINGS_MENU_ALIAS',
			'UMB_SETTINGS_SECTION_ALIAS',
			'UMB_SETTINGS_SECTION_PATHNAME',
			'UMB_SETTINGS_SECTION_PATH',
			'UMB_STRUCTURE_SETTINGS_MENU_ALIAS',
		],
	},
	{
	...
	},
	{
		...
		consts: [
			...
			'UMB_STATIC_FILE_ITEM_REPOSITORY_ALIAS',
			'UMB_STATIC_FILE_STORE_ALIAS',
			'UMB_STATIC_FILE_ITEM_STORE_CONTEXT',
	...
	},
	{
		...
		consts: [
			...
			'UMB_RENAME_STYLESHEET_REPOSITORY_ALIAS',
			'UMB_RENAME_STYLESHEET_ENTITY_ACTION_ALIAS',
			'UMB_STYLESHEET_ENTITY_TYPE',
			'UMB_STYLESHEET_ROOT_ENTITY_TYPE',
			'UMB_STYLESHEET_FOLDER_ENTITY_TYPE',
			'UMB_STYLESHEET_PICKER_MODAL',
			'UMB_STYLESHEET_RULE_SETTINGS_MODAL_ALIAS',
			'UMB_STYLESHEET_RULE_SETTINGS_MODAL',
			'UMB_STYLESHEET_ITEM_REPOSITORY_ALIAS',
			'UMB_STYLESHEET_ITEM_STORE_ALIAS',
			'UMB_STYLESHEET_ITEM_STORE_CONTEXT',
			'UMB_STYLESHEET_DETAIL_REPOSITORY_ALIAS',
			'UMB_STYLESHEET_DETAIL_STORE_ALIAS',
			...
			'UMB_STYLESHEET_FOLDER_STORE_ALIAS',
			'UMB_STYLESHEET_FOLDER_STORE_CONTEXT',
			'UMB_STYLESHEET_FOLDER_WORKSPACE_ALIAS',
			'UMB_STYLESHEET_FOLDER_WORKSPACE_CONTEXT',
			...
			'UMB_STYLESHEET_WORKSPACE_CONTEXT',
		],
	},
	{
	...
	},
	{
		...
		consts: [
			'UMB_BLOCK_ENTRY_WEB_COMPONENTS_ABSOLUTE_PATH',
			'UMB_BLOCK_ENTRY_WEB_COMPONENTS_ABSOLUTE_PATH',
	...
	},
	{
		...
		consts: [
			'UMB_TRANSLATION_MENU_ALIAS',
			'UMB_TRANSLATION_SECTION_ALIAS',
			'UMB_TRANSLATION_SECTION_PATHNAME',
			'UMB_TRANSLATION_SECTION_PATH',
		],
	},
	{
	...
	},
	{
		...
		consts: [
			'UMB_USER_GROUP_COLLECTION_ALIAS',
			'UMB_USER_GROUP_COLLECTION_REPOSITORY_ALIAS',
			'UMB_USER_GROUP_COLLECTION_CONTEXT',
			'UMB_USER_GROUP_TABLE_COLLECTION_VIEW_ALIAS',
			'UMB_USER_GROUP_ENTITY_TYPE',
			'UMB_USER_GROUP_ROOT_ENTITY_TYPE',
			'UMB_USER_GROUP_PICKER_MODAL',
			'UMB_USER_GROUP_WORKSPACE_PATH',
			'UMB_USER_GROUP_ROOT_WORKSPACE_PATH',
			'UMB_USER_GROUP_DETAIL_REPOSITORY_ALIAS',
			'UMB_USER_GROUP_DETAIL_STORE_ALIAS',
			'UMB_USER_GROUP_DETAIL_STORE_CONTEXT',
			'UMB_USER_GROUP_ITEM_REPOSITORY_ALIAS',
			'UMB_USER_GROUP_STORE_ALIAS',
			'UMB_USER_GROUP_ITEM_STORE_CONTEXT',
			'UMB_USER_GROUP_WORKSPACE_ALIAS',
			'UMB_USER_GROUP_WORKSPACE_ALIAS',
			'UMB_USER_GROUP_WORKSPACE_CONTEXT',
			'UMB_USER_GROUP_WORKSPACE_ALIAS',
		],
	},
	{
	...
	},
	{
		...
		consts: [
			...
			'UMB_CREATE_USER_CLIENT_CREDENTIAL_MODAL',
			'UMB_USER_CLIENT_CREDENTIAL_REPOSITORY_ALIAS',
			'UMB_USER_COLLECTION_ALIAS',
			'UMB_USER_COLLECTION_REPOSITORY_ALIAS',
			'UMB_USER_COLLECTION_CONTEXT',
			'UMB_COLLECTION_VIEW_USER_TABLE',
			'UMB_COLLECTION_VIEW_USER_GRID',
			'UMB_USER_ALLOW_CHANGE_PASSWORD_CONDITION_ALIAS',
			'UMB_USER_ALLOW_DELETE_CONDITION_ALIAS',
			'UMB_USER_ALLOW_DISABLE_CONDITION_ALIAS',
			'UMB_USER_ALLOW_ENABLE_CONDITION_ALIAS',
			'UMB_USER_ALLOW_EXTERNAL_LOGIN_CONDITION_ALIAS',
			'UMB_USER_ALLOW_MFA_CONDITION_ALIAS',
			'UMB_USER_ALLOW_UNLOCK_CONDITION_ALIAS',
			'UMB_CREATE_USER_MODAL_ALIAS',
			'UMB_CREATE_USER_MODAL',
			'UMB_CREATE_USER_SUCCESS_MODAL',
			'UMB_USER_ENTITY_TYPE',
			'UMB_USER_ROOT_ENTITY_TYPE',
			'UMB_INVITE_USER_MODAL',
			'UMB_RESEND_INVITE_TO_USER_MODAL',
			'UMB_INVITE_USER_REPOSITORY_ALIAS',
			'UMB_USER_MFA_MODAL',
			'UMB_USER_PICKER_MODAL',
			'UMB_USER_WORKSPACE_PATH',
			'UMB_USER_ROOT_WORKSPACE_PATH',
			'UMB_USER_AVATAR_REPOSITORY_ALIAS',
			'UMB_CHANGE_USER_PASSWORD_REPOSITORY_ALIAS',
			'UMB_USER_CONFIG_REPOSITORY_ALIAS',
			'UMB_USER_CONFIG_STORE_ALIAS',
			'UMB_USER_CONFIG_STORE_CONTEXT',
			'UMB_USER_DETAIL_REPOSITORY_ALIAS',
			'UMB_USER_DETAIL_STORE_ALIAS',
			'UMB_USER_DETAIL_STORE_CONTEXT',
			'UMB_DISABLE_USER_REPOSITORY_ALIAS',
			'UMB_ENABLE_USER_REPOSITORY_ALIAS',
			'UMB_USER_ITEM_REPOSITORY_ALIAS',
			'UMB_USER_ITEM_STORE_ALIAS',
			'UMB_USER_ITEM_STORE_CONTEXT',
			'UMB_NEW_USER_PASSWORD_REPOSITORY_ALIAS',
			'UMB_UNLOCK_USER_REPOSITORY_ALIAS',
			'UMB_USER_WORKSPACE_ALIAS',
			'UMB_USER_WORKSPACE_CONTEXT',
			'UMB_USER_ROOT_WORKSPACE_ALIAS',
		],
	},
	{
	...
	},
	{
		...
		consts: [
			'UMB_WEBHOOK_COLLECTION_ALIAS',
			'UMB_WEBHOOK_COLLECTION_REPOSITORY_ALIAS',
			'UMB_WEBHOOK_TABLE_COLLECTION_VIEW_ALIAS',
			'UMB_WEBHOOK_EVENTS_MODAL',
			'UMB_WEBHOOK_WORKSPACE_ALIAS',
			'UMB_WEBHOOK_WORKSPACE',
			'UMB_WEBHOOK_ENTITY_TYPE',
			'UMB_WEBHOOK_ROOT_ENTITY_TYPE',
			'UMB_WEBHOOK_DETAIL_REPOSITORY_ALIAS',
			'UMB_WEBHOOK_DETAIL_STORE_ALIAS',
			'UMB_WEBHOOK_DETAIL_STORE_CONTEXT',
			'UMB_WEBHOOK_EVENT_REPOSITORY_ALIAS',
			'UMB_WEBHOOK_EVENT_STORE_ALIAS',
			'UMB_WEBHOOK_EVENT_STORE_CONTEXT',
			'UMB_WEBHOOK_ITEM_REPOSITORY_ALIAS',
			'UMB_WEBHOOK_STORE_ALIAS',
			'UMB_WEBHOOK_ITEM_STORE_CONTEXT',
			'UMB_WEBHOOK_WORKSPACE_CONTEXT',
			'UMB_WEBHOOK_ROOT_WORKSPACE_ALIAS',
		],
	},
	{
		...
		consts: [
			...
			'UMB_WORKSPACE_HAS_COLLECTION_CONDITION',
			'UMB_WORKSPACE_ENTITY_IS_NEW_CONDITION_ALIAS',
			'UMB_WORKSPACE_ENTITY_IS_NEW_CONDITION',
