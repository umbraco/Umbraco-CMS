...
var paste = (function () {
    ...
    var hasProPlugin = function (editor) {
      if (/(^|[ ,])powerpaste([, ]|$)/.test(editor.settings.plugins) && global.get('powerpaste')) {
        if (typeof window.console !== 'undefined' && window.console.log) {
          window.console.log('PowerPaste is incompatible with Paste plugin! Remove \'umbpaste\' from the \'plugins\' option.');
        }
        return true;
      } else {
        return false;
    ...
    var filterWordContent = function (editor, content) {
        ...
        console.log("filterWordContent 3");
        console.log(content);
        
        content = content.replace(/\<!\[(if !vml|endif)\]\>/g, '');// removes <![if !vml]> & <![endif]>
    ...
    var setup$1 = function (editor) {
      var plugin = editor.plugins.umbpaste;
    ...
    global.add('umbpaste', function (editor) {
