...
/// <summary>
/// A "available at" action result with no response body.
/// </summary>
public sealed class EmptyAvailableAtActionResult : ActionResult
{
    ...
    public EmptyAvailableAtActionResult(string actionName, string controllerName, object routeValues, string resourceIdentifier)
    {
