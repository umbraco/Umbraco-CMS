	...
	internal class LegacyUmbracoSettings
	{
		...
		internal static XmlDocument EnsureSettingsDocument()
		{
			...
			if (settingsFile == null)
			{
				...
				{
					LogHelper.Error<LegacyUmbracoSettings>("Error reading umbracoSettings file: " + e.ToString(), e);
				}
        ...
        internal static RenderingEngine DefaultRenderingEngine
		{
			get
			{
				if (_defaultRenderingEngine == null)
				{
					...
					{
						LogHelper.Error<LegacyUmbracoSettings>("Could not load /settings/templates/defaultRenderingEngine from umbracosettings.config", ex);
        ...
        internal static MacroErrorBehaviour MacroErrorBehaviour
		{
			get
			{
				if (_macroErrorBehaviour == null)
				{
					...
					{
						LogHelper.Error<LegacyUmbracoSettings>("Could not load /settings/content/MacroErrors from umbracosettings.config", ex);
        ...
        internal static IconPickerBehaviour IconPickerBehaviour
		{
			get
			{
				if (_iconPickerBehaviour == null)
				{
					...
					{
                        LogHelper.Error<LegacyUmbracoSettings>("Could not load /settings/content/DocumentTypeIconList from umbracosettings.config", ex);
