...
{
    private const bool StaticSecure = true;

    private const string StaticSameSite = "Strict";

    /// <summary>
    ///     Gets or sets a value indicating whether the cookie Secure configuration.
    /// </summary>
    [DefaultValue(StaticSecure)]
    public bool Secure { get; set; } = StaticSecure;
