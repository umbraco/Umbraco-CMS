...
{
    internal const bool StaticUseDictionaryValueSearch = false;
    ...
    /// </remarks>
    [DefaultValue(StaticUseDictionaryValueSearch)]
    public bool UseDictionaryValueSearch { get; set; } = StaticUseDictionaryValueSearch;
}
