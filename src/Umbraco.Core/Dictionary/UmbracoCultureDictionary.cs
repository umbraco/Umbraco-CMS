...
internal class DefaultCultureDictionary : ICultureDictionary
{
    ...
    private ILanguage? Language =>
        ...
        _requestCache.GetCacheItem(typeof(DefaultCultureDictionary).Name + "Culture" + Culture.Name,
            () =>
            {
    ...
    public IDictionary<string, string> GetChildren(string key)
    {
        ...
        {
            IDictionaryTranslation byLang =
                dictionaryItem.Translations?.FirstOrDefault(x => x.Language?.Equals(Language) ?? false);
