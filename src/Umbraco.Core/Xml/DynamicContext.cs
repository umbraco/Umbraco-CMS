...
public class DynamicContext : XsltContext
{
    ...
    internal class DynamicVariable : IXsltContextVariable
    {
        ...
        XPathResultType IXsltContextVariable.VariableType => _type;

        private readonly XPathResultType _type;

        object IXsltContextVariable.Evaluate(XsltContext context) => _value;
    ...
    public override int CompareDocument(string baseUri, string nextbaseUri) =>
        string.Compare(baseUri, nextbaseUri, false, CultureInfo.InvariantCulture);
