    ...
    public static class TypeFinder
    {
            ...
            bool onlyConcreteClasses)
        {
            ...
            foreach (var a in referencedAssemblies)
            {
                ...
                {
                    LogHelper.Error(typeof(TypeFinder), "Could not query types on {0} assembly, this is most likely due to this assembly not being compatible with the current Umbraco version", ex);
                    continue;
                }
