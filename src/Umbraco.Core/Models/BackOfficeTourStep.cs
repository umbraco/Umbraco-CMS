...
public class BackOfficeTourStep
{
    ...
    [DataMember(Name = "element")] public string? Element { get; set; }

    [DataMember(Name = "elementPreventClick")]
    public bool ElementPreventClick { get; set; }

    [DataMember(Name = "backdropOpacity")] public float? BackdropOpacity { get; set; }

    [DataMember(Name = "event")] public string? Event { get; set; }

    [DataMember(Name = "view")] public string? View { get; set; }

    [DataMember(Name = "eventElement")] public string? EventElement { get; set; }
