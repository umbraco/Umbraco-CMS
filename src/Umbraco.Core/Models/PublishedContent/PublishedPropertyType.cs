...
/// </summary>
/// <remarks>
///     Instances of the <see cref="PublishedPropertyType" /> class are immutable, ie
...
public class PublishedPropertyType : IPublishedPropertyType
{
        ...
        IPublishedContentTypeFactory factory)
    {
        ...
        _propertyValueConverters =
            propertyValueConverters ?? throw new ArgumentNullException(nameof(propertyValueConverters));
    ...
    public Type? ClrType
    {
        get
        {
            ...
            return _clrType ?? (_modelClrType is not null
                ? _clrType = _publishedModelFactory.MapModelType(_modelClrType)
                : null);
        }
    }
