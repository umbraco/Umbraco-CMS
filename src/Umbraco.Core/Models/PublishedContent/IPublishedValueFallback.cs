namespace Umbraco.Core.Models.PublishedContent
{
    ...
    public interface IPublishedValueFallback
    {
        ...
        /// get property.Value() or property.Value{T}() to trigger fallback.</para>
        /// </remarks>
        T GetValue<T>(IPublishedProperty property, string culture, string segment, T defaultValue, int fallback);
        ...
        /// <para>It can only fallback at element level (no recurse).</para>
        /// </remarks>
        T GetValue<T>(IPublishedElement content, string alias, string culture, string segment, T defaultValue, int fallback);
