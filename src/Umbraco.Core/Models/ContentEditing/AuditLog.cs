...
public class AuditLog
{
    ...
    [DataMember(Name = "userAvatars")] public string[]? UserAvatars { get; set; }

    [DataMember(Name = "nodeId")] public int NodeId { get; set; }

    [DataMember(Name = "timestamp")] public DateTime Timestamp { get; set; }

    [DataMember(Name = "logType")] public string? LogType { get; set; }

    [DataMember(Name = "entityType")] public string? EntityType { get; set; }
