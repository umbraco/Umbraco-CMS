...
public class MemberSave : ContentBaseSave<IMember>
{
    ...
    [DataMember(Name = "password")] public ChangingPasswordModel? Password { get; set; }

    [DataMember(Name = "memberGroups")] public IEnumerable<string>? Groups { get; set; }
    ...
    [DataMember(Name = "isLockedOut")] public bool IsLockedOut { get; set; }

    [DataMember(Name = "isApproved")] public bool IsApproved { get; set; }
