...
namespace Umbraco.Cms.Core.Models.ContentEditing
{
    ...
    {
        [DataMember(Name = "contentId")] public int ContentId { get; set; }

        [DataMember(Name = "contentTypeId")] public int ContentTypeId { get; set; }

        [DataMember(Name = "versionId")] public int VersionId { get; set; }

        [DataMember(Name = "userId")] public int UserId { get; set; }

        [DataMember(Name = "versionDate")] public DateTime VersionDate { get; set; }
