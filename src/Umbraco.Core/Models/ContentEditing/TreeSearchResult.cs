...
{
    [DataMember(Name = "appAlias")] public string? AppAlias { get; set; }

    [DataMember(Name = "treeAlias")] public string? TreeAlias { get; set; }
    ...
    [DataMember(Name = "results")] public IEnumerable<SearchResultEntity>? Results { get; set; }
}
