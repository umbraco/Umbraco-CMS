    ...
    where T : class
{
    ...
    /// </summary>
    /// <param name="key">The Guid key of the entity whose versions were deleted.</param>
    ...
    protected DeletedVersionsNotification(Guid key, EventMessages messages, int specificVersion = default, bool deletePriorVersions = false, DateTime dateToRetain = default)
