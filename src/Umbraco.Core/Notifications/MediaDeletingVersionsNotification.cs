...
public sealed class MediaDeletingVersionsNotification : DeletingVersionsNotification<IMedia>
{
    ...
    /// </summary>
    /// <param name="key">
    /// Gets the Guid key of the <see cref="IMedia"/> object being deleted.
    /// </param>
    /// <param name="messages">
    ...
    /// </param>
    public MediaDeletingVersionsNotification(Guid key, EventMessages messages, int specificVersion = default, bool deletePriorVersions = false, DateTime dateToRetain = default)
