...
///     into folders. This notification is published after a container has been renamed.
/// </remarks>
public class EntityContainerRenamedNotification : RenamedNotification<EntityContainer>
{
    /// <summary>
    ///     Initializes a new instance of the <see cref="EntityContainerRenamedNotification"/> class.
    /// </summary>
    /// <param name="target">The entity container that was renamed.</param>
