    ...
    where T : class
{
    ...
    protected DeletingVersionsNotification(Guid key, EventMessages messages, int specificVersion = default, bool deletePriorVersions = false, DateTime dateToRetain = default)
