...
public static class ContentNotificationExtensions
{
    ...
    /// </summary>
    public static bool IsPublishingCulture(this ContentPublishingNotification notification, IContent content,
        string culture)
    ...
    /// </summary>
    public static bool IsUnpublishingCulture(this ContentPublishingNotification notification, IContent content,
        string culture)
    ...
    /// </summary>
    public static bool IsUnpublishingCulture(this ContentUnpublishingNotification notification, IContent content,
        string culture)
        => IsUnpublishingCulture(content, culture);
    ...
    /// </summary>
    public static bool HasPublishedCulture(this ContentPublishedNotification notification, IContent content,
        string culture)
    ...
    /// </summary>
    public static bool HasUnpublishedCulture(this ContentPublishedNotification notification, IContent content,
        string culture)
    ...
    /// </summary>
    public static bool HasUnpublishedCulture(this ContentUnpublishedNotification notification, IContent content,
        string culture)
        => HasUnpublishedCulture(content, culture);
