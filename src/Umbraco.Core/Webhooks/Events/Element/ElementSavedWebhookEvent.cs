...
/// <summary>
/// Webhook event that fires when an element is saved.
/// </summary>
[WebhookEvent("Element Saved", Constants.WebhookEvents.Types.Element)]
public class ElementSavedWebhookEvent : WebhookEventContentBase<ElementSavedNotification, IElement>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="ElementSavedWebhookEvent"/> class.
    /// </summary>
    /// <param name="webhookFiringService">The webhook firing service.</param>
    /// <param name="webhookService">The webhook service.</param>
    /// <param name="webhookSettings">The webhook settings.</param>
    /// <param name="serverRoleAccessor">The server role accessor.</param>
    public ElementSavedWebhookEvent(
