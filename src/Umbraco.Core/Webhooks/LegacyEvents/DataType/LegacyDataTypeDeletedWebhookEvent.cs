...
/// <summary>
/// Legacy webhook event that fires when a data type is deleted, using the legacy payload format.
/// </summary>
...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="LegacyDataTypeDeletedWebhookEvent"/> class.
    /// </summary>
