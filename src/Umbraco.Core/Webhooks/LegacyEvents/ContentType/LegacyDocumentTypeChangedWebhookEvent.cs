...
/// <summary>
/// Legacy webhook event that fires when a document type is changed, using the legacy payload format.
/// </summary>
...
{
    /// <summary>
    /// Initializes a new instance of the <see cref="LegacyDocumentTypeChangedWebhookEvent"/> class.
    /// </summary>
