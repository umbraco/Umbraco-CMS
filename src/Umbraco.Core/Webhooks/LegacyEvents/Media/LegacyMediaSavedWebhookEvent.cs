...
/// <summary>
/// Legacy webhook event that fires when media is saved, using the legacy payload format.
/// </summary>
...
public class LegacyMediaSavedWebhookEvent : WebhookEventContentBase<MediaSavedNotification, IMedia>
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="LegacyMediaSavedWebhookEvent"/> class.
    /// </summary>
