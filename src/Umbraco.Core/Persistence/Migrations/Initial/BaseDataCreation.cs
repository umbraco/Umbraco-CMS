...
namespace Umbraco.Core.Persistence.Migrations.Initial
{
    ...
    internal class BaseDataCreation
    {
        ...
        private void CreateCmsDataTypeData()
        {
            ...
            _database.Insert("cmsDataType", "pk", false, new DataTypeDto { PrimaryKey = 17, DataTypeId = 1035, PropertyEditorAlias = Constants.PropertyEditors.MultipleMediaPickerAlias, DbType = "Integer" });            
