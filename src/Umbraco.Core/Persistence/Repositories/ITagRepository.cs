...
public interface ITagRepository : IReadWriteQueryRepository<int, ITag>
{
    ...
    IEnumerable<TaggedEntity> GetTaggedEntitiesByTagGroup(TaggableObjectTypes objectType, string group,
        string? culture = null);

    /// <summary>
    ///     Gets all entities of a type, tagged with the specified tag.
    /// </summary>
    IEnumerable<TaggedEntity> GetTaggedEntitiesByTag(TaggableObjectTypes objectType, string tag, string? group = null,
        string? culture = null);
