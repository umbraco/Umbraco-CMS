...
namespace Umbraco.Core.Persistence.Repositories
{
    internal class NotificationsRepository
    {
        ...
        public IEnumerable<Notification> GetUsersNotifications(IEnumerable<int> userIds, string action, IEnumerable<int> nodeIds)
        {
            ...
            return _unitOfWork.Database.Fetch<dynamic>(sql).Select(x => new Notification(x.id, x.userId, x.nodeObjectType, x.action));
        }
