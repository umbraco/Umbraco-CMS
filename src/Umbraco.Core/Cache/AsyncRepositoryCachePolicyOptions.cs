...
/// </summary>
public class AsyncRepositoryCachePolicyOptions
{
    /// <summary>
    ///     Ctor - sets GetAllCacheValidateCount = true
    /// </summary>
    public AsyncRepositoryCachePolicyOptions(Func<Task<int>> performCountAsync)
    {
        PerformCountAsync = performCountAsync;
    ...
    /// </summary>
    public AsyncRepositoryCachePolicyOptions()
    {
        PerformCountAsync = null;
        CacheNullValues = false;
    ...
    /// </summary>
    public Func<Task<int>>? PerformCountAsync { get; set; }
