...
public class PhysicalFileSystem : IPhysicalFileSystem, IFileProviderFactory
{
    ...
    /// <remarks>Filesystem-relative paths use forward-slashes as directory separators.</remarks>
    /// //TODO check is this is true on linux and windows..
    ...
    ///         directory separator. All separators are forward-slashes.
    ///     </para>
    /// </remarks>
    ...
    public string GetFullPath(string path)
    {
        ...
        throw new UnauthorizedAccessException(
            $"File original: [{originalPath}] full: [{path}] is outside this filesystem's root.");
    }
    ...
    protected string EnsureTrailingSeparator(string path) => path.EnsureEndsWith(Path.DirectorySeparatorChar);
