...
public class PhysicalFileSystem : IPhysicalFileSystem, IFileProviderFactory
{
    ...
    /// <param name="overrideIfExists">A value indicating whether to override the existing file, if any.</param>
    /// <param name="copy">A value indicating whether to copy the file, if true.</param>
    ...
    /// Moves a file.
    /// </summary>
    /// <param name="source">The filesystem-relative path to the source file.</param>
    /// <param name="target">The filesystem-relative path to the target file.</param>
    /// <param name="overrideIfExists">A value indicating whether to override the existing file, if any.</param>
    ...
    /// </summary>
    /// <param name="path">The path to ensure.</param>
    /// <returns>The path with a directory separator character.</returns>
    ...
    /// </summary>
    /// <param name="path">The path to ensure.</param>
    /// <returns>The path with a URL separator character.</returns>
