    ...
    public class AddCmsContentNuByteColumn : MigrationBase
    {
        ...
        public override void Migrate()
        {
            ...
            if (DatabaseType.IsSqlCe())
            {
                ...
                Create.Table<ContentNuTempDto>(withoutKeysAndIndexes: true).Do();
            ...
            AddColumn<ContentNuDto>(columns, "dataRaw");
        }

        private const string TempTableName = Constants.DatabaseSchema.Tables.NodeData + "TEMP";

        [TableName(TempTableName)]
        [ExplicitColumns]
        private class ContentNuTempDto
        {
            [Column("nodeId")]
