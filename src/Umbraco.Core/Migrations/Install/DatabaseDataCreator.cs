...
namespace Umbraco.Core.Migrations.Install
{
    ...
    internal class DatabaseDataCreator
    {
        ...
        private void CreateNodeData()
        {
            ...
            _database.Insert(Constants.DatabaseSchema.Tables.Node, "id", false, new NodeDto { NodeId = Constants.DataTypes.UploadSound, Trashed = false, ParentId = -1, UserId = -1, Level = 1, Path = $"-1,{Constants.DataTypes.UploadSound}", SortOrder = 36, UniqueId = Constants.DataTypes.Guids.UploadSoundGuid, Text = "Upload Sound", NodeObjectType = Constants.ObjectTypes.DataType, CreateDate = DateTime.Now });
            _database.Insert(Constants.DatabaseSchema.Tables.Node, "id", false, new NodeDto { NodeId = Constants.DataTypes.UploadDocument, Trashed = false, ParentId = -1, UserId = -1, Level = 1, Path = $"-1,{Constants.DataTypes.UploadDocument}", SortOrder = 37, UniqueId = Constants.DataTypes.Guids.UploadDocumentGuid, Text = "Upload Document", NodeObjectType = Constants.ObjectTypes.DataType, CreateDate = DateTime.Now });
            _database.Insert(Constants.DatabaseSchema.Tables.Node, "id", false, new NodeDto { NodeId = Constants.DataTypes.UploadVectorImage, Trashed = false, ParentId = -1, UserId = -1, Level = 1, Path = $"-1,{Constants.DataTypes.UploadVectorImage}", SortOrder = 38, UniqueId = Constants.DataTypes.Guids.UploadVectorImageGuid, Text = "Upload Vector Image", NodeObjectType = Constants.ObjectTypes.DataType, CreateDate = DateTime.Now });
            ...
            _database.Insert(Constants.DatabaseSchema.Tables.Node, "id", false, new NodeDto { NodeId = 1037, Trashed = false, ParentId = -1, UserId = -1, Level = 1, Path = "-1,1037", SortOrder = 2, UniqueId = new Guid("c4b1efcf-a9d5-41c4-9621-e9d273b52a9c"), Text = Constants.Conventions.MediaTypes.Vector, NodeObjectType = Constants.ObjectTypes.MediaType, CreateDate = DateTime.Now });
        ...
        private void CreateContentTypeData()
        {
            ...
            _database.Insert(Constants.DatabaseSchema.Tables.ContentType, "pk", false, new ContentTypeDto { PrimaryKey = 541, NodeId = 1035, Alias = Constants.Conventions.MediaTypes.Sound, Icon = Constants.Icons.MediaSound, Thumbnail = Constants.Icons.MediaSound, AllowAtRoot = true, Variations = (byte) ContentVariation.Nothing });
            _database.Insert(Constants.DatabaseSchema.Tables.ContentType, "pk", false, new ContentTypeDto { PrimaryKey = 542, NodeId = 1036, Alias = Constants.Conventions.MediaTypes.Document, Icon = Constants.Icons.MediaDocument, Thumbnail = Constants.Icons.MediaDocument, AllowAtRoot = true, Variations = (byte) ContentVariation.Nothing });
            _database.Insert(Constants.DatabaseSchema.Tables.ContentType, "pk", false, new ContentTypeDto { PrimaryKey = 543, NodeId = 1037, Alias = Constants.Conventions.MediaTypes.Vector, Icon = Constants.Icons.MediaVector, Thumbnail = Constants.Icons.MediaVector, AllowAtRoot = true, Variations = (byte) ContentVariation.Nothing });
        ...
        private void CreatePropertyTypeGroupData()
        {
            ...
            _database.Insert(Constants.DatabaseSchema.Tables.PropertyTypeGroup, "id", false, new PropertyTypeGroupDto { Id = 53, ContentTypeNodeId = 1035, Text = "Sound", SortOrder = 1, UniqueId = new Guid(Constants.PropertyTypeGroups.Sound) });
            _database.Insert(Constants.DatabaseSchema.Tables.PropertyTypeGroup, "id", false, new PropertyTypeGroupDto { Id = 54, ContentTypeNodeId = 1036, Text = "Document", SortOrder = 1, UniqueId = new Guid(Constants.PropertyTypeGroups.Document) });
            _database.Insert(Constants.DatabaseSchema.Tables.PropertyTypeGroup, "id", false, new PropertyTypeGroupDto { Id = 55, ContentTypeNodeId = 1037, Text = "Vector Image", SortOrder = 1, UniqueId = new Guid(Constants.PropertyTypeGroups.Vector) });
        ...
        private void CreatePropertyTypeData()
        {
            ...
            _database.Insert(Constants.DatabaseSchema.Tables.PropertyType, "id", false, new PropertyTypeDto { Id = 43, UniqueId = 43.ToGuid(), DataTypeId = Constants.DataTypes.UploadSound, ContentTypeId = 1035, PropertyTypeGroupId = 53, Alias = Constants.Conventions.Media.File, Name = "Sound", SortOrder = 0, Mandatory = true, ValidationRegExp = null, Description = null, Variations = (byte) ContentVariation.Nothing });
            ...
            _database.Insert(Constants.DatabaseSchema.Tables.PropertyType, "id", false, new PropertyTypeDto { Id = 46, UniqueId = 46.ToGuid(), DataTypeId = Constants.DataTypes.UploadDocument, ContentTypeId = 1036, PropertyTypeGroupId = 54, Alias = Constants.Conventions.Media.File, Name = "Document", SortOrder = 0, Mandatory = true, ValidationRegExp = null, Description = null, Variations = (byte) ContentVariation.Nothing });
            ...
            _database.Insert(Constants.DatabaseSchema.Tables.PropertyType, "id", false, new PropertyTypeDto { Id = 49, UniqueId = 49.ToGuid(), DataTypeId = Constants.DataTypes.UploadVectorImage, ContentTypeId = 1037, PropertyTypeGroupId = 55, Alias = Constants.Conventions.Media.File, Name = "Vector Image", SortOrder = 0, Mandatory = true, ValidationRegExp = null, Description = null, Variations = (byte) ContentVariation.Nothing });
        ...
        private void CreateDataTypeData()
        {
            ...
            _database.Insert(Constants.DatabaseSchema.Tables.DataType, "pk", false, new DataTypeDto
            {
                NodeId = Constants.DataTypes.UploadSound,
                EditorAlias = Constants.PropertyEditors.Aliases.UploadField,
                DbType = "Nvarchar",
            ...
            _database.Insert(Constants.DatabaseSchema.Tables.DataType, "pk", false, new DataTypeDto
            {
                NodeId = Constants.DataTypes.UploadVectorImage,
                EditorAlias = Constants.PropertyEditors.Aliases.UploadField,
                DbType = "Nvarchar",
