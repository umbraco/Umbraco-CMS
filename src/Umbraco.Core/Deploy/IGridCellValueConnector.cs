...
namespace Umbraco.Core.Deploy
{
    ...
    public interface IGridCellValueConnector
    {
        ...
        /// </summary>
        /// <param name="control">The control containing the value.</param>
        ...
        string GetValue(GridValue.Control control, Property property, ICollection<ArtifactDependency> dependencies);

        /// <summary>
        /// Allows you to modify the value of a control being deployed.
        /// </summary>
        /// <param name="control">The control being deployed.</param>
        /// <param name="property">The property where the <paramref name="control"/> is located. Do not modify - only used for context.</param>
        /// <remarks>Follows the pattern of the property value connectors (<see cref="IValueConnector"/>). The SetValue method is used to modify the value of the <paramref name="control"/>.</remarks>
        /// <remarks>Note that only the <paramref name="control"/> value should be modified - not the <paramref name="property"/>.</remarks>
        /// <remarks>The <paramref name="property"/> should only be used to assist with context data relevant when setting the <paramref name="control"/> value.</remarks>
