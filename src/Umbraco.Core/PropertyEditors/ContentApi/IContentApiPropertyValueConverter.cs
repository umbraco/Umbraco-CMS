...
namespace Umbraco.Cms.Core.PropertyEditors.ContentApi;
...
public interface IContentApiPropertyValueConverter : IPropertyValueConverter
{
    ...
    /// </remarks>
    Type GetContentApiPropertyValueType(IPublishedPropertyType propertyType);
    ...
    ///     </para>
    /// </remarks>
    object? ConvertIntermediateToContentApiObject(IPublishedElement owner, IPublishedPropertyType propertyType, PropertyCacheLevel referenceCacheLevel, object? inter, bool preview);
}
