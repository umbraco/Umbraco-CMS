...
public interface IHeadlessPropertyValueConverter : IPropertyValueConverter
{
    /// <summary>
    ///     Gets the type of values returned by the converter for headless representation.
    /// </summary>
    ...
    /// </remarks>
    Type GetHeadlessPropertyValueType(IPublishedPropertyType propertyType);

    /// <summary>
    ///     Converts a property intermediate value to an Object value for headless representation.
    /// </summary>
    ...
    ///     </para>
    /// </remarks>
    object? ConvertIntermediateToHeadlessObject(IPublishedElement owner, IPublishedPropertyType propertyType, PropertyCacheLevel referenceCacheLevel, object? inter, bool preview);
}
