...
public class ListViewConfiguration
{
    ...
    [ConfigurationField("orderDirection", "Order Direction",
        "views/propertyeditors/listview/orderDirection.prevalues.html")]
    public string OrderDirection { get; set; }

    [ConfigurationField("includeProperties", "Columns Displayed",
    ...
    [ConfigurationField("bulkActionPermissions", "Bulk Action Permissions",
    ...
    [ConfigurationField("icon", "Content app icon", "views/propertyeditors/listview/icon.prevalues.html",
        Description = "The icon of the listview content app")]
    public string? Icon { get; set; }

    [ConfigurationField("tabName", "Content app name", "textstring",
        Description = "The name of the listview content app (default if empty: 'Child Items')")]
    public string? TabName { get; set; }

    [ConfigurationField("showContentFirst", "Show Content App First", "boolean",
    ...
    [ConfigurationField("useInfiniteEditor", "Edit in Infinite Editor", "boolean",
    ...
    public class Property
    {
        ...
        [DataMember(Name = "isSystem")] public int IsSystem { get; set; } // TODO: bool
    }
    ...
    public class Layout
    {
        ...
        [DataMember(Name = "selected")] public bool Selected { get; set; }
    }
    ...
    public class BulkActionPermissionSettings
    {
        ...
        [DataMember(Name = "allowBulkCopy")] public bool AllowBulkCopy { get; set; } = true;

        [DataMember(Name = "allowBulkMove")] public bool AllowBulkMove { get; set; } = true;

        [DataMember(Name = "allowBulkDelete")] public bool AllowBulkDelete { get; set; } = true;
    }
}
