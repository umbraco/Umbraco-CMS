...
public class DefaultShortStringHelper : IShortStringHelper
{
    ...
    public DefaultShortStringHelper(DefaultShortStringHelperConfig config) => _config = config.Clone();
    ...
    public static bool IsValidFileNameChar(char c) => InvalidFileNameChars.Contains(c) == false;
    ...
    /// </remarks>
    public virtual string CleanStringForSafeAlias(string text) => CleanStringForSafeAlias(text, _config.DefaultCulture);
    ...
    public virtual string CleanStringForSafeAlias(string text, string culture) =>
        CleanString(text, CleanStringType.Alias, culture);
    ...
    public virtual string CleanStringForUrlSegment(string text) =>
        CleanStringForUrlSegment(text, _config.DefaultCulture);
    ...
    public virtual string CleanStringForUrlSegment(string text, string? culture) =>
        CleanString(text, CleanStringType.UrlSegment, culture);
    ...
    public virtual string CleanStringForSafeFileName(string text) =>
        CleanStringForSafeFileName(text, _config.DefaultCulture);
    ...
    public string CleanString(string text, CleanStringType stringType) =>
        CleanString(text, stringType, _config.DefaultCulture, null);
    ...
    public string CleanString(string text, CleanStringType stringType, char separator) =>
        CleanString(text, stringType, _config.DefaultCulture, separator);
    ...
    public string CleanString(string text, CleanStringType stringType, string? culture) =>
        CleanString(text, stringType, culture, null);
    ...
    public string CleanString(string text, CleanStringType stringType, char separator, string culture) =>
        CleanString(text, stringType, culture, separator);
