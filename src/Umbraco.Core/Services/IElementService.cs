...
///     <see cref="IAsyncPublishableContentService{TContent}" />. It remains as the Element-facing contract
///     that <see cref="ElementService" /> is registered and resolved as.
/// </remarks>
public interface IElementService : IContentServiceBase, IAsyncPublishableContentService<IElement>
{
}
