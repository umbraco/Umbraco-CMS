...
namespace Umbraco.Core.Services
{
    public class RelationService : ScopeRepositoryService, IRelationService
    {
        ...
        {
            using (var repository = RepositoryFactory.CreateRelationRepository(UowProvider.GetReadOnlyUnitOfWork()))
            {
        ...
        {
            using (var repository = RepositoryFactory.CreateRelationTypeRepository(UowProvider.GetReadOnlyUnitOfWork()))
            {
                return repository.Get(id);
            }
        }
        ...
        public IRelation Relate(IUmbracoEntity parent, IUmbracoEntity child, IRelationType relationType)
        {
            ...
            using (var repository = RepositoryFactory.CreateRelationRepository(uow))
            {
                ...
                uow.Commit();
                SavedRelation.RaiseEvent(new SaveEventArgs<IRelation>(relation, false), this, uow.EventManager);
                return relation;
            }
        ...
        public void Save(IRelationType relationType)
        {
            ...
            using (var repository = RepositoryFactory.CreateRelationTypeRepository(uow))
            {
                ...
                uow.Commit();
                SavedRelationType.RaiseEvent(new SaveEventArgs<IRelationType>(relationType, false), this, uow.EventManager);
            }
        ...
        public void Delete(IRelation relation)
        {
            ...
            using (var repository = RepositoryFactory.CreateRelationRepository(uow))
            {
                ...
                uow.Commit();
                DeletedRelation.RaiseEvent(new DeleteEventArgs<IRelation>(relation, false), this, uow.EventManager);
        ...
        public void Delete(IRelationType relationType)
        {
            ...
            using (var repository = RepositoryFactory.CreateRelationTypeRepository(uow))
            {
                ...
                uow.Commit();
                DeletedRelationType.RaiseEvent(new DeleteEventArgs<IRelationType>(relationType, false), this, uow.EventManager);
        ...
        public void DeleteRelationsOfType(IRelationType relationType)
        {
            ...
            using (var repository = RepositoryFactory.CreateRelationRepository(uow))
            {
                ...
                uow.Commit();
                DeletedRelation.RaiseEvent(new DeleteEventArgs<IRelation>(relations, false), this, uow.EventManager);
