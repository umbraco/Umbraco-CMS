...
// TODO: make methods in this class async
internal abstract class AsyncContentNavigationServiceBase<TContentType, TContentTypeService>
    ...
    where TContentTypeService : IAsyncContentTypeBaseService<TContentType>
{
    ...
    /// <summary>
    ///     Initializes a new instance of the <see cref="AsyncContentNavigationServiceBase{TContentType, TContentTypeService}"/> class.
    /// </summary>
    ...
    protected AsyncContentNavigationServiceBase(ICoreScopeProvider coreScopeProvider, INavigationRepository navigationRepository, TContentTypeService typeService)
    {
...
#pragma warning restore IDE0008 // Use explicit type
    ...
    private bool TryGetContentTypeKey(string contentTypeAlias, out Guid? contentTypeKey)
    {
        ...
        TContentType? contentType = _typeService.GetAsync(contentTypeAlias).GetAwaiter().GetResult();
