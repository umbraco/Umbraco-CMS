...
namespace Umbraco.Core.Services.Implement
{
    ...
    public class LocalizationService : ScopeRepositoryService, ILocalizationService
    {
        ...
        public void Save(IDictionaryItem dictionaryItem, int userId = ConstantsCore.Security.SuperUserId)
        {
            using (var scope = ScopeProvider.CreateScope())
            {
        ...
        public void Delete(IDictionaryItem dictionaryItem, int userId = ConstantsCore.Security.SuperUserId)
        {
            using (var scope = ScopeProvider.CreateScope())
            {
        ...
        public void Save(ILanguage language, int userId = ConstantsCore.Security.SuperUserId)
        {
            using (var scope = ScopeProvider.CreateScope())
            {
        ...
        public void Delete(ILanguage language, int userId = ConstantsCore.Security.SuperUserId)
        {
            using (var scope = ScopeProvider.CreateScope())
            {
                // write-lock languages to guard against race conds when dealing with default language
