...
namespace Umbraco.Core.Services.Implement
{
    ...
    public class MacroService : ScopeRepositoryService, IMacroService
    {
        ...
        public void Delete(IMacro macro, int userId = ConstantsCore.Security.SuperUserId)
        {
        ...
        /// <param name="userId">Optional Id of the user deleting the macro</param>
        public void Save(IMacro macro, int userId = ConstantsCore.Security.SuperUserId)
        {
            using (var scope = ScopeProvider.CreateScope())
            {
