...
namespace Umbraco.Core.Services.Implement
{
    ...
    public class FileService : ScopeRepositoryService, IFileService
    {
        ...
        public void SaveStylesheet(Stylesheet stylesheet, int userId = ConstantsCore.Security.SuperUserId)
        {
        ...
        /// <param name="userId"></param>
        public void DeleteStylesheet(string path, int userId = ConstantsCore.Security.SuperUserId)
        {
            using (var scope = ScopeProvider.CreateScope())
            {
        ...
        /// <param name="userId"></param>
        public void SaveScript(Script script, int userId = ConstantsCore.Security.SuperUserId)
        {
            using (var scope = ScopeProvider.CreateScope())
            {
        ...
        /// <param name="userId"></param>
        public void DeleteScript(string path, int userId = ConstantsCore.Security.SuperUserId)
        {
            using (var scope = ScopeProvider.CreateScope())
            {
        ...
        /// </returns>
        public Attempt<OperationResult<OperationResultType, ITemplate>> CreateTemplateForContentType(string contentTypeAlias, string contentTypeName, int userId = ConstantsCore.Security.SuperUserId)
        {
        ...
        /// <param name="userId"></param>
        /// <returns></returns>
        public ITemplate CreateTemplateWithIdentity(string name, string alias, string content, ITemplate masterTemplate = null, int userId = ConstantsCore.Security.SuperUserId)
        {
        ...
        /// <param name="userId"></param>
        public void SaveTemplate(ITemplate template, int userId = ConstantsCore.Security.SuperUserId)
        {
            using (var scope = ScopeProvider.CreateScope())
            {
        ...
        public void SaveTemplate(IEnumerable<ITemplate> templates, int userId = ConstantsCore.Security.SuperUserId)
        {
        ...
        /// <param name="userId"></param>
        public void DeleteTemplate(string alias, int userId = ConstantsCore.Security.SuperUserId)
        {
            using (var scope = ScopeProvider.CreateScope())
            {
...
#region Partial Views
        ...
        public Attempt<IPartialView> CreatePartialView(IPartialView partialView, string snippetName = null, int userId = ConstantsCore.Security.SuperUserId)
        {
            return CreatePartialViewMacro(partialView, PartialViewType.PartialView, snippetName, userId);
        }

        public Attempt<IPartialView> CreatePartialViewMacro(IPartialView partialView, string snippetName = null, int userId = ConstantsCore.Security.SuperUserId)
        {
            return CreatePartialViewMacro(partialView, PartialViewType.PartialViewMacro, snippetName, userId);
        }

        private Attempt<IPartialView> CreatePartialViewMacro(IPartialView partialView, PartialViewType partialViewType, string snippetName = null, int userId = ConstantsCore.Security.SuperUserId)
        {
        ...
        public bool DeletePartialView(string path, int userId = ConstantsCore.Security.SuperUserId)
        {
            return DeletePartialViewMacro(path, PartialViewType.PartialView, userId);
        }

        public bool DeletePartialViewMacro(string path, int userId = ConstantsCore.Security.SuperUserId)
        {
            return DeletePartialViewMacro(path, PartialViewType.PartialViewMacro, userId);
        }

        private bool DeletePartialViewMacro(string path, PartialViewType partialViewType, int userId = ConstantsCore.Security.SuperUserId)
        {
            using (var scope = ScopeProvider.CreateScope())
            {
                var repository = GetPartialViewRepository(partialViewType);
        ...
        public Attempt<IPartialView> SavePartialView(IPartialView partialView, int userId = ConstantsCore.Security.SuperUserId)
        {
            return SavePartialView(partialView, PartialViewType.PartialView, userId);
        }

        public Attempt<IPartialView> SavePartialViewMacro(IPartialView partialView, int userId = ConstantsCore.Security.SuperUserId)
        {
            return SavePartialView(partialView, PartialViewType.PartialViewMacro, userId);
        }

        private Attempt<IPartialView> SavePartialView(IPartialView partialView, PartialViewType partialViewType, int userId = ConstantsCore.Security.SuperUserId)
        {
            using (var scope = ScopeProvider.CreateScope())
            {
