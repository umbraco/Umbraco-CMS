...
public abstract class ContentTypeServiceBase<TRepository, TItem> : ContentTypeServiceBase,
    ...
    where TItem : class, IContentTypeComposition
{
    ...
    protected abstract ContentTypeRefreshNotification<TItem> GetContentTypeRefreshedNotification(
        IEnumerable<ContentTypeChange<TItem>> changes, EventMessages eventMessages);
    ...
    public void Delete(TItem item, int userId = Constants.Security.SuperUserId)
    {
        using (ICoreScope scope = ScopeProvider.CreateCoreScope())
        {
            ...
            IEnumerable<TItem> referenceToAllowedContentTypes =
            ...
            DeletedNotification<TItem> deletedNotification =
        ...
        string name, int userId = Constants.Security.SuperUserId)
    {
        ...
        using (ICoreScope scope = ScopeProvider.CreateCoreScope())
        {
            ...
            {
                scope.Complete();
                return OperationResult.Attempt.Fail<OperationResultType, EntityContainer>(
