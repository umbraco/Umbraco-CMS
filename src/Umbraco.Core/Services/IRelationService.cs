...
public interface IRelationService : IService
{
    ...
    /// <returns></returns>
    IEnumerable<IRelation> GetPagedByRelationTypeId(int relationTypeId, long pageIndex, int pageSize,
    ...
    /// <param name="totalChildren"></param>
    /// <returns>An enumerable list of <see cref="IUmbracoEntity" /></returns>
    IEnumerable<IUmbracoEntity> GetPagedParentEntitiesByChildId(int id, long pageIndex, int pageSize,
    ...
    /// <param name="totalChildren"></param>
    /// <returns>An enumerable list of <see cref="IUmbracoEntity" /></returns>
    IEnumerable<IUmbracoEntity> GetPagedChildEntitiesByParentId(int id, long pageIndex, int pageSize,
        out long totalChildren, params UmbracoObjectTypes[] entityTypes);
