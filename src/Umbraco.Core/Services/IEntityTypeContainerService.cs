...
/// <summary>
///     Provides methods for managing <see cref="EntityContainer"/> objects for entity types.
/// </summary>
/// <typeparam name="TTreeEntity">The type of tree entity this container service manages.</typeparam>
    ...
    where TTreeEntity : ITreeEntity
{
    ...
    /// <returns>A task that represents the asynchronous operation. The task result contains the container, or null if not found.</returns>
    ...
    /// <returns>A task that represents the asynchronous operation. The task result contains the matching containers.</returns>
    Task<IEnumerable<EntityContainer>> GetAsync(string name, int level);

    /// <summary>
    /// Gets all containers.
    /// </summary>
    /// <returns>A task that represents the asynchronous operation. The task result contains all containers.</returns>
    ...
    /// <returns>A task that represents the asynchronous operation. The task result contains the parent container, or null if the container is at the root.</returns>
    ...
    /// <returns>A task that represents the asynchronous operation. The task result contains the parent container, or null if the entity is at the root.</returns>
    ...
    /// <returns>An <see cref="Attempt{TResult,TStatus}"/> containing the created container if successful, or an error status if not.</returns>
    ...
    /// <returns>An <see cref="Attempt{TResult,TStatus}"/> containing the updated container if successful, or an error status if not.</returns>
