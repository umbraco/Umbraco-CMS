...
public class InstallationSummary
{
    ...
    public override string ToString()
    {
        ...
        void WriteConflicts<T>(IEnumerable<T>? source, Func<T, string?> selector, string message,
        ...
        WriteConflicts(Warnings?.ConflictingMacros, x => x?.Alias,
            "Conflicting macros found, they will be overwritten: ");
        WriteConflicts(Warnings?.ConflictingTemplates, x => x.Alias,
            "Conflicting templates found, they will be overwritten: ");
        WriteConflicts(Warnings?.ConflictingStylesheets, x => x?.Alias,
            "Conflicting stylesheets found, they will be overwritten: ");
