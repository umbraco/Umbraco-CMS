...
namespace Umbraco.Core.Packaging.Models
{
    ...
    public class PackageAction
    {
        ...
        public bool Undo //NOTE: Should thid default to "False"? but the documentation says default "True" (https://our.umbraco.org/wiki/reference/packaging/package-actions)
        {
