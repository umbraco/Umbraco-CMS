...
(function ($, Base, window, document, undefined) {
    ...
    Umbraco.Controls.FolderBrowser = Base.extend({
        ...
        _initOverlay: function () {
            ...
            var instructions = 'draggable' in document.createElement('span') ? "<h1>Drag files here to upload</h1> \<p>Or, click the button below to choose the items to upload</p>" : "<h1>Click the browse button below to chose the items to upload</h1>";
