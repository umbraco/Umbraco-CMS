...
<asp:Panel ID="pnlTab" Style="text-align: left" runat="server">
    ...
    <cc2:Pane ID="PaneTabsInherited" runat="server" Visible="false">
        <p><strong>Master Content Type enabled</strong><br />
            This Content Type uses <em>
                <asp:Literal ID="tabsMasterContentTypeName" runat="server"></asp:Literal></em> as Master Content Type(s). Tabs from Master Content Types are not shown and can only be edited on the Master Content Type itself</p>
    </cc2:Pane>

    <cc2:Pane ID="Pane2" runat="server">
        <cc2:PropertyPanel runat="server" ID="pp_newTab" Text="New tab">
            <asp:TextBox ID="txtNewTab" runat="server" />
            &nbsp;
            <asp:Button ID="btnNewTab" runat="server" Text="New tab" OnClick="btnNewTab_Click" />
        </cc2:PropertyPanel>
    </cc2:Pane>
    ...
    <cc2:Pane ID="Pane1" runat="server" Width="216" Height="80">
        ...
        <p style="text-align: center;">
            <asp:Literal ID="lttNoTabs" runat="server"></asp:Literal>
        </p>
    </cc2:Pane>
</asp:Panel>
...
<asp:Panel ID="pnlInfo" runat="server">
    ...
    <cc2:Pane runat="server">
        <cc2:PropertyPanel ID="pp_container" runat="server" Text="Is Container Content Type">
            <asp:CheckBox runat="server" ID="isContainer" Text="Yes" /><br />
...
<asp:Panel ID="pnlProperties" runat="server">
    <cc2:Pane ID="PanePropertiesInherited" runat="server" Visible="false">
        <p><strong>Master Content Type enabled</strong><br />
            This Content Type uses <em>
                <asp:Literal ID="propertiesMasterContentTypeName" runat="server"></asp:Literal></em> as a Master Content Type. Properties from Master Content Types are not shown and can only be edited on the Master Content Type itself</p>
    </cc2:Pane>
