...
(function($) {
    $.fn.GroupPermissionsEditor = function(opts) {
        return this.each(function() {
            ...
            new Umbraco.Controls.GroupPermissionsEditor().init($(this), conf.groupId, $(conf.pPanelSelector), conf.replacePChkBoxSelector);
        });
    };
    $.fn.GroupPermissionsEditorAPI = function() {
        /// <summary>exposes the Permissions Editor API for the selected object</summary>
        return $(this).data("GroupPermissionsEditor") == null ? null : $(this).data("GroupPermissionsEditor");
    }
    Umbraco.Controls.GroupPermissionsEditor = function() {
        /// <summary>
        /// A class to perform the AJAX callback methods for the GroupPermissionsEditor
        /// </summary>
        return {
            //private members
            _groupID: -1,
            ...
            init: function(tree, uId, pPanel, chkReplaceSelector) {
                ...
                this._groupID = parseInt(uId);
                this._pPanel = pPanel;
                this._tree = tree;
                this._chkReplaceSelector = chkReplaceSelector;

                //store the api object
                tree.data("GroupPermissionsEditor", this);
            ...
            _beginShowNodePermissions: function(selectedIDs) {
                ...
                //setTimeout("GroupPermissionsEditor._showNodePermissions('" + selectedIDs + "');", 10);
            },
            _showNodePermissions: function(selectedIDs) {
                var _this = this;
                umbraco.cms.presentation.user.GroupPermissionsHandler.GetNodePermissions(this._groupID, selectedIDs, function (r) { _this._showNodePermissionsCallback(r); });
            },
            ...
            _savePermissions: function(nodeIDs, selectedPermissions, replaceChildren) {
                var _this = this;
                umbraco.cms.presentation.user.GroupPermissionsHandler.SaveNodePermissions(this._groupID, nodeIDs, selectedPermissions, replaceChildren, function (r) { _this._savePermissionsHandler(r) });
            },
