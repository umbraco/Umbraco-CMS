...
public class StaticFileTreeChildrenController : StaticFileTreeControllerBase
{
    public StaticFileTreeChildrenController(IPhysicalFileSystem physicalFileSystem)
