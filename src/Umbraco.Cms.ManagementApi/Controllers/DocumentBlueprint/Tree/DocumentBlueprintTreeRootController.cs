...
public class DocumentBlueprintTreeRootController : DocumentBlueprintTreeControllerBase
{
    public DocumentBlueprintTreeRootController(IEntityService entityService, IContentTypeService contentTypeService)
