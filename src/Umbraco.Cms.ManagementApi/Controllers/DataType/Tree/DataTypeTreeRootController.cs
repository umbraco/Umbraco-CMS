...
public class DataTypeTreeRootController : DataTypeTreeControllerBase
{
    public DataTypeTreeRootController(IEntityService entityService, IDataTypeService dataTypeService)
