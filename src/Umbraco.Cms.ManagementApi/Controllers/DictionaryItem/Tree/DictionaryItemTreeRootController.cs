...
public class DictionaryItemTreeRootController : DictionaryItemTreeControllerBase
{
    public DictionaryItemTreeRootController(IEntityService entityService, ILocalizationService localizationService)
