...
public class DictionaryItemTreeChildrenController : DictionaryItemTreeControllerBase
{
    public DictionaryItemTreeChildrenController(IEntityService entityService, ILocalizationService localizationService)
