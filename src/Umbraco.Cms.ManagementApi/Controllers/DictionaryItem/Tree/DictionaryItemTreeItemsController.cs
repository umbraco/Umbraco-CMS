...
public class DictionaryItemTreeItemsController : DictionaryItemTreeControllerBase
{
    public DictionaryItemTreeItemsController(IEntityService entityService, ILocalizationService localizationService)
