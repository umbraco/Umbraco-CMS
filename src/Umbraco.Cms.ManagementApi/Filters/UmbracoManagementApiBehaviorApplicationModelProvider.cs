...
///     </para>
/// </remarks>
public class UmbracoManagementApiBehaviorApplicationModelProvider : IApplicationModelProvider
{
    private readonly List<IActionModelConvention> _actionModelConventions;

    /// <summary>
    ///     Initializes a new instance of the <see cref="UmbracoManagementApiBehaviorApplicationModelProvider" /> class.
    /// </summary>
    public UmbracoManagementApiBehaviorApplicationModelProvider(IModelMetadataProvider modelMetadataProvider)
    {
        ...
        _actionModelConventions = new List<IActionModelConvention>
        {
            ...
            new UmbracoSystemTextJsonModelBinderConvention(modelMetadataProvider),
        };
    ...
    public void OnProvidersExecuting(ApplicationModelProviderContext context)
    {
        ...
        {
            if (!IsUmbracoManagementApiController(controller))
            {
                continue;
            }
    ...
    private static bool IsUmbracoManagementApiController(ICommonModel controller)
        => controller.Attributes.OfType<UmbracoManagementApiControllerAttribute>().Any();
}
