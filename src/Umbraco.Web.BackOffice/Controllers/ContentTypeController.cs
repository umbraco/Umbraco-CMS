...
namespace Umbraco.Web.BackOffice.Controllers
{
    ...
    public class ContentTypeController : ContentTypeControllerBase<IContentType>
    {
        ...
        public IActionResult DeleteById(int id)
        {
            ...
            _contentTypeService.Delete(foundType, _webSecurityAccessor.WebSecurity.CurrentUser.Id);
            return Ok();
        }
        ...
        {
            _contentTypeService.DeleteContainer(id, _webSecurityAccessor.WebSecurity.CurrentUser.Id);
        ...
        {
            var result = _contentTypeService.CreateContainer(parentId, name, _webSecurityAccessor.WebSecurity.CurrentUser.Id);
        ...
        {
            var result = _contentTypeService.RenameContainer(id, name, _webSecurityAccessor.WebSecurity.CurrentUser.Id);
