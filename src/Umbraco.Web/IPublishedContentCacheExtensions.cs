...
namespace Umbraco.Web
{
    ...
    public static class IPublishedContentCacheExtensions
    {
        ...
        public static dynamic GetDynamicById(this IPublishedContentCache cache, int contentId)
        {
        ...
        /// <returns>The dynamic content, or null.</returns>
        public static dynamic GetDynamicSingleByXPath(this IPublishedContentCache cache, string xpath, params XPathVariable[] vars)
        {
        ...
        /// <param name="vars">Optional XPath variables</param>
        /// <returns>The dynamic content, or null.</returns>
        public static dynamic GetDynamicSingleByXPath(this IPublishedContentCache cache, XPathExpression xpath, params XPathVariable[] vars)
        {
            var content = cache.GetSingleByXPath(xpath, vars);
            return content == null ? DynamicNull.Null : new DynamicPublishedContent(content).AsDynamic();
        }
        ...
        public static dynamic GetDynamicByXPath(this IPublishedContentCache cache, string xpath, params XPathVariable[] vars)
        {
        ...
        /// <param name="vars">Optional XPath variables</param>
        /// <returns>The dynamic contents.</returns>
        public static dynamic GetDynamicByXPath(this IPublishedContentCache cache, XPathExpression xpath, params XPathVariable[] vars)
        {
            var content = cache.GetByXPath(xpath, vars);
            return new DynamicPublishedContentList(content.Select(c => new DynamicPublishedContent(c)));
        }
        ...
        /// <param name="cache">The contextual cache.</param>
        /// <returns>The dynamic contents.</returns>
        public static dynamic GetDynamicAtRoot(this IPublishedContentCache cache)
        {
