...
namespace Umbraco.Web.PropertyEditors
{
    ...
    /// </remarks>
    [PropertyEditor(Constants.PropertyEditors.Aliases.DropDownList, "Dropdown list", "dropdown", ValueType = PropertyEditorValueTypes.String, Group = "lists", Icon = "icon-indent")]
