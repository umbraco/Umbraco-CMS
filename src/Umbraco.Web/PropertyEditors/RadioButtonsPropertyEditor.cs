...
namespace Umbraco.Web.PropertyEditors
{
    ...
    /// </remarks>
    [PropertyEditor(Constants.PropertyEditors.Aliases.RadioButtonList, "Radio button list", "radiobuttons", ValueType = ValueTypes.Integer, Group="lists", Icon="icon-target")]
