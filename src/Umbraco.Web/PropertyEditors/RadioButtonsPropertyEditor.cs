...
namespace Umbraco.Web.PropertyEditors
{
    ...
    /// </remarks>
    [PropertyEditor(Constants.PropertyEditors.Aliases.RadioButtonList, "Radio button list", "radiobuttons", ValueType = PropertyEditorValueTypes.Integer, Group="lists", Icon="icon-target")]
