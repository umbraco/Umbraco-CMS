...
namespace Umbraco.Web.PropertyEditors.ValueConverters
{
    ...
    public class MultipleMediaPickerPropertyConverter : PropertyValueConverterBase
    {
        ...
        public MultipleMediaPickerPropertyConverter(ServiceContext services, CacheHelper appCache, IUmbracoContextAccessor umbracoContextAccessor, PropertyEditorCollection propertyEditors, ILogger logger)
        {
        ...
        public override object ConvertSourceToInter(PublishedPropertyType propertyType, object source, bool preview)
        {
            ...
            if (nodeIds.Length > 0)
            {
                ...
                _logger.Warn<MultipleMediaPickerPropertyConverter>(error);
