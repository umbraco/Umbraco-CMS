...
namespace Umbraco.Web.PropertyEditors.ValueConverters
{
    ...
    public class RelatedLinksLegacyValueConverter : PropertyValueConverterBase
    {
        ...
        public override object ConvertInterToXPath(IPublishedElement owner, PublishedPropertyType propertyType, PropertyCacheLevel referenceCacheLevel, object source, bool preview)
        {
            if (source == null) return null;
            var sourceString = source.ToString();
