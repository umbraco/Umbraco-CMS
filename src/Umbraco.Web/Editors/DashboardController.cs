...
namespace Umbraco.Web.Editors
{
    ...
    public class DashboardController : UmbracoApiController
    {
        ...
        /// </summary>
        public DashboardController(IGlobalSettings globalSettings, UmbracoContext umbracoContext, ISqlContext sqlContext, ServiceContext services, AppCaches applicationCache, IProfilingLogger logger, IRuntimeState runtimeState, Dashboards dashboards)
