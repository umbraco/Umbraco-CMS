...
namespace umbraco.cms.presentation.settings
{
	...
	public partial class editTemplate : UmbracoEnsuredPage
	{
		...
		public editTemplate()
		{
            ...
            _umbracoDatabase = ApplicationContext.Current.DatabaseContext.Database;
        }
		...
		{
			if (
                _umbracoDatabase.ExecuteScalar<int>(string.Format("select 1 from cmsMacroProperty where macro = {0}", macroId)) ==
				1)
				return "1";
			else
				return "0";
