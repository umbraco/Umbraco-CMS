...
namespace umbraco.cms.presentation.developer
{
    ...
    public partial class editMacro : UmbracoEnsuredPage
    {
        ...
        public void deleteMacroProperty(object sender, EventArgs e)
        {
            ...
            ApplicationContext.Current.DatabaseContext.Database.Delete("cmsMacroProperty", "id", new { id = macroPropertyID.Value });
        ...
        //
        // commented-out - it doesn't compile (see error message below) and it seems to be obsolete - doesn't have any callers
        //
        ////Error	632	Inconsistent accessibility: 
        ////   return type 'System.Collections.Generic.List<Umbraco.Core.Models.Rdbms.MacroPropertyTypeDto>' is less accessible 
        ////   than method 'umbraco.cms.presentation.developer.editMacro.GetMacroPropertyTypes()'	
        //public List<MacroPropertyTypeDto> GetMacroPropertyTypes()
        //{
        //    // Load dataChildTypes	
        //    return ApplicationContext.Current.DatabaseContext.Database.Fetch<MacroPropertyTypeDto>("select id, macroPropertyTypeAlias from cmsMacroPropertyType order by macroPropertyTypeAlias"); 
        //}
