...
namespace Umbraco.Web.Routing
{
    ...
    /// </summary>
    public interface ISiteDomainHelper2 : ISiteDomainHelper
    {
        /// <summary>
        ...
        /// </remarks>
        DomainAndUri MapDomain(Uri current, HttpRequestBase httpRequest, DomainAndUri[] domainAndUris);
        ...
        IEnumerable<DomainAndUri> MapDomains(Uri current, HttpRequestBase httpRequest, DomainAndUri[] domainAndUris, bool excludeDefault);
    }

    [Obsolete("Use ISiteDomainHelper2 instead")]
