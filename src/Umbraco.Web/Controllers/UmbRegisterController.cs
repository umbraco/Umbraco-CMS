...
namespace Umbraco.Web.Controllers
{
    public class UmbRegisterController : SurfaceController
    {
        ...
        public UmbRegisterController(UmbracoHelper umbracoHelper, IUmbracoDatabaseFactory databaseFactory, ServiceContext services, AppCaches appCaches, ILogger logger, IProfilingLogger profilingLogger)
