...
{
    /// <summary>
    /// Used only to invalidate the user group permissions cache
    /// </summary>
    /// <remarks>
    /// The UserGroupCacheRefresher will also clear a group's permissions cache, 
    /// this refresher is for invalidating only permissions for groups and content, not the groups themselves.
    /// </remarks>
