...
namespace Umbraco.Web.Trees
{
    ...
    [Tree(Constants.Applications.Settings, Constants.Trees.SchemaTypes, null, sortOrder:5)]
    [Mvc.PluginController("UmbracoTrees")]
    [CoreTree]
    //[LegacyBaseTree(typeof(loadSchemaTypes))]
    public class SchemaTypeTreeController : TreeController
    {
        protected override TreeNodeCollection GetTreeNodes(string id, FormDataCollection queryStrings)
        {
            ...
            nodes.AddRange(
                Services.EntityService.GetChildren(intId.Result, UmbracoObjectTypes.SchemaTypeContainer)
            ...
            nodes.AddRange(
                Services.EntityService.GetChildren(intId.Result, UmbracoObjectTypes.SchemaType)
                    .OrderBy(entity => entity.Name)
                    .Select(dt =>
                    {
        ...
        protected override MenuItemCollection GetMenuForNode(string id, FormDataCollection queryStrings)
        {
            ...
            var container = Services.EntityService.Get(int.Parse(id), UmbracoObjectTypes.SchemaTypeContainer);
            if (container != null)
            {
                //set the default to create
                menu.DefaultMenuAlias = ActionNew.Instance.Alias;
