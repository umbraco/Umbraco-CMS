...
/// the published index. This custom cache refresher is only ever broadcast from an actual publish or unpublish (see
/// <see cref="ElementPublishStatusNotificationHandler"/>), giving that missing level of granularity.
/// </remarks>
internal sealed class ElementChangeCacheRefresher : PayloadCacheRefresherBase<ElementChangeCacheRefresherNotification, ContentCacheRefresherNotificationPayload<ElementChangeCacheRefresher.JsonPayload>>
{
    /// <summary>
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ElementChangeCacheRefresher"/> class.
    /// </summary>
    /// <param name="appCaches">The application caches.</param>
    /// <param name="serializer">The JSON serializer.</param>
    /// <param name="eventAggregator">The event aggregator.</param>
    /// <param name="factory">The notification factory.</param>
    public ElementChangeCacheRefresher(AppCaches appCaches, IJsonSerializer serializer, IEventAggregator eventAggregator, ICacheRefresherNotificationFactory factory)
    ...
    /// <inheritdoc />
    public override string Name => "Element Change Cache Refresher";

    /// <summary>
    /// The payload broadcast for a single published or unpublished element.
    /// </summary>
