...
/// <inheritdoc />
public class InitialState : Migration
{
    ...
    /// <inheritdoc />
    protected void UpSqlite(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                jsonInstruction = table.Column<string>(type: "ntext", nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                createDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())"),
                userData = table.Column<string>(type: "ntext", nullable: true)
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                tourData = table.Column<string>(type: "ntext", nullable: true)
            },
            constraints: table =>
            {
                table.PrimaryKey("PK_umbracoUser", x => x.id);
            });
        ...
        migrationBuilder.CreateTable(
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK_umbracoUserStartNode", x => x.id);
                table.ForeignKey(
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                textValue = table.Column<string>(type: "ntext", nullable: true)
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateIndex(
            name: "IX_cmsTagRelationship_tagId",
            table: "cmsTagRelationship",
            column: "tagId");
        ...
        migrationBuilder.CreateIndex(
            name: "IX_umbracoContentVersionCleanupPolicy_contentTypeId",
            table: "umbracoContentVersionCleanupPolicy",
            column: "contentTypeId");
    ...
    protected void UpSqlServer(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                macroUseInEditor = table.Column<bool>(type: "bit", nullable: false, defaultValueSql: "('0')"),
                macroRefreshRate = table.Column<int>(type: "int", nullable: false, defaultValueSql: "('0')"),
                macroAlias = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                macroName = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                macroCacheByPage = table.Column<bool>(type: "bit", nullable: false, defaultValueSql: "('1')"),
                macroCachePersonalized = table.Column<bool>(type: "bit", nullable: false, defaultValueSql: "('0')"),
                macroDontRender = table.Column<bool>(type: "bit", nullable: false, defaultValueSql: "('0')"),
                macroSource = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                macroType = table.Column<int>(type: "int", nullable: false)
            },
            constraints: table =>
            {
                table.PrimaryKey("PK_cmsMacro", x => x.id);
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                id = table.Column<int>(type: "int", nullable: false)
                    .Annotation("SqlServer:Identity", "1, 1"),
                performingUserId = table.Column<int>(type: "int", nullable: false),
                performingDetails = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true),
                performingIp = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: true),
                eventDateUtc = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())"),
                affectedUserId = table.Column<int>(type: "int", nullable: false),
                affectedDetails = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true),
                eventType = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: false),
                eventDetails = table.Column<string>(type: "nvarchar(1024)", maxLength: 1024, nullable: true)
            },
            constraints: table =>
            {
                table.PrimaryKey("PK_umbracoAudit", x => x.id);
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                utcStamp = table.Column<DateTime>(type: "datetime", nullable: false),
                jsonInstruction = table.Column<string>(type: "ntext", nullable: false),
                originated = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                instructionCount = table.Column<int>(type: "int", nullable: false, defaultValueSql: "('1')")
            },
            constraints: table =>
            {
                table.PrimaryKey("PK_umbracoCacheInstruction", x => x.id);
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                id = table.Column<int>(type: "int", nullable: false)
                    .Annotation("SqlServer:Identity", "1, 1"),
                userOrMemberKey = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                isDefaultVariantLang = table.Column<bool>(type: "bit", nullable: false, defaultValueSql: "('0')"),
                mandatory = table.Column<bool>(type: "bit", nullable: false, defaultValueSql: "('0')"),
                fallbackLanguageId = table.Column<int>(type: "int", nullable: true)
            },
            constraints: table =>
            {
                table.PrimaryKey("PK_umbracoLanguage", x => x.id);
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                id = table.Column<int>(type: "int", nullable: false)
                    .Annotation("SqlServer:Identity", "1, 1"),
                typeUniqueId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                dual = table.Column<bool>(type: "bit", nullable: false),
                parentObjectType = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                childObjectType = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                name = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                alias = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false),
                isDependency = table.Column<bool>(type: "bit", nullable: false, defaultValueSql: "('0')")
            },
            constraints: table =>
            {
                table.PrimaryKey("PK_umbracoRelationType", x => x.id);
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                isSchedulingPublisher = table.Column<bool>(type: "bit", nullable: false)
            },
            constraints: table =>
            {
                table.PrimaryKey("PK_umbracoServer", x => x.id);
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                id = table.Column<int>(type: "int", nullable: false)
                    .Annotation("SqlServer:Identity", "1, 1"),
                userOrMemberKey = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                providerName = table.Column<string>(type: "nvarchar(400)", maxLength: 400, nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                id = table.Column<int>(type: "int", nullable: false)
                    .Annotation("SqlServer:Identity", "1, 1"),
                userDisabled = table.Column<bool>(type: "bit", nullable: false, defaultValueSql: "('0')"),
                userNoConsole = table.Column<bool>(type: "bit", nullable: false, defaultValueSql: "('0')"),
                userName = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                userLogin = table.Column<string>(type: "nvarchar(125)", maxLength: 125, nullable: false),
                userPassword = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                passwordConfig = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                userEmail = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                userLanguage = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: true),
                securityStampToken = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                id = table.Column<int>(type: "int", nullable: false)
                    .Annotation("SqlServer:Identity", "1, 1"),
                uniquePropertyId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                editorAlias = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                macro = table.Column<int>(type: "int", nullable: false),
                macroPropertySortOrder = table.Column<int>(type: "int", nullable: false, defaultValueSql: "('0')"),
                macroPropertyAlias = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                macroPropertyName = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false)
            },
            constraints: table =>
            {
                table.PrimaryKey("PK_cmsMacroProperty", x => x.id);
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                Datestamp = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())"),
                logHeader = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                logComment = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                trashed = table.Column<bool>(type: "bit", nullable: false, defaultValueSql: "('0')"),
                nodeUser = table.Column<int>(type: "int", nullable: true),
                text = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                nodeObjectType = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                createDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())")
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                thumbnail = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false, defaultValueSql: "('folder.png')"),
                description = table.Column<string>(type: "nvarchar(1500)", maxLength: 1500, nullable: true),
                isContainer = table.Column<bool>(type: "bit", nullable: false, defaultValueSql: "('0')"),
                isElement = table.Column<bool>(type: "bit", nullable: false, defaultValueSql: "('0')"),
                allowAtRoot = table.Column<bool>(type: "bit", nullable: false, defaultValueSql: "('0')"),
                variations = table.Column<int>(type: "int", nullable: false, defaultValueSql: "('1')")
            },
            constraints: table =>
            {
                table.PrimaryKey("PK_cmsContentType", x => x.pk);
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                parentContentTypeId = table.Column<int>(type: "int", nullable: false),
                childContentTypeId = table.Column<int>(type: "int", nullable: false)
            },
            constraints: table =>
            {
                table.PrimaryKey("PK_cmsContentType2ContentType", x => new { x.parentContentTypeId, x.childContentTypeId });
        ...
        migrationBuilder.CreateTable(
            ...
            {
                nodeId = table.Column<int>(type: "int", nullable: false),
                propertyEditorAlias = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                dbType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                culture = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                userId = table.Column<int>(type: "int", nullable: false),
                nodeId = table.Column<int>(type: "int", nullable: false),
                action = table.Column<string>(type: "nchar(1)", fixedLength: true, maxLength: 1, nullable: false)
            },
            constraints: table =>
            {
                table.PrimaryKey("PK_umbracoUser2NodeNotify", x => new { x.userId, x.nodeId, x.action });
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                id = table.Column<int>(type: "int", nullable: false)
                    .Annotation("SqlServer:Identity", "1, 1"),
                userGroupAlias = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                userGroupName = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false),
                userGroupDefaultPermissions = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                createDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())"),
                updateDate = table.Column<DateTime>(type: "datetime", nullable: false, defaultValueSql: "(getdate())"),
                icon = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                hasAccessToAllLanguages = table.Column<bool>(type: "bit", nullable: false),
                startContentId = table.Column<int>(type: "int", nullable: true),
                startMediaId = table.Column<int>(type: "int", nullable: true)
            },
            constraints: table =>
            {
                table.PrimaryKey("PK_umbracoUserGroup", x => x.id);
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                startNodeType = table.Column<int>(type: "int", nullable: false)
            },
            constraints: table =>
            {
                table.PrimaryKey("PK_umbracoUserStartNode", x => x.id);
        ...
        migrationBuilder.CreateTable(
            ...
            {
                Id = table.Column<int>(type: "int", nullable: false),
                AllowedId = table.Column<int>(type: "int", nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                memberCanEdit = table.Column<bool>(type: "bit", nullable: false, defaultValueSql: "('0')"),
                viewOnProfile = table.Column<bool>(type: "bit", nullable: false, defaultValueSql: "('0')"),
                isSensitive = table.Column<bool>(type: "bit", nullable: false, defaultValueSql: "('0')")
            },
            constraints: table =>
            {
                table.PrimaryKey("PK_cmsMemberType", x => x.pk);
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                id = table.Column<int>(type: "int", nullable: false)
                    .Annotation("SqlServer:Identity", "1, 1"),
                uniqueID = table.Column<Guid>(type: "uniqueidentifier", nullable: false, defaultValueSql: "(newid())"),
                contenttypeNodeId = table.Column<int>(type: "int", nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            {
                contentTypeId = table.Column<int>(type: "int", nullable: false),
                preventCleanup = table.Column<bool>(type: "bit", nullable: false),
                keepAllVersionsNewerThanDays = table.Column<int>(type: "int", nullable: true),
                keepLatestVersionPerDayForDays = table.Column<int>(type: "int", nullable: true),
                updated = table.Column<DateTime>(type: "datetime", nullable: false)
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateTable(
            ...
            {
                contentTypeNodeId = table.Column<int>(type: "int", nullable: false),
                templateNodeId = table.Column<int>(type: "int", nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                ruleValue = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
        ...
        migrationBuilder.CreateTable(
            ...
            {
                userGroupId = table.Column<int>(type: "int", nullable: false),
                app = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false)
            },
            constraints: table =>
            {
                table.PrimaryKey("PK_userGroup2App", x => new { x.userGroupId, x.app });
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                contentTypeId = table.Column<int>(type: "int", nullable: false),
                propertyTypeGroupId = table.Column<int>(type: "int", nullable: true),
                Alias = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                Name = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                sortOrder = table.Column<int>(type: "int", nullable: false, defaultValueSql: "('0')"),
                mandatory = table.Column<bool>(type: "bit", nullable: false, defaultValueSql: "('0')"),
                mandatoryMessage = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                validationRegExp = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                validationRegExpMessage = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                Description = table.Column<string>(type: "nvarchar(2000)", maxLength: 2000, nullable: true),
                labelOnTop = table.Column<bool>(type: "bit", nullable: false, defaultValueSql: "('0')"),
                variations = table.Column<int>(type: "int", nullable: false, defaultValueSql: "('1')"),
                UniqueID = table.Column<Guid>(type: "uniqueidentifier", nullable: false, defaultValueSql: "(newid())")
            },
            constraints: table =>
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                published = table.Column<bool>(type: "bit", nullable: false),
                data = table.Column<string>(type: "ntext", nullable: true),
                rv = table.Column<long>(type: "bigint", nullable: false),
                dataRaw = table.Column<byte[]>(type: "varbinary(max)", nullable: true)
            },
            constraints: table =>
            {
                table.PrimaryKey("PK_cmsContentNu", x => new { x.nodeId, x.published });
        ...
        migrationBuilder.CreateTable(
            ...
            {
                nodeId = table.Column<int>(type: "int", nullable: false),
                Email = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false, defaultValueSql: "('''')"),
                LoginName = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false, defaultValueSql: "('''')"),
                Password = table.Column<string>(type: "nvarchar(1000)", maxLength: 1000, nullable: false, defaultValueSql: "('''')"),
                passwordConfig = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                securityStampToken = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                emailConfirmedDate = table.Column<DateTime>(type: "datetime", nullable: true),
                failedPasswordAttempts = table.Column<int>(type: "int", nullable: true),
                isLockedOut = table.Column<bool>(type: "bit", nullable: true, defaultValueSql: "('0')"),
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                current = table.Column<bool>(type: "bit", nullable: false),
                text = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                preventCleanup = table.Column<bool>(type: "bit", nullable: false, defaultValueSql: "('0')")
            },
            constraints: table =>
            {
                table.PrimaryKey("PK_umbracoContentVersion", x => x.id);
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                MemberGroup = table.Column<int>(type: "int", nullable: false)
            },
            constraints: table =>
            {
                table.PrimaryKey("PK_cmsMember2MemberGroup", x => new { x.Member, x.MemberGroup });
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                name = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: false),
                date = table.Column<DateTime>(type: "datetime", nullable: false),
                availableUserId = table.Column<int>(type: "int", nullable: true)
            },
            constraints: table =>
            {
                table.PrimaryKey("PK_umbracoContentVersionCultureVariation", x => x.id);
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                propertyTypeId = table.Column<int>(type: "int", nullable: false),
                languageId = table.Column<int>(type: "int", nullable: true),
                segment = table.Column<string>(type: "nvarchar(256)", maxLength: 256, nullable: true),
                intValue = table.Column<int>(type: "int", nullable: true),
                decimalValue = table.Column<decimal>(type: "decimal(38,6)", nullable: true),
                dateValue = table.Column<DateTime>(type: "datetime", nullable: true),
                varcharValue = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: true),
                textValue = table.Column<string>(type: "ntext", nullable: true)
            },
            constraints: table =>
            {
        ...
        migrationBuilder.CreateIndex(
            ...
            column: "languageISOCode",
            unique: true,
            filter: "[languageISOCode] IS NOT NULL");
        ...
        migrationBuilder.CreateIndex(
            ...
            columns: new[] { "versionId", "propertyTypeId", "languageId", "segment" },
            unique: true,
            filter: "[languageId] IS NOT NULL AND [segment] IS NOT NULL");
