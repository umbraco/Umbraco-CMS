...
namespace Umbraco.Cms.Persistence.EFCore.Migrations
{
    ...
    [Migration("20220823084205_InitialState")]
    partial class InitialState : Migration
    {

        protected override void BuildTargetModel(ModelBuilder modelBuilder)
        {
            if (base.ActiveProvider.EndsWith("SqlServer"))
            {
                BuildTargetModelSqlServer(modelBuilder);
            }
            else if (base.ActiveProvider.EndsWith("Sqlite"))
            {
                BuildTargetModelSqlite(modelBuilder);
            }

        }

       protected void BuildTargetModelSqlite(ModelBuilder modelBuilder)
        {
...
#pragma warning restore 612, 618
        ...
        /// <inheritdoc />
        protected void BuildTargetModelSqlServer(ModelBuilder modelBuilder)
        {
#pragma warning disable 612, 618
            modelBuilder
