...
export default {
	auth: {
		...
		requiredEmailValidationMessage: 'Please fill out an email',
		requiredUsernameValidationMessage: 'Please fill out a username',
		requiredPasswordValidationMessage: 'Please fill out a password',
