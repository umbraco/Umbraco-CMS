...
/// <summary>
///     Base class for output cache eviction handlers that evict cached pages referencing changed entities
///     via Umbraco's automatic relation types.
/// </summary>
internal abstract class RelationOutputCacheEvictionHandlerBase
{
    ...
    /// </summary>
    protected async Task EvictRelatedPagesAsync(
