...
public class ContentCacheDataModel
{
    ...
    [DataMember(Order = 0)]
    [JsonPropertyName("pd")]
    [JsonConverter(typeof(JsonDictionaryIgnoreCaseStringInternConverter<PropertyData[]>))]
    [MessagePackFormatter(typeof(MessagePackDictionaryIgnoreCaseStringInternFormatter<PropertyData[]>))]
    public Dictionary<string, PropertyData[]>? PropertyData { get; set; }

    [DataMember(Order = 1)]
    [JsonPropertyName("cd")]
    [JsonConverter(typeof(JsonDictionaryIgnoreCaseStringInternConverter<CultureVariation>))]
    [MessagePackFormatter(typeof(MessagePackDictionaryIgnoreCaseStringInternFormatter<CultureVariation>))]
    ...
    [JsonConverter(typeof(JsonDictionaryIgnoreCaseStringConverter<PropertyData[]>))]
    private Dictionary<string, PropertyData[]> LegacyPropertyData { set => PropertyData = value; }

    [IgnoreDataMember]
    [JsonPropertyName("cultureData")]
    [JsonConverter(typeof(JsonDictionaryIgnoreCaseStringConverter<CultureVariation>))]
