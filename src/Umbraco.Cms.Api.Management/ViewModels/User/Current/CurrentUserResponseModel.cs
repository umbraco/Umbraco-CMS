...
public class CurrentUserResponseModel : UserPresentationBase
{
    ...
    /// <summary>
    /// Gets or sets the set of document blueprint start node IDs (as <see cref="ReferenceByIdModel"/>) associated with the current user.
    ...
    /// <summary>
    /// Gets or sets a value indicating whether the current user has access to the document blueprint root.
    /// </summary>
