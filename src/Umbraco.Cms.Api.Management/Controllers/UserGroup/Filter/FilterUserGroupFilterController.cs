...
public class FilterUserGroupFilterController : UserGroupFilterControllerBase
{
    ...
    [EndpointSummary("Gets a filtered collection of usergroups.")]
    [EndpointDescription("Filters usergroups based on the provided criteria with support for pagination.")]
