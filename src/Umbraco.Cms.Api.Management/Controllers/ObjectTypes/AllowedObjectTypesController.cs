...
public class AllowedObjectTypesController : ObjectTypesControllerBase
{
    ...
    [EndpointSummary("Gets a paginated collection of objecttypess.")]
    [EndpointDescription("Gets a paginated collection of objecttypess with support for skip and take pagination.")]
