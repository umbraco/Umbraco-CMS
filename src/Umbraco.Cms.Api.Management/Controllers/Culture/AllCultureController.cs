...
public class AllCultureController : CultureControllerBase
{
    ...
    [EndpointDescription("Returns the total number of cultures setup and also individual details for each culture. Optionally you can paginate the results using skip and take parameters")]
