...
public class RestoreMediaRecycleBinController : MediaRecycleBinControllerBase
{
    ...
    [EndpointSummary("Restores a media from the recycle bin.")]
    [EndpointDescription("Restores a media from the recycle bin to its original location or a specified parent.")]
