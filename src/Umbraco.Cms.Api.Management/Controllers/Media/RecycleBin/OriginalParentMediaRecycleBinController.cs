...
public class OriginalParentMediaRecycleBinController : MediaRecycleBinControllerBase
{
    ...
    [EndpointSummary("Gets the original parent of a media in the recycle bin.")]
    [EndpointDescription("Gets the original parent location of a media before it was moved to the recycle bin.")]
