...
public class AncestorsDataTypeTreeController : DataTypeTreeControllerBase
{
    ...
    [EndpointSummary("Gets a collection of ancestor data type items.")]
    [EndpointDescription("Gets a collection of data type items that are ancestors to the provided Id.")]
