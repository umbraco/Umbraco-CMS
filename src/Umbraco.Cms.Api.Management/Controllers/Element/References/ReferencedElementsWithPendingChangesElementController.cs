...
/// <summary>
/// Controller responsible for retrieving the elements referenced by an element that are not fully published.
/// </summary>
[ApiVersion("1.0")]
public class ReferencedElementsWithPendingChangesElementController : ElementControllerBase
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="ReferencedElementsWithPendingChangesElementController"/> class.
    /// </summary>
    ...
    public ReferencedElementsWithPendingChangesElementController(
    ...
    /// <summary>
    ///     Gets a paged list of the elements directly referenced by an element that are not fully published.
    /// </summary>
    /// <remarks>
    ///     Used to warn editors, when publishing or scheduling an element, that another element it references (via
    ///     an Element Picker property, or as embedded reusable block content) is a draft, has unpublished changes,
    ///     or is scheduled for a future publish.
    /// </remarks>
    /// <param name="cancellationToken">A token to monitor for cancellation requests.</param>
    /// <param name="id">The unique identifier of the element to find referenced elements for.</param>
    ...
    [EndpointSummary("Gets the elements referenced by an element that are not fully published.")]
    [EndpointDescription("Gets a paginated collection of elements directly referenced by the element identified by the provided Id, that are draft, have pending changes, or are scheduled for a future publish.")]
        ...
        int take = 20)
    {
        Attempt<PagedModel<ReferencedElementWithPendingChanges>, GetReferencesOperationStatus> attempt =
            await _referencedElementsService.GetPagedReferencedElementsWithPendingChangesAsync(
                id, UmbracoObjectTypes.Element, skip, take, cancellationToken);
