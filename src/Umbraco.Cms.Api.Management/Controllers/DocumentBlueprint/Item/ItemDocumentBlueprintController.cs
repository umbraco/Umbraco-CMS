...
public class ItemDocumentBlueprintController : DocumentBlueprintItemControllerBase
{
    ...
    [EndpointSummary("Gets a collection of documentblueprint items.")]
    [EndpointDescription("Gets a collection of documentblueprint items identified by the provided Ids.")]
