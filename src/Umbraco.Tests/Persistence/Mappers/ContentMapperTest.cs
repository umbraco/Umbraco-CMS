...
namespace Umbraco.Tests.Persistence.Mappers
{
    ...
    public class ContentMapperTest : MapperTestBase
    {
        ...
        {
            var column = new ContentMapper(MockSqlContext()).Map(nameof(Content.Id));
        ...
        {
            var column = new ContentMapper(MockSqlContext()).Map(nameof(Content.Trashed));
        ...
        {
            var column = new ContentMapper(MockSqlContext()).Map(nameof(Content.Published));
        ...
        {
            var column = new ContentMapper(MockSqlContext()).Map(nameof(Content.VersionId));
