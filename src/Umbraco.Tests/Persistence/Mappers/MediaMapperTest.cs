...
namespace Umbraco.Tests.Persistence.Mappers
{
    ...
    public class MediaMapperTest : MapperTestBase
    {
        ...
        {
            var column = new MediaMapper(MockSqlContext()).Map(nameof(Media.Id));
        ...
        {
            var column = new MediaMapper(MockSqlContext()).Map(nameof(Media.Trashed));
        ...
        {
            var column = new MediaMapper(MockSqlContext()).Map(nameof(Media.UpdateDate));
        ...
        {
            var column = new MediaMapper(MockSqlContext()).Map(nameof(Media.VersionId));
