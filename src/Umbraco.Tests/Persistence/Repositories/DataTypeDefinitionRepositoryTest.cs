...
namespace Umbraco.Tests.Persistence.Repositories
{
    ...
    public class DataTypeDefinitionRepositoryTest : TestWithDatabaseBase
    {
        ...
        {
            return new EntityContainerRepository(scopeAccessor, AppCaches.Disabled, LoggerFactory_.CreateLogger<EntityContainerRepository>(), Constants.ObjectTypes.DataTypeContainer);
        }
        ...
        public void Can_Find_Usages()
        {
            ...
            using (provider.CreateScope())
            {
                ...
                IDataType dataType1 = new DataType(new RadioButtonsPropertyEditor(LoggerFactory_, IOHelper, DataTypeService, LocalizationService, LocalizedTextService, ShortStringHelper)) { Name = "dt1" };
                dtRepo.Save(dataType1);
                IDataType dataType2 = new DataType(new RadioButtonsPropertyEditor(LoggerFactory_, IOHelper, DataTypeService, LocalizationService, LocalizedTextService, ShortStringHelper)) { Name = "dt2" };
        ...
        public void Can_Move()
        {
            ...
            using (provider.CreateScope())
            {
                ...
                var dataType = (IDataType) new DataType(new RadioButtonsPropertyEditor(LoggerFactory_,  IOHelper, DataTypeService, LocalizationService, LocalizedTextService, ShortStringHelper), container2.Id)
                {
                    Name = "dt1"
                };
                ...
                //create a
                var dataType2 = (IDataType)new DataType(new RadioButtonsPropertyEditor(LoggerFactory_, IOHelper, DataTypeService, LocalizationService, LocalizedTextService, ShortStringHelper), dataType.Id)
                {
                    Name = "dt2"
                };
        ...
        public void Can_Create_Container_Containing_Data_Types()
        {
            ...
            using (provider.CreateScope())
            {
                ...
                var dataTypeDefinition = new DataType(new RadioButtonsPropertyEditor(LoggerFactory_, IOHelper, DataTypeService, LocalizationService, LocalizedTextService, ShortStringHelper), container.Id) { Name = "test" };
        ...
        public void Can_Delete_Container_Containing_Data_Types()
        {
            ...
            using (provider.CreateScope())
            {
                ...
                IDataType dataType = new DataType(new RadioButtonsPropertyEditor(LoggerFactory_, IOHelper, DataTypeService, LocalizationService, LocalizedTextService, ShortStringHelper), container.Id) { Name = "test" };
                repository.Save(dataType);
        ...
        public void Can_Create()
        {
            ...
            {
                var repository = CreateRepository();
                IDataType dataType = new DataType(new RadioButtonsPropertyEditor(LoggerFactory_, IOHelper, DataTypeService, LocalizationService, LocalizedTextService, ShortStringHelper)) {Name = "test"};
        ...
        public void Can_Perform_Add_On_DataTypeDefinitionRepository()
        {
            ...
            {
                var repository = CreateRepository();
                var dataTypeDefinition = new DataType(new LabelPropertyEditor(LoggerFactory_, IOHelper, DataTypeService, LocalizedTextService, LocalizationService, ShortStringHelper))
                {
        ...
        public void Can_Perform_Update_On_DataTypeDefinitionRepository()
        {
            ...
            {
                var repository = CreateRepository();
                var dataTypeDefinition = new DataType(new IntegerPropertyEditor(LoggerFactory_, DataTypeService, LocalizationService, ShortStringHelper, LocalizedTextService))
                {
                    DatabaseType = ValueStorageType.Integer,
                    Name = "AgeDataType",
                    CreatorId = 0
                ...
                definition.Editor = new LabelPropertyEditor(LoggerFactory_, IOHelper, DataTypeService, LocalizedTextService, LocalizationService, ShortStringHelper); //change
