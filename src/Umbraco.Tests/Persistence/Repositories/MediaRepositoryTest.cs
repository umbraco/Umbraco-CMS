...
namespace Umbraco.Tests.Persistence.Repositories
{
    ...
    public class MediaRepositoryTest : BaseDatabaseFactoryTest
    {
        ...
        public void Can_Instantiate_Repository()
        {
            ...
            // Act
            var repository = RepositoryResolver.ResolveByType<IMediaRepository>(unitOfWork);
        ...
        public void Can_Perform_Add_On_MediaRepository()
        {
            ...
            var provider = new PetaPocoUnitOfWorkProvider();
            var unitOfWork = provider.GetUnitOfWork();
            var mediaTypeRepository = RepositoryResolver.ResolveByType<IMediaTypeRepository>(unitOfWork);
            var repository = RepositoryResolver.ResolveByType<IMediaRepository>(unitOfWork);
