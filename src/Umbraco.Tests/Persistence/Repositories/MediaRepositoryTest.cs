...
namespace Umbraco.Tests.Persistence.Repositories
{
    ...
    public class MediaRepositoryTest : TestWithDatabaseBase
    {
        ...
        private MediaRepository CreateRepository(IScopeProvider provider, out MediaTypeRepository mediaTypeRepository, AppCaches appCaches = null)
        {
            ...
            var repository = new MediaRepository(scopeAccessor, appCaches, Logger, mediaTypeRepository, tagRepository, Mock.Of<ILanguageRepository>(), relationRepository, relationTypeRepository, propertyEditors, dataValueReferences, ServiceContext.DataTypeService);
            return repository;
        }
