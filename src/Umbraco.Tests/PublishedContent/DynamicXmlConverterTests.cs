...
namespace Umbraco.Tests.PublishedContent
{
    ...
    public class DynamicXmlConverterTests : AbstractPartialTrustFixture<DynamicXmlConverterTests>
    {
        ...
        public void Convert_To_String()
        {
            ...
            Assert.IsTrue(result.Success);
            Assert.AreEqual(strippedXml, result.Result);
        }
        ...
        public void Convert_To_XElement()
        {
            ...
            Assert.IsTrue(result.Success);
            Assert.AreEqual(strippedXml, result.Result.ToString(SaveOptions.DisableFormatting));
        }
        ...
        public void Convert_To_XmlElement()
        {
            ...
            Assert.IsTrue(result.Success);
            Assert.AreEqual(strippedXml, result.Result.OuterXml);
        }
        ...
        public void Convert_To_XmlDocument()
        {
            ...
            Assert.IsTrue(result.Success);
            Assert.AreEqual(strippedXml, result.Result.InnerXml);
        }
