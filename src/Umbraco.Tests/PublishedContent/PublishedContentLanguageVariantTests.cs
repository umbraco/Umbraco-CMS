    ...
    public class PublishedContentLanguageVariantTests : PublishedContentSnapshotTestBase
    {
        ...
        private static void MockLocalizationService(ServiceContext serviceContext)
        {
            ...
            var languages = new List<Language>
                {
                    new Language("en-US", "English (United States)") { Id = 1, IsDefault = true },
                    new Language("fr", "French") { Id = 2 },
                    new Language("es", "Spanish") { Id = 3, FallbackLanguageId = 1 },
                    new Language("it", "Italian") { Id = 4, FallbackLanguageId = 3 },
                    new Language("de", "German") { Id = 5 },
