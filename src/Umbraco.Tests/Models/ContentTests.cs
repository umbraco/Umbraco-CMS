...
namespace Umbraco.Tests.Models
{
    ...
    public class ContentTests : UmbracoTestBase
    {
        ...
        public override void SetUp()
        {
            ...
            _contentPublishingService = new ContentPublishingService(contentTypeServiceMock.Object);
        }
        ...
        public void Variant_Published_Culture_Names_Track_Dirty_Changes()
        {
            ...
            Thread.Sleep(500);                                          //The "Date" wont be dirty if the test runs too fast since it will be the same date
            content.SetCultureName("name-fr", langFr);
            _contentPublishingService.PublishCulture(content, langFr);                             //we've set the name, now we're publishing it
        ...
        public void Can_Deep_Clone()
        {
            ...
            _contentPublishingService.PublishCulture(content, "en-US");
        ...
        public void Remember_Dirty_Properties()
        {
            ...
            Assert.IsTrue(content.WasPropertyDirty(nameof(Content.ExpireDate)));
            ...
            Assert.IsTrue(content.WasPropertyDirty(nameof(Content.ReleaseDate)));
