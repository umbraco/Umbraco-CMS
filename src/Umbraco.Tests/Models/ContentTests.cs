...
namespace Umbraco.Tests.Models
{
    ...
    public class ContentTests : UmbracoTestBase
    {
        ...
        protected override void Compose()
        {
            ...
            var editor = new TextboxPropertyEditor(Mock.Of<ILogger>(), Mock.Of<IDataTypeService>(), Mock.Of<ILocalizationService>(), TestHelper.IOHelper, TestHelper.ShortStringHelper) { Alias = "test" };
