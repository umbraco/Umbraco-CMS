...
namespace Umbraco.Tests.Configurations.UmbracoSettings
{
    ...
    public class ScriptingElementTests : UmbracoSettingsTests
    {
        ...
        public virtual void DataTypeModelStaticMappings()
        {
            ...
            Assert.IsTrue(mappings[1].PropertyTypeAlias == "textPage2");
            ...
            Assert.IsTrue(mappings[2].PropertyTypeAlias == "textPage3");
            ...
            Assert.IsTrue(mappings[3].PropertyTypeAlias == "textPage4");
