...
namespace Umbraco.Tests.BusinessLogic
{
    ...
    /// </remarks>
    [TestFixture]
    public class cms_businesslogic_Template_Tests : BaseDatabaseFactoryTestWithContext
    {
        #region Tests
        ...
        public void _2nd_a_Test_Template_Constructor_By_Guid_Id()
        {
       ...
       // const int TEST_ITEMS_MAX_COUNT = 7;
        ...
        private TemplateDto _template1; // master
        private TemplateDto _template2;
        private TemplateDto _template3;
        private TemplateDto _template4;
        private TemplateDto _template5;
        ...
        private void EnsureAll_Template_TestRecordsAreDeleted()
        {
