    ...
    public class ContentModelValidatorTests : UmbracoTestBase
    {
        ...
        public override void SetUp()
        {
            ...
            _contentType.AddPropertyType(
                new PropertyType(ShortStringHelper, "complexTest", ValueStorageType.Ntext) { Alias = "complex", Name = "Complex", Description = "", Mandatory = false, SortOrder = 1, DataTypeId = ComplexDataTypeId },
                "Content");
