...
{
    [TestFixture]
    public class ManifestContentAppTests : UmbracoTestBase

    {
        ...
        public void Setup()
        {
            ...
            var serviceContext = new ServiceContext(
                ...
                contentTypeService: _contentTypeServiceMock.Object);
        ...
        public void Test()
        {
            ...
            Mock.Get(content).Setup(x => x.ContentTypeId).Returns(contentType.Id);
