...
namespace Umbraco.Tests.TestHelpers.Entities
{
    public class MockedContentTypes
    {
        ...
        public static ContentType CreateAllTypesContentType(string alias, string name)
        {
            ...
            contentCollection.Add(new PropertyType(Constants.PropertyEditors.Aliases.DateTime, ValueStorageType.Date) { Alias = "date", Name = "Date", Mandatory = false, SortOrder = 13, DataTypeId = -41 });
