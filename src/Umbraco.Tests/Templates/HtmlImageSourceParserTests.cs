...
<p>
    <div><img src=""/media/1001/my-image.jpg?width=100"" data-udi=""umb://media/81BB2036-034F-418B-B61F-C7160D68DCD4"" /></div>
        ...
        [TestCase(
            @"<div><img src=""?width=100"" width=""100"" data-udi=""umb://media/81BB2036034F418BB61FC7160D68DCD4""/></div>",
            ExpectedResult = @"<div><img src=""/media/1001/image.jpg?type=mock&width=100&mode=max"" width=""100"" data-udi=""umb://media/81BB2036034F418BB61FC7160D68DCD4""/></div>",
            TestName = "Empty source is updated with data-udi set"
        )]
        [TestCase(
            @"<div><img src=""non empty src"" data-udi=""umb://media/81BB2036034F418BB61FC7160D68DCD4""/></div>",
        ...
        [TestCase(
            @"<div><img src=""non empty src?height=100"" height=""100"" data-udi=""umb://media/81BB2036034F418BB61FC7160D68DCD4""/></div>",
            ExpectedResult = @"<div><img src=""/media/1001/image.jpg?type=mock&height=100&mode=max"" height=""100"" data-udi=""umb://media/81BB2036034F418BB61FC7160D68DCD4""/></div>",
            TestName = "Filled source is overwritten with data-udi set"
        )]
        [TestCase(
            @"<div><img src=""some src"" some-attribute data-udi=""umb://media/81BB2036034F418BB61FC7160D68DCD4"" another-attribute/></div>",
        ...
        [TestCase(
            @"<div>
                <img src="""" data-udi=""umb://media/81BB2036034F418BB61FC7160D68DCD4""/>
                <img src=""src"" data-udi=""umb://media/81BB2036034F418BB61FC7160D68DCD5""/>
                <img src="""" data-mode=""test"" data-udi=""umb://media/81BB2036034F418BB61FC7160D68DCD5""/>
                <img src=""?asd"" data-udi=""umb://media/81BB2036034F418BB61FC7160D68DCD6""/>
                <img src=""?width=100&height=100.33&mode=max"" width=""100"" height=""100.33"" data-udi=""umb://media/81BB2036034F418BB61FC7160D68DCD6""/>
              </div>",
            ExpectedResult =
            @"<div>
                <img src=""/media/1001/image.jpg"" data-udi=""umb://media/81BB2036034F418BB61FC7160D68DCD4""/>
                <img src=""/media/1001/image.jpg"" data-udi=""umb://media/81BB2036034F418BB61FC7160D68DCD5""/>
                <img src=""/media/1001/image.jpg?type=mock&mode=test"" data-mode=""test"" data-udi=""umb://media/81BB2036034F418BB61FC7160D68DCD5""/>
                <img src=""/media/1001/image.jpg?asd"" data-udi=""umb://media/81BB2036034F418BB61FC7160D68DCD6""/>
                <img src=""/media/1001/image.jpg?type=mock&width=100&height=100&mode=max"" width=""100"" height=""100.33"" data-udi=""umb://media/81BB2036034F418BB61FC7160D68DCD6""/>
              </div>",
            TestName = "Multiple img tags are handled"
        )]
        [Category("Ensure image sources")]
        [Test]
        public string Ensure_ImageSources_Processing_With_IImageUrlGenerator(string sourceHtml)
        {
            var fakeMediaUrl = "/media/1001/image.jpg";
            ...
            imageUrlGenerator.Setup(x => x.GetImageUrl(It.IsAny<ImageUrlGenerationOptions>()))
                .Returns((ImageUrlGenerationOptions o) =>
                {
                    var builder = new StringBuilder(o.ImageUrl).Append("?type=mock");
                    if (o.Width != null)
                    {
                        builder.Append($"&width={o.Width}");
                    }

                    if (o.Height != null)
                    {
                        builder.Append($"&height={o.Height}");
                    }

                    if (o.ImageCropMode != null)
                    {
                        builder.Append($"&mode={o.ImageCropMode}");
                    }

                    return builder.ToString();
                });
            var parser = new HtmlImageSourceParser((guid) => fakeMediaUrl, imageUrlGenerator.Object);
            var actual = parser.EnsureImageSources(sourceHtml);
