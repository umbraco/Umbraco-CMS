...
namespace Umbraco.Tests.Services
{
    ...
    public class ContentTypeServiceVariantsTests : TestWithSomeContentBase
    {
        ...
        public void Change_Variations_SimpleContentType_VariantToInvariantAndBack()
        {
            ...
            Assert.AreEqual("v2", document.GetValue("value2"));
            Assert.AreEqual(contentType.Id,document.ContentTypeId);
            Assert.IsFalse(contentType.PropertyTypes.First(x => x.Alias == "value1").VariesByCulture());
            ...
            Assert.AreEqual("v2", document.GetValue("value2"));
            Assert.AreEqual(contentType.Id,document.ContentTypeId);
            Assert.IsTrue(contentType.PropertyTypes.First(x => x.Alias == "value1").VariesByCulture());
        ...
        public void Change_Variations_SimpleContentType_VariantPropertyToInvariantAndBack()
        {
            ...
            Assert.AreEqual(contentType.Id,document.ContentTypeId);
            Assert.IsTrue(contentType.PropertyTypes.First(x => x.Alias == "value2").VariesByCulture());
