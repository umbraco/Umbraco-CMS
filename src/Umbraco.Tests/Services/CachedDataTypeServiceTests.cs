...
namespace Umbraco.Tests.Services
{
    ...
    public class CachedDataTypeServiceTests : TestWithSomeContentBase
    {
        ...
        public void DataTypeService_Can_Get_All()
        {
            ...
            IDataType dataType = new DataType(new LabelPropertyEditor(LoggerFactory_, IOHelper, DataTypeService,LocalizedTextService, LocalizationService, ShortStringHelper)) { Name = "Testing Textfield", DatabaseType = ValueStorageType.Ntext };
