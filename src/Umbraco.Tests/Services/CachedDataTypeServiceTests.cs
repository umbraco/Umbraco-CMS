...
namespace Umbraco.Tests.Services
{
    ...
    public class CachedDataTypeServiceTests : TestWithSomeContentBase
    {
        ...
        public void DataTypeService_Can_Get_All()
        {
            ...
            IDataType dataType = new DataType(new LabelPropertyEditor(Logger, IOHelper, DataTypeService, LocalizationService, ShortStringHelper)) { Name = "Testing Textfield", DatabaseType = ValueStorageType.Ntext };
