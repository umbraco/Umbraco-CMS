...
namespace Umbraco.Tests.Services
{
    ...
    public class ContentServiceTests : TestWithSomeContentBase
    {
        ...
        public void Moving_Node_To_Recycle_Bin_With_Invalid_Path()
        {
            ...
            {
                ServiceContext.ContentPublishingService.PublishCulture(c);
        ...
        public void Can_Unpublish_Content_Variation()
        {
            ...
            ServiceContext.ContentPublishingService.PublishCulture(content,langUk.IsoCode);
        ...
        private void ContentServiceOnPublishing(IContentService sender, PublishEventArgs<NotificationData> args)
        {
            Assert.AreEqual(1, args.PublishedEntities.Count());
            var entity = args.PublishedEntities.First();
            Assert.AreEqual("foo", entity.Content.Name);

            var e = ServiceContext.ContentService.GetById(entity.Content.Id);
        ...
        public void Can_Publish_Only_Valid_Content()
        {
            ...
            var contentCanPublishValues = ServiceContext.ContentPublishingService.PublishCulture(content);
