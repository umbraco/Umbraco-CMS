...
using UserServiceImpl = Umbraco.Core.Services.Implement.UserService;
...
namespace Umbraco.Tests.Services
{
    ...
    public class UserServiceTests : TestWithSomeContentBase
    {
        ...
        public void Calculate_Permissions_For_User_For_Path()
        {
            ...
            var result = UserServiceImpl.CalculatePermissionsForPathForUser(permissions, pathIds);
            ...
            result = UserServiceImpl.CalculatePermissionsForPathForUser(permissions, pathIds.Skip(1).ToArray());
            ...
            result = UserServiceImpl.CalculatePermissionsForPathForUser(permissions, pathIds.Skip(2).ToArray());
            ...
            result = UserServiceImpl.CalculatePermissionsForPathForUser(permissions, pathIds.Skip(3).ToArray());
        ...
        public void Determine_Deepest_Explicit_Permissions_For_Group_For_Path_1()
        {
            ...
            var result = UserServiceImpl.GetPermissionsForPathForGroup(permissions, pathIds, fallbackToDefaultPermissions: true);
        ...
        public void Determine_Deepest_Explicit_Permissions_For_Group_For_Path_2()
        {
            ...
            var result = UserServiceImpl.GetPermissionsForPathForGroup(permissions, pathIds, fallbackToDefaultPermissions: false);
