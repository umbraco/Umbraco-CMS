...
namespace Umbraco.Tests.Services
{
    ...
    public class DataTypeServiceTests : TestWithSomeContentBase
    {
        ...
        public void Cannot_Save_DataType_With_Empty_Name()
        {
            ...
            // Act
            var dataTypeDefinition = new DataType(new LabelPropertyEditor(Logger, IOHelper, DataTypeService, LocalizationService, ShortStringHelper)) { Name = string.Empty, DatabaseType = ValueStorageType.Ntext };
