...
internal class ColumnInSchemaDto
{
    ...
    [Column("COLUMN_DEFAULT")] public string ColumnDefault { get; set; } = null!;

    [Column("IS_NULLABLE")] public string IsNullable { get; set; } = null!;

    [Column("DATA_TYPE")] public string DataType { get; set; } = null!;
}
