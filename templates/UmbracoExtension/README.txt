...
== Steps ==
* Open a terminal inside the `\UmbracoExtension` folder
...
* From the `\UmbracoExtension` folder run the command `npm run watch` this will monitor the changes to the *.ts files and rebuild the project
