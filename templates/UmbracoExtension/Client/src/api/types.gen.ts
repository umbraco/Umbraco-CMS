...
export type GetUmbracoExampleApiV1PingResponse = (string);

export type GetUmbracoExampleApiV1PingError = (unknown);

export type GetUmbracoExampleApiV1WhatsMyNameResponse = (string);

export type GetUmbracoExampleApiV1WhatsMyNameError = (unknown);

export type GetUmbracoExampleApiV1WhatsTheTimeMrWolfResponse = (string);

export type GetUmbracoExampleApiV1WhatsTheTimeMrWolfError = (unknown);

export type GetUmbracoExampleApiV1WhoAmIResponse = ((UserModel));

export type GetUmbracoExampleApiV1WhoAmIError = (unknown);