...
<li id="<%=this.FullId%>" onMouseDown="activeDragId = this.id;">
	<div class="propertyForm" id="<%=this.FullId%>_form">
			...
			<a href="javascript:expandCollapse('<%=this.ClientID%>');"><img src="<%=umbraco.GlobalSettings.Path%>/images/expand.png" style="FLOAT: right"/>
			...
			<h3 style="padding: 0px; margin: 0px;">
			  ...
			  <a href="javascript:expandCollapse('<%=this.ClientID%>');"><img src="<%=umbraco.GlobalSettings.Path%>/images/collapse.png" id="<%=this.ClientID%>_fold" style="FLOAT: right">
