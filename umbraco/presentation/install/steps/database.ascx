...
<asp:Panel ID="settings" runat="server" Visible="true">
    ...
    <div runat="server" id="div_info" class="notice">
        <p>
            ...
            Please contact your ISP if necessary. If you're installing on a local machine or
            server you might need information from your system administrator.</p>
        <p>
            <strong>If you do not have any database available</strong>, you can choose the embedded
            database which does not require any information from your ISP or system administrators,
            and will install right away.
        </p>
    </div>
    <p runat="server" id="DatabaseError" class="errormessage">
    </p>
            <asp:PlaceHolder ID="sqlCeNotice" runat="server" Visible="false">
                <div class="error">
                    <p>
    ...
    <ol class="form">
        <li runat="server" id="DatabaseTypeItem">
            ...
            <asp:DropDownList runat="server" ID="DatabaseType" CssClass="textfield" AutoPostBack="True"
                OnSelectedIndexChanged="DatabaseType_SelectedIndexChanged">
    ...
    <p>
        <asp:Button runat="server" ID="DatabaseConnectButton" Text="Confirm" OnClick="DatabaseConnectButton_Click"
            OnClientClick="showProgress(this,'loadingBar'); return true;" />
    </p>
</asp:Panel>
<asp:Panel ID="identify" runat="server" Visible="false">
    <h2>
        ...
        <asp:PlaceHolder ID="dbUpgrade" runat="server">
            <asp:Literal ID="version" runat="server"></asp:Literal></asp:PlaceHolder>
    </h2>
  ...
  <div class="success"><p>Your current database is up-to-date!. Click <strong>next</strong> to continue the configuration wizard</p></div>
    ...
    <asp:PlaceHolder ID="other" runat="server" Visible="False">
        <div class="notice">
            <p>
                Press the <strong>upgrade</strong> button to upgrade your database to Umbraco
    ...
    <asp:PlaceHolder ID="installConfirm" runat="server" Visible="False">
        <div class="success">
            <p>
                Umbraco
                <%=umbraco.GlobalSettings.CurrentVersion%>
                has now been copied to your database. Press <b>Next</b> to proceed.</p>
        </div>
    </asp:PlaceHolder>
