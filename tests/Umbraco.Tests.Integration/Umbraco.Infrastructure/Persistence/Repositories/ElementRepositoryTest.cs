...
public class ElementRepositoryTest : UmbracoIntegrationTest
{
    ...
    public async Task Retrieval_By_Key_After_Retrieval_By_Id_Is_Cached()
    {
        ...
        var element = await CreateElementAsync(repository, contentTypeRepository);
    ...
    private static async Task<Element> CreateElementAsync(ElementRepository repository, ContentTypeRepository contentTypeRepository)
    {
