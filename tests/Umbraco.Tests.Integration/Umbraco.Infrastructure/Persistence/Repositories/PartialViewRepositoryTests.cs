...
public class PartialViewRepositoryTests : UmbracoIntegrationTest
{
    ...
    public void PathTests()
    {
        ...
        var fileSystems = FileSystemsCreator.CreateTestFileSystems(LoggerFactory, IOHelper,
        ...
        using (var scope = provider.CreateScope())
        {
            ...
            Assert.AreEqual("path-2\\test-path-2.cshtml".Replace("\\", $"{Path.DirectorySeparatorChar}"),
                partialView.Path);
