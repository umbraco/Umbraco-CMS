...
internal sealed class MediaTypeServiceTests : UmbracoIntegrationTest
{
    ...
    public async Task Can_Copy_MediaType_By_Performing_Clone()
    {
        ...
        Assert.That(
            ...
            Is.Not.EqualTo(mediaType.PropertyTypes.First(x => x.Alias.Equals("umbracoFile")).Id));
        Assert.That(
            sut.PropertyGroups.First(x => x.Name.Equals("Media")).Id,
            Is.Not.EqualTo(mediaType.PropertyGroups.First(x => x.Name.Equals("Media")).Id));
    }
    ...
    public async Task Can_Copy_MediaType_To_New_Parent_By_Performing_Clone()
    {
        ...
        Assert.That(
            ...
            Is.Not.EqualTo(clonedMediaType.PropertyTypes.First(x => x.Alias.StartsWith("umbracoFile")).Id));
        Assert.That(
            originalMediaType.PropertyGroups.First(x => x.Name.StartsWith("Media")).Id,
            Is.Not.EqualTo(clonedMediaType.PropertyGroups.First(x => x.Name.StartsWith("Media")).Id));
    }
