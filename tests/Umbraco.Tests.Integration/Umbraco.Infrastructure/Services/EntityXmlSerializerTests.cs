...
internal sealed class EntityXmlSerializerTests : UmbracoIntegrationTest
{
    ...
    public async Task Can_Generate_Xml_Representation_Of_Content()
    {
        ...
        Assert.That((string)element.Attribute("isDoc"), Is.Empty);
        ...
        Assert.That((string)element.Attribute("templateAlias"), Is.EqualTo(template.Alias));
        ...
        Assert.That(
            ...
            Is.EqualTo(content.Properties["bodyText"].GetValue().ToString()));
        Assert.That(
            element.Elements("keywords").Single().Value,
            Is.EqualTo(content.Properties["keywords"].GetValue().ToString()));
        Assert.That(
            element.Elements("description").Single().Value,
            Is.EqualTo(content.Properties["description"].GetValue().ToString()));
    }
    ...
    public async Task Can_Generate_Xml_Representation_Of_Media()
    {
        ...
        Assert.That(
            ...
            Is.EqualTo(media.Properties[Constants.Conventions.Media.File].GetValue().ToString()));
        Assert.That(
            element.Elements(Constants.Conventions.Media.Width).Single().Value,
            Is.EqualTo(media.Properties[Constants.Conventions.Media.Width].GetValue().ToString()));
        Assert.That(
            element.Elements(Constants.Conventions.Media.Height).Single().Value,
            Is.EqualTo(media.Properties[Constants.Conventions.Media.Height].GetValue().ToString()));
        Assert.That(
            element.Elements(Constants.Conventions.Media.Bytes).Single().Value,
            Is.EqualTo(media.Properties[Constants.Conventions.Media.Bytes].GetValue().ToString()));
        Assert.That(
            element.Elements(Constants.Conventions.Media.Extension).Single().Value,
            Is.EqualTo(media.Properties[Constants.Conventions.Media.Extension].GetValue().ToString()));
    }
