...
internal sealed partial class ContentTypeServiceTests
{
    ...
    public async Task GetAllAllowedInLibrary_Threads_ParentKey_To_Filter()
    {
        ...
        Assert.That(ContentTypeFilterCapturingParentKey.WasCalled, Is.True);
        Assert.That(ContentTypeFilterCapturingParentKey.LastParentKey, Is.EqualTo(parentKey));
    }
    ...
    public async Task GetAllAllowedInLibrary_Threads_Null_ParentKey_At_Root_To_Filter()
    {
        ...
        Assert.That(ContentTypeFilterCapturingParentKey.WasCalled, Is.True);
        Assert.That(ContentTypeFilterCapturingParentKey.LastParentKey, Is.Null);
    }
