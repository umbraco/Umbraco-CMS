...
namespace Umbraco.Cms.Tests.Integration.Umbraco.Infrastructure.Services
{
    ...
    public class ContentEventsTests : UmbracoIntegrationTestWithContent
    {
        ...
        public void PublishContentBranchWithPublishedChildren()
        {
            ...
            // branch is:
            ResetEvents();
            ContentService.SaveAndPublishBranch(content1, PublishBranchForceOptions.None); // forceOptions = None: don't publish unpublished items
...
#pragma warning restore SA1003 // Symbols should be spaced correctly
        ...
        public void PublishContentBranchWithAllChildren()
        {
            ...
            ResetEvents();
            ContentService.SaveAndPublishBranch(content1, PublishBranchForceOptions.PublishUnpublished); // forceOptions = PublishUnpublished: also publish unpublished items
