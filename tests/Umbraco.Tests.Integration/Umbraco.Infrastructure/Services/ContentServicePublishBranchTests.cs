...
public class ContentServicePublishBranchTests : UmbracoIntegrationTest
{
    ...
    public void Can_Publish_Invariant_Branch(int method)
    {
        ...
        var r = PublishInvariantBranch(iRoot, false, false, method).ToArray();
        ...
        // !force = publishes those that are actually published, and have changes
        // here: nothing
        r = PublishInvariantBranch(iRoot, false, false, method).ToArray();
        ...
        r = PublishInvariantBranch(iRoot, true, false, method).ToArray();
        AssertPublishResults(
            r,
            x => x.Content.Name,
            "iroot",
    ...
    public void Can_Publish_Variant_Branch_When_No_Changes_On_Root_All_Cultures()
    {
        ...
        var r = ContentService.PublishBranch(vRoot, false, false, vRoot.AvailableCultures.ToArray())
    ...
    public void Can_Publish_Variant_Branch_When_No_Changes_On_Root_Specific_Culture()
    {
        ...
        var r = ContentService.PublishBranch(vRoot, false, false, ["de"]).ToArray();
        Assert.AreEqual(PublishResultType.SuccessPublishAlready, r[0].Result);
        Assert.AreEqual(PublishResultType.SuccessPublishCulture, r[1].Result);
    }
    ...
    public void Can_Publish_Variant_Branch()
    {
        ...
        // !force = publishes those that are actually published, and have changes
        // here: nothing
        var r = ContentService.PublishBranch(vRoot, false, false, ["*"]).ToArray(); // no culture specified = all cultures
        ...
        r = ContentService.PublishBranch(vRoot, false, false, ["de"]).ToArray();
    ...
    public void Can_Publish_Mixed_Branch_1()
    {
        ...
        var r = ContentService.PublishBranch(iRoot, false, false, ["de"]).ToArray();
    ...
    public void Can_Publish_MixedBranch_2()
    {
        ...
        var r = ContentService.PublishBranch(iRoot, false, false, ["de", "ru"]).ToArray();
        AssertPublishResults(r, x => x.Content.Name, "iroot", "ii1", "iv11.de");
        AssertPublishResults(
            r,
            x => x.Result,
    ...
    public void Can_Publish_Invariant_Branch_With_Force_Options(bool forceUnpublished, bool forceRepublish)
    {
        ...
        var result = ContentService.PublishBranch(iRoot, forceUnpublished, forceRepublish, ["*"]).ToArray();
    ...
    public void Can_Publish_Variant_Branch_With_Force_Options(string culture, bool forceUnpublished, bool forceRepublish)
    {
        ...
        var result = ContentService.PublishBranch(vRoot, forceUnpublished, forceRepublish, cultures).ToArray();
    ...
    private IEnumerable<PublishResult> PublishInvariantBranch(IContent content, bool forceUnpublish, bool forceRepublish, int method)
    {
        ...
        {
            case 1:
                return ContentService.PublishBranch(content, forceUnpublish, forceRepublish, content.AvailableCultures.ToArray());
            case 2:
                return ContentService.PublishBranch(content, forceUnpublish, forceRepublish, cultures: ["*"]);
            case 3:
                return ContentService.PublishBranch(content, forceUnpublish, forceRepublish, cultures: Array.Empty<string>());
            default:
