...
internal sealed class ContentTypeServiceVariantsTests : UmbracoIntegrationTest
{
        ...
        ContentVariation changeContentTypeVariationTo)
    {
        ...
        Assert.That(doc.Edited, Is.True);
        Assert.That(
            doc.IsCultureEdited("en-US"),
            Is.True); // this is true because the name change is copied to the default language
        ...
        ContentVariation variant, ContentVariation invariant)
    {
        ...
        Assert.That(
            document.IsCultureEdited(
                "en"),
            Is.True); // This will be true because the edited value isn't the same as the published value
        Assert.That(
            document.IsCultureEdited(
                "fr"),
            Is.True); // This will be true because the edited value isn't the same as the published value
        ...
        Assert.That(
            document.IsCultureEdited(
                "en"),
            Is.True); // This will remain true because there is now a pending change for the invariant property data which is flagged under the default lang
        Assert.That(
            document.IsCultureEdited(
                "fr"),
            Is.False); // This will be false because nothing has changed for this culture and the property no longer reflects variant changes
        Assert.That(document.Edited, Is.True);
        ...
        Assert.That(
            document.IsCultureEdited(
                "en"),
            Is.False); // The invariant published AND edited values are copied over to the default language
        Assert.That(
            document.IsCultureEdited(
                "fr"),
            Is.True); // The previously existing french values are there and there is no published value
        ...
        Assert.That(
            document.IsCultureEdited("en"),
            Is.False); // This returns false, the variant property value has been published
        Assert.That(
            document.IsCultureEdited("fr"),
            Is.False); // This returns false, the variant property value has been published
        Assert.That(document.Edited, Is.False);
    }
        ...
        ContentVariation invariant, ContentVariation variant)
    {
        ...
        Assert.That(
            document.IsCultureEdited(
                "en"),
            Is.True); // This is true because the invariant property reflects changes on the default lang
        Assert.That(document.IsCultureEdited("fr"), Is.False);
        Assert.That(document.Edited, Is.True);
        ...
        Assert.That(document.GetValue("value1", published: true), Is.Null); // The values are there but the business logic returns null
        Assert.That(document.GetValue("value1", "en"), Is.EqualTo("v1en2"));
        ...
        Assert.That(
            document.IsCultureEdited("en"),
            Is.False); // The variant published AND edited values are copied over to the invariant
        Assert.That(document.IsCultureEdited("fr"), Is.False);
        Assert.That(document.Edited, Is.False);
    }
