...
public partial class ContentPublishingServiceTests
{
    ...
    {
        var result = await ContentPublishingService.PublishBranchAsync(Textpage.Key, _allCultures, force ? PublishBranchForceOptions.PublishUnpublished : PublishBranchForceOptions.None, Constants.Security.SuperUserKey);
    ...
    public async Task Can_Publish_Branch_Beneath_Root()
    {
        ...
        VerifyIsNotPublished(Subpage2.Key);
        var result = await ContentPublishingService.PublishBranchAsync(Subpage2.Key, _allCultures, PublishBranchForceOptions.PublishUnpublished, Constants.Security.SuperUserKey);
    ...
    public async Task Can_Publish_Branch_Of_Variant_Content()
    {
        ...
        var result = await ContentPublishingService.PublishBranchAsync(root.Key, new[] { langEn.IsoCode, langDa.IsoCode }, PublishBranchForceOptions.PublishUnpublished, Constants.Security.SuperUserKey);
        Assert.IsTrue(result.Success);
    ...
    public async Task Can_Publish_Culture_Branch_With_Other_Culture_Invalid()
    {
        ...
        var result = await ContentPublishingService.PublishBranchAsync(root.Key, new[] { langEn.IsoCode }, PublishBranchForceOptions.PublishUnpublished, Constants.Security.SuperUserKey);
        Assert.IsTrue(result.Success);
        AssertBranchResultSuccess(result.Result, root.Key, child.Key);
    ...
    public async Task Cannot_Publish_Branch_Of_Non_Existing_Content()
    {
        ...
        var result = await ContentPublishingService.PublishBranchAsync(key, _allCultures, PublishBranchForceOptions.PublishUnpublished, Constants.Security.SuperUserKey);
    ...
    public async Task Cannot_Publish_Branch_With_Invalid_Parent()
    {
        ...
        var result = await ContentPublishingService.PublishBranchAsync(Textpage.Key, _allCultures, PublishBranchForceOptions.PublishUnpublished, Constants.Security.SuperUserKey);
    ...
    public async Task Cannot_Republish_Branch_After_Adding_Mandatory_Property()
    {
        ...
        result = await ContentPublishingService.PublishBranchAsync(Textpage.Key, _allCultures, PublishBranchForceOptions.PublishUnpublished, Constants.Security.SuperUserKey);
        Assert.IsFalse(result.Success);
