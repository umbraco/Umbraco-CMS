    ...
    public async Task Can_Combine_Element_Level_Segment_Variation_With_Document_Level_Language_Variation(string culture, string? segment)
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(
                ...
                Is.EqualTo(segment is null ? $"This is the default segment content text for {culture}" : $"This is the {segment} segment content text for {culture}"));
        });
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(
                variantProperty.GetValue(),
                Is.EqualTo(segment is null ? $"This is the default segment settings text for {culture}" : $"This is the {segment} segment settings text for {culture}"));
        });
    }
}
