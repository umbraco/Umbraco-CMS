...
public class TestDbMeta
{
    ...
    public static TestDbMeta
        CreateWithMasterConnectionString(string name, bool isEmpty, string masterConnectionString) =>
        new(name, isEmpty, ConstructConnectionString(masterConnectionString, name), Constants.ProviderName, null);
