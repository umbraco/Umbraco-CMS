...
using UmbracoBuilderExtensions = Umbraco.Cms.Persistence.SqlServer.UmbracoBuilderExtensions;

namespace Umbraco.Cms.Tests.Integration.Testing;

/// <summary>
/// Allows using all Umbraco services without a webserver host.
/// Make sure to call BuildAndStartHost() in a [OneTimeSetUp] or [SetUp] method and StopHost() plus ExecuteTearDownQueue() in a [OneTimeTearDown] or [TearDown] method,
/// or use the UmbracoIntegrationTest base class which initializes Umbraco for each individual test.
/// </summary>
public abstract class UmbracoIntegrationFixtureBase : UmbracoIntegrationTestBase
{
    private IHost _host;
    ...
    /// <summary>
    /// Intended to be called from a test fixture [SetUp] or a setup fixture [OneTimeSetUp]
    /// </summary>
    protected void BuildAndStartHost()
    {
    ...
    protected void ConfigureServices(IServiceCollection services)
    {
        ...
        Persistence.Sqlite.UmbracoBuilderExtensions.AddUmbracoSqliteSupport(UmbracoBuilderExtensions.AddUmbracoSqlServerSupport(builder.AddConfiguration()
                .AddUmbracoCore()
                .AddWebComponents()
