...
// A minimal in-memory IIndexer/ISearcher used to give the back-office search services a working,
// synchronously-populated index within integration tests (no Examine/Lucene required).
