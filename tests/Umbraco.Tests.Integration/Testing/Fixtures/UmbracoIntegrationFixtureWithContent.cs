...
/// <summary>
///     Fixture-agnostic integration test with pre-built content.
///     Unlike <see cref="UmbracoIntegrationTestWithContent"/>, this class does NOT use NUnit lifecycle attributes.
///     Call <see cref="UmbracoIntegrationFixture.BuildAndStartHost"/> then <see cref="CreateTestData"/> to set up content.
/// </summary>
public abstract class UmbracoIntegrationFixtureWithContent : UmbracoIntegrationFixture
{
    ...
    /// <summary>
    ///     Creates the default test content structure. Call after <see cref="UmbracoIntegrationFixture.BuildAndStartHost"/>.
    /// </summary>
