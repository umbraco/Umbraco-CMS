...
/// <summary>
///     Fixture-agnostic integration test with pre-built content using the modern editing API.
///     Unlike <see cref="UmbracoIntegrationTestWithContentEditing"/>, this class does NOT use NUnit lifecycle attributes.
///     Call <see cref="UmbracoIntegrationFixture.BuildAndStartHost"/> then <see cref="CreateTestDataAsync"/> to set up content.
/// </summary>
public abstract class UmbracoIntegrationFixtureWithContentEditing : UmbracoIntegrationFixture
{
    ...
    /// <summary>
    ///     Creates the default test content structure using modern editing APIs.
    ///     Call after <see cref="UmbracoIntegrationFixture.BuildAndStartHost"/>.
    /// </summary>
    /// <remarks>
    ///     This is an async Task method (unlike the original which was async void).
    /// </remarks>
    public async Task CreateTestDataAsync()
    {
        ...
        ContentTypeUpdateModel = ContentTypeUpdateHelper.CreateContentTypeUpdateModel(contentTypeResult);
