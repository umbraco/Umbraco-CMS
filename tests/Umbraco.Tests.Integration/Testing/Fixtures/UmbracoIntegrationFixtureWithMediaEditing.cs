...
/// <summary>
///     Fixture-agnostic integration test with pre-built media library.
///     Unlike <see cref="UmbracoIntegrationTestWithMediaEditing"/>, this class does NOT use NUnit lifecycle attributes.
///     Call <see cref="UmbracoIntegrationFixture.BuildAndStartHost"/> then <see cref="CreateTestDataAsync"/> to set up media.
/// </summary>
public abstract class UmbracoIntegrationFixtureWithMediaEditing : UmbracoIntegrationFixture
{
    ...
    /// <summary>
    ///     Creates the default test media structure.
