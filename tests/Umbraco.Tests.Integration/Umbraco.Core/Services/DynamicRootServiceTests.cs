...
internal sealed class DynamicRootServiceTests : UmbracoIntegrationTest
{
    ...
    public async Task SetupContentStructure()
    {
        ...
        await ContentService.SaveAsync(ContentYears, Constants.Security.SuperUserKey, null, CancellationToken.None);
        ...
        await ContentService.SaveAsync(ContentYear2022, Constants.Security.SuperUserKey, null, CancellationToken.None);
        ...
        await ContentService.SaveAsync(ContentActs2022, Constants.Security.SuperUserKey, null, CancellationToken.None);
        ...
        await ContentService.SaveAsync(ContentAct2022RanD, Constants.Security.SuperUserKey, null, CancellationToken.None);
        ...
        await ContentService.SaveAsync(ContentStages2022, Constants.Security.SuperUserKey, null, CancellationToken.None);
        ...
        await ContentService.SaveAsync(ContentStage2022Red, Constants.Security.SuperUserKey, null, CancellationToken.None);
        ...
        await ContentService.SaveAsync(ContentStage2022Blue, Constants.Security.SuperUserKey, null, CancellationToken.None);
        ...
        await ContentService.SaveAsync(ContentYear2023, Constants.Security.SuperUserKey, null, CancellationToken.None);
        ...
        await ContentService.SaveAsync(ContentYear2024, Constants.Security.SuperUserKey, null, CancellationToken.None);

        Trashed = ContentBuilder.CreateSimpleContent(ContentTypeYears, "Text Page Deleted", -20);
        Trashed.Trashed = true;
        await ContentService.SaveAsync(Trashed, Constants.Security.SuperUserKey, null, CancellationToken.None);
    }
    ...
    public async Task GetDynamicRootsAsync_NearestDescendantOrSelf_FindsOnlyNearest()
    {
        ...
        await ContentService.SaveAsync(contentNewActs, Constants.Security.SuperUserKey, null, CancellationToken.None);
        ...
        await ContentService.SaveAsync(contentNewAct, Constants.Security.SuperUserKey, null, CancellationToken.None);
