...
public partial class ContentPublishingServiceTests : UmbracoIntegrationTestWithContent
{
    ...
    public async Task Can_UnSchedule_Publish_Invariant()
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(schedules.GetSchedule(Constants.System.InvariantCulture, ContentScheduleAction.Release).Any(), Is.False);
            Assert.That(schedules.GetSchedule(Constants.System.InvariantCulture, ContentScheduleAction.Expire).Any(), Is.True);
    ...
    public async Task Can_Unschedule_Publish_All_Cultures()
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(schedules.GetSchedule(setupInfo.LangEn.IsoCode, ContentScheduleAction.Release).Any(), Is.False);
            Assert.That(schedules.GetSchedule(setupInfo.LangDa.IsoCode, ContentScheduleAction.Release).Any(), Is.False);
            Assert.That(schedules.GetSchedule(setupInfo.LangBe.IsoCode, ContentScheduleAction.Release).Any(), Is.False);
