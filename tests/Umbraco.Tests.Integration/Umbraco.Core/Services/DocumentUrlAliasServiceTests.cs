...
internal sealed class DocumentUrlAliasServiceTests : UmbracoIntegrationTest
{
    ...
    public async Task SetupTestData()
    {
        ...
        await ContentService.SaveAsync(PageWithSingleAlias, -1, null, CancellationToken.None);
        ...
        await ContentService.SaveAsync(PageWithMultipleAliases, -1, null, CancellationToken.None);
        ...
        await ContentService.SaveAsync(PageWithNoAlias, -1, null, CancellationToken.None);
    ...
    public async Task CreateOrUpdateAliasesAsync_Creates_Alias_For_New_Document()
    {
        ...
        await ContentService.SaveAsync(newPage, -1, null, CancellationToken.None);
    ...
    public async Task CreateOrUpdateAliasesWithDescendantsAsync_Updates_Document_And_Descendants()
    {
        ...
        await ContentService.SaveAsync(parentContent, -1, null, CancellationToken.None);
    ...
    public async Task RebuildAllAliasesAsync_Handles_Empty_Database()
    {
        ...
        await ContentService.SaveAsync(content1, -1, null, CancellationToken.None);
        ...
        await ContentService.SaveAsync(content2, -1, null, CancellationToken.None);
        ...
        await ContentService.SaveAsync(content3, -1, null, CancellationToken.None);
    ...
    [Test]
    public async Task GetDocumentKeysByAliasAsync_Finds_Invariant_Content_For_Any_Culture()
    {
        ...
        var result = await DocumentUrlAliasService.GetDocumentKeysByAliasAsync("my-single-alias", "fr-FR");
    ...
    [Test]
    public async Task Invariant_Content_Stores_Null_LanguageId()
    {
    ...
    [Test]
    public async Task Variant_Content_Stores_Specific_LanguageId()
    {
    ...
    public async Task CreateOrUpdateAliasesAsync_Ignores_Draft_Alias_Colliding_With_Published_Alias_On_Another_Document()
    {
        ...
        await ContentService.SaveAsync(pageB, -1, null, CancellationToken.None);
    ...
    public async Task CreateOrUpdateAliasesAsync_Ignores_Draft_Alias_Edit_On_Published_Variant_Culture()
    {
        ...
        await ContentService.SaveAsync(draftContent, -1, null, CancellationToken.None);
