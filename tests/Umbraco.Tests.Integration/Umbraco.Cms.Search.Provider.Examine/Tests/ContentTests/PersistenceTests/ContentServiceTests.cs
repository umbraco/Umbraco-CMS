...
public class ContentServiceTests : UmbracoIntegrationTest
{
    ...
    public async Task TestSetup(bool publish)
    {
        ...
        {
            Attempt<ContentCreateResult, ContentEditingOperationStatus> createRootResult = await ContentEditingService.CreateAsync(rootCreateModel, global::Umbraco.Cms.Core.Constants.Security.SuperUserKey);
