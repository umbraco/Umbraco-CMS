...
public abstract class UmbracoTestServerFixtureBase : UmbracoIntegrationTestBase
{
    ...
    /// </summary>
    protected void BuildAndStartWebApplication()
    {
    ...
    /// </summary>
    protected void DisposeClientAndFactory()
    {
        Client?.Dispose();
    ...
    private IHostBuilder CreateHostBuilder()
    {
        IHostBuilder hostBuilder = Host.CreateDefaultBuilder()
            ...
            .ConfigureWebHost(builder =>
            {
                ...
                // call startup
                WebHostBuilderExtensions.Configure(builder, (Action<IApplicationBuilder>)Configure);
            })
