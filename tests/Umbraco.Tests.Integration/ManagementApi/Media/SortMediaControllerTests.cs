...
{
    protected override Expression<Func<SortMediaController, object>> MethodSelector => x => x.Sort(null);
    ...
    protected override async Task<HttpResponseMessage> ClientRequest()
    {
        ...
        {
            ParentId = null, Sorting = new[] { new ItemSortingRequestModel { Id = Guid.Empty, SortOrder = 1 } }
        };
