...
public class AncestorsMediaItemControllerTests : ManagementApiUserGroupTestBase<AncestorsMediaItemController>
{
    ...
    protected override Expression<Func<AncestorsMediaItemController, object>> MethodSelector =>
        x => x.Ancestors(CancellationToken.None, new HashSet<Guid> { _mediaKey });
