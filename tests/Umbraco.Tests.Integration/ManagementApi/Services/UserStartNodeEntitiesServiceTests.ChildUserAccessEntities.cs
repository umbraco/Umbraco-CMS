...
public partial class UserStartNodeEntitiesServiceTests
{
    ...
    {
        var contentStartNodePaths = await CreateUserAndGetStartNodePaths(ItemsByName["1-1"].Id, ItemsByName["1-10"].Id);
    ...
    {
        var contentStartNodePaths = await CreateUserAndGetStartNodePaths(ItemsByName["3-3"].Id);
    ...
    {
        var contentStartNodePaths = await CreateUserAndGetStartNodePaths(ItemsByName["3-3-3"].Id, ItemsByName["3-3-4"].Id);
    ...
    {
        var contentStartNodePaths = await CreateUserAndGetStartNodePaths(ItemsByName["3-3-3"].Id, ItemsByName["3-5-3"].Id);
    ...
    {
        var contentStartNodePaths = await CreateUserAndGetStartNodePaths(ItemsByName["3-3"].Id, ItemsByName["3-2"].Id, ItemsByName["3-1"].Id);
