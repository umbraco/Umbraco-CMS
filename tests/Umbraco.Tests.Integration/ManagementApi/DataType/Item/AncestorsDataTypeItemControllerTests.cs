...
public class AncestorsDataTypeItemControllerTests : ManagementApiUserGroupTestBase<AncestorsDataTypeItemController>
{
    ...
    protected override Expression<Func<AncestorsDataTypeItemController, object>> MethodSelector =>
        x => x.Ancestors(CancellationToken.None, new HashSet<Guid> { _dataTypeKey });
