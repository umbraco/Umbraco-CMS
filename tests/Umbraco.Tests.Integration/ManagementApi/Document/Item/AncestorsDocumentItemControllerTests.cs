...
public class AncestorsDocumentItemControllerTests : ManagementApiUserGroupTestBase<AncestorsDocumentItemController>
{
    ...
    protected override Expression<Func<AncestorsDocumentItemController, object>> MethodSelector =>
        x => x.Ancestors(CancellationToken.None, new HashSet<Guid> { _contentKey });
