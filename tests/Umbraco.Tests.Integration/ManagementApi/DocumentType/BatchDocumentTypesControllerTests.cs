...
public class BatchDocumentTypesControllerTests : ManagementApiUserGroupTestBase<BatchDocumentTypesController>
{
    ...
    protected override Expression<Func<BatchDocumentTypesController, object>> MethodSelector =>
