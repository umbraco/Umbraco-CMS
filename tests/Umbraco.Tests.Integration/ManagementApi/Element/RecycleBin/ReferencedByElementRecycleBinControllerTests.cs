...
public class ReferencedByElementRecycleBinControllerTests : ElementRecycleBinControllerTestBase<ReferencedByElementRecycleBinController>
{
    ...
    protected override Expression<Func<ReferencedByElementRecycleBinController, object>> MethodSelector =>
        x => x.ReferencedBy(CancellationToken.None, 0, 20);
