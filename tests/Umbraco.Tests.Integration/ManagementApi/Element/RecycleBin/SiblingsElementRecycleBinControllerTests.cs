...
public class SiblingsElementRecycleBinControllerTests : ElementRecycleBinControllerTestBase<SiblingsElementRecycleBinController>
{
    ...
    public async Task Setup()
    {
        ...
        Assert.That(response1.Success, Is.True, $"Failed to create element 1: {response1.Status}");
        ...
        Assert.That(response2.Success, Is.True, $"Failed to create element 2: {response2.Status}");
        ...
        Assert.That(moveResult1.Success, Is.True, $"Failed to move element 1 to recycle bin: {moveResult1.Result}");
        ...
        Assert.That(moveResult2.Success, Is.True, $"Failed to move element 2 to recycle bin: {moveResult2.Result}");
    }
