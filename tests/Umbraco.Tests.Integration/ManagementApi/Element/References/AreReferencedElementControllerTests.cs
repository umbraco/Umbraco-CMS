...
public class AreReferencedElementControllerTests : ManagementApiUserGroupTestBase<AreReferencedElementController>
{
    ...
    protected override Expression<Func<AreReferencedElementController, object>> MethodSelector =>
        x => x.GetPagedReferencedItems(CancellationToken.None, new HashSet<Guid> { _elementKey }, 0, 20);
