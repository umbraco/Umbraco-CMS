...
public class ByKeyElementControllerTests : ManagementApiUserGroupTestBase<ByKeyElementController>
{
    ...
    protected override Expression<Func<ByKeyElementController, object>> MethodSelector =>
        x => x.ByKey(CancellationToken.None, _elementKey);
