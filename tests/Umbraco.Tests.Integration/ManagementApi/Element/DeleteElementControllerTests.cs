...
public class DeleteElementControllerTests : ManagementApiUserGroupTestBase<DeleteElementController>
{
    ...
    public async Task Setup()
    {
        ...
        // Create a new element for each test since delete removes it
    ...
    protected override Expression<Func<DeleteElementController, object>> MethodSelector =>
        x => x.Delete(CancellationToken.None, _elementKey);
