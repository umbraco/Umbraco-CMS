...
public class AncestorsElementItemControllerTests : ManagementApiUserGroupTestBase<AncestorsElementItemController>
{
    ...
    protected override Expression<Func<AncestorsElementItemController, object>> MethodSelector =>
        x => x.Ancestors(CancellationToken.None, new HashSet<Guid> { _elementKey });
