...
public class ValidateUpdateElementControllerTests : ManagementApiUserGroupTestBase<ValidateUpdateElementController>
{
    ...
    protected override Expression<Func<ValidateUpdateElementController, object>> MethodSelector =>
        x => x.Validate(CancellationToken.None, _elementKey, null!);
    ...
    protected override async Task<HttpResponseMessage> ClientRequest()
    {
        ...
        return await Client.PutAsync(Url, JsonContent.Create(validateModel));
    }
}
