...
public class BatchMemberTypesControllerTests : ManagementApiUserGroupTestBase<BatchMemberTypesController>
{
    ...
    protected override Expression<Func<BatchMemberTypesController, object>> MethodSelector =>
