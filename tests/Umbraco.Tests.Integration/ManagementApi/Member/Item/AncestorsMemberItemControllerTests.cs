...
public class AncestorsMemberItemControllerTests : ManagementApiUserGroupTestBase<AncestorsMemberItemController>
{
    ...
    protected override Expression<Func<AncestorsMemberItemController, object>> MethodSelector =>
        x => x.Ancestors(CancellationToken.None, new HashSet<Guid> { _memberKey });
