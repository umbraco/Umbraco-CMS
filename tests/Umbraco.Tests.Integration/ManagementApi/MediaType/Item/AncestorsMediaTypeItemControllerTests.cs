...
public class AncestorsMediaTypeItemControllerTests : ManagementApiUserGroupTestBase<AncestorsMediaTypeItemController>
{
    ...
    protected override Expression<Func<AncestorsMediaTypeItemController, object>> MethodSelector =>
        x => x.Ancestors(CancellationToken.None, new HashSet<Guid> { _mediaTypeKey });
