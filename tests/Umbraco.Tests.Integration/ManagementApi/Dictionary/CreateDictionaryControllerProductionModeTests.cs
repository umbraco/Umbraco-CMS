...
public class CreateDictionaryControllerProductionModeTests : ManagementApiTest<CreateDictionaryController>
{
    protected override Expression<Func<CreateDictionaryController, object>> MethodSelector { get; set; }
    ...
    {
        CreateDictionaryItemRequestModel createModel =
