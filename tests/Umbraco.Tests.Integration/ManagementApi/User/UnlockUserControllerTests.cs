...
{
    protected override Expression<Func<UnlockUserController, object>> MethodSelector => x => x.UnlockUsers(null);
    ...
    {
        UnlockUsersRequestModel unlockUsersRequestModel = new() { UserIds = new HashSet<Guid> { Guid.Empty } };
