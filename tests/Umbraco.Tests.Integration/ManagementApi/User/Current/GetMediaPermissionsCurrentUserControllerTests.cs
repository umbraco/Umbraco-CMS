...
{
    protected override Expression<Func<GetMediaPermissionsCurrentUserController, object>> MethodSelector => x => x.GetPermissions(CancellationToken.None, new HashSet<Guid> { Guid.Empty });
