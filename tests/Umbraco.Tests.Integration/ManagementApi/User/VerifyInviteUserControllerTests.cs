...
{
    protected override Expression<Func<VerifyInviteUserController, object>> MethodSelector => x => x.Invite(null);
    ...
    {
        VerifyInviteUserRequestModel verifyInviteUserRequestModel = new() { UserId = Guid.Empty, Token = string.Empty };
