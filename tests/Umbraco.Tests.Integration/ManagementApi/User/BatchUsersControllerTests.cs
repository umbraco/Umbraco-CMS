...
public class BatchUsersControllerTests : ManagementApiUserGroupTestBase<BatchUsersController>
{
    ...
    protected override Expression<Func<BatchUsersController, object>> MethodSelector =>
        x => x.Batch(CancellationToken.None, new HashSet<Guid>());

    protected override async Task<HttpResponseMessage> ClientRequest()
        => await Client.GetAsync($"{Url}?id={_userKey}");
