...
{
    protected override Expression<Func<InviteUserController, object>> MethodSelector => x => x.Invite(null);
    ...
    {
        InviteUserRequestModel inviteUserRequestModel = new() { Message = "Welcome to Umbraco!", };
