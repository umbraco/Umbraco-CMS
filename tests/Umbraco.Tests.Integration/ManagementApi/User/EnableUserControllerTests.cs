...
{
    protected override Expression<Func<EnableUserController, object>> MethodSelector => x => x.EnableUsers(null);
    ...
    {
        EnableUserRequestModel enableUserRequestModel = new() { UserIds = new HashSet<Guid> { Guid.Empty } };
