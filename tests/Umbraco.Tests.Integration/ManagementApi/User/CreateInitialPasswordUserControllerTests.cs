...
{
    protected override Expression<Func<CreateInitialPasswordUserController, object>> MethodSelector => x => x.CreateInitialPassword(null);
    ...
    {
        CreateInitialPasswordUserRequestModel createInitialPasswordUserRequest = new() { Password = "password", };
