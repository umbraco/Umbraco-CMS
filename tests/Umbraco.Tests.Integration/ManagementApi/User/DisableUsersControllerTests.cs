...
{
    protected override Expression<Func<DisableUserController, object>> MethodSelector => x => x.DisableUsers(null);
    ...
    {
        DisableUserRequestModel disableUserRequestModel = new() { UserIds = new HashSet<Guid> { Guid.Empty } };
