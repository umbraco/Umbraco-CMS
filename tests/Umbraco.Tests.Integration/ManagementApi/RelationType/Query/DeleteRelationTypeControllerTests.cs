...
public class DeleteRelationTypeControllerTests : ManagementApiUserGroupTestBase<DeleteRelationTypeController>
{
    protected override Expression<Func<DeleteRelationTypeController, object>> MethodSelector =>
