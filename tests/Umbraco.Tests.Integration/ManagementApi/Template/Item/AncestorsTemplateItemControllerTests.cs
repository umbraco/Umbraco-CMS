...
public class AncestorsTemplateItemControllerTests : ManagementApiUserGroupTestBase<AncestorsTemplateItemController>
{
    ...
    protected override Expression<Func<AncestorsTemplateItemController, object>> MethodSelector =>
        x => x.Ancestors(CancellationToken.None, new HashSet<Guid> { _templateKey });
