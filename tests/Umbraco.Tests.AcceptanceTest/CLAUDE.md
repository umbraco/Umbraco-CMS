...
- A disallowed file extension on any Upload editor (File, Vector Graphics, Article, Audio, Video) is rejected with **no visible feedback whatsoever** — no error message, no notification, just an empty dropzone.
