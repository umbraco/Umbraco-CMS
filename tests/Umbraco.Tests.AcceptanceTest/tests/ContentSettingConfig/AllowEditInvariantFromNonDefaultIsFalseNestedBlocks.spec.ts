...
const matrixCases: ReadonlyArray<{
  ...
  {outerBlockList: true,  outerElement: false, innerBlockList: false, innerElement: true,  text: true,  daEditable: false},
  {outerBlockList: true,  outerElement: false, innerBlockList: false, innerElement: true,  text: false, daEditable: false},
