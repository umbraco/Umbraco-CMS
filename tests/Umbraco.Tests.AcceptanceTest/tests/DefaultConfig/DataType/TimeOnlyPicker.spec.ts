...
const propertyEditorName = 'Time Only';
const customDataTypeName = 'Custom Time Only';
const editorAlias = 'Umbraco.TimeOnly';
const editorUiAlias = 'Umb.PropertyEditorUi.TimeOnlyPicker';
...
test('can create a time only data type', async ({umbracoApi, umbracoUi}) => {
  // Act
