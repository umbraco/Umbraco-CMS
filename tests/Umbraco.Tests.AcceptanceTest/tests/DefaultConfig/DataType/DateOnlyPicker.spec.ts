...
const propertyEditorName = 'Date Only';
const customDataTypeName = 'Custom Date Only';
const editorAlias = 'Umbraco.DateOnly';
const editorUiAlias = 'Umb.PropertyEditorUi.DateOnlyPicker';
...
test('can create a date only data type', async ({umbracoApi, umbracoUi}) => {
  // Act
