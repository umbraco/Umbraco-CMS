...
const propertyEditorName = 'Email';
const customDataTypeName = 'Custom Email Address';
const editorAlias = 'Umbraco.EmailAddress';
const editorUiAlias = 'Umb.PropertyEditorUi.EmailAddress';
...
test('can create an email address data type', async ({umbracoApi, umbracoUi}) => {
  // Act
