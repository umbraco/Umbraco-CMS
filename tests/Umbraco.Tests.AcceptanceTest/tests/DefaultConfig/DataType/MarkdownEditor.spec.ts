...
const propertyEditorName = 'Markdown Editor';
const customDataTypeName = 'Custom Markdown Editor';
const editorAlias = 'Umbraco.MarkdownEditor';
const editorUiAlias = 'Umb.PropertyEditorUi.MarkdownEditor';
...
test('can create a markdown editor data type', async ({umbracoApi, umbracoUi}) => {
  // Act
