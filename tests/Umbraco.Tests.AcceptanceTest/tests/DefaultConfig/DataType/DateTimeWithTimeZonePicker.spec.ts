...
const propertyEditorName = 'Date Time (with time zone)';
const customDataTypeName = 'Custom Date Time With Time Zone';
const editorAlias = 'Umbraco.DateTimeWithTimeZone';
const editorUiAlias = 'Umb.PropertyEditorUi.DateTimeWithTimeZonePicker';
...
test('can create a date time with time zone data type', async ({umbracoApi, umbracoUi}) => {
  // Act
