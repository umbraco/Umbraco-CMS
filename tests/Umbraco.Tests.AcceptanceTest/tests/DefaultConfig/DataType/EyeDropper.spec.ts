...
const propertyEditorName = 'Eye Dropper Color Picker';
const customDataTypeName = 'Custom Eye Dropper';
const editorAlias = 'Umbraco.ColorPicker.EyeDropper';
const editorUiAlias = 'Umb.PropertyEditorUi.EyeDropper';
...
test('can create an eye dropper color picker data type', async ({umbracoApi, umbracoUi}) => {
  // Act
