...
test.describe('Media Type Folder tests', () => {
  ...
  test('can create a empty media type folder', async ({page, umbracoApi, umbracoUi}) => {
    // Act
    ...
    expect(umbracoUi.mediaType.isUniqueTreeItemVisible(mediaTypeFolderName)).toBeTruthy();
  });

  test('can delete a media type folder', async ({page, umbracoApi, umbracoUi}) => {
    // Arrange
  ...
  test('can rename a media type folder', async ({page, umbracoApi, umbracoUi}) => {
    // Arrange
    ...
    await umbracoUi.mediaType.clickRenameFolderThreeDotsButton();
  ...
  test.skip('can create a media type folder in a folder', async ({page, umbracoApi, umbracoUi}) => {
    // Arrange
