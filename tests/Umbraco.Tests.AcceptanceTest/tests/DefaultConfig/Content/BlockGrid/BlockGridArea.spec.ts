...
test.skip('can create content with block grid area with min allowed', {annotation: {type: 'issue', description: "Skip this test due to this issue: https://github.com/umbraco/Umbraco-CMS/issues/22121"}}, async ({umbracoApi, umbracoUi}) => {
  // Arrange
...
test.skip('can create content with block grid area with max allowed', {annotation: {type: 'issue', description: "Skip this test due to this issue: https://github.com/umbraco/Umbraco-CMS/issues/22121"}}, async ({umbracoApi, umbracoUi}) => {
  // Arrange
  const secondElementTypeId = await umbracoApi.documentType.createEmptyElementType(secondElementTypeName);
  const maxAllowed = 0;
...
test.skip('can create content with a block grid area with specified allowance with min allowed', {annotation: {type: 'issue', description: "Skip this test due to this issue: https://github.com/umbraco/Umbraco-CMS/issues/22121"}}, async ({umbracoApi, umbracoUi}) => {
  // Arrange
  const secondElementTypeId = await umbracoApi.documentType.createEmptyElementType(secondElementTypeName);
  const minAllowed = 2;
...
test.skip('can create content with a block grid area with specified allowance with max allowed', {annotation: {type: 'issue', description: "Skip this test due to this issue: https://github.com/umbraco/Umbraco-CMS/issues/22121"}}, async ({umbracoApi, umbracoUi}) => {
  // Arrange
  const secondElementTypeId = await umbracoApi.documentType.createEmptyElementType(secondElementTypeName);
  const maxAllowed = 1;
