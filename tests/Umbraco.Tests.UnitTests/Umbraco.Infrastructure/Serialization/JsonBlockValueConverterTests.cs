...
public class JsonBlockValueConverterTests
{
    ...
    public void Can_Serialize_BlockGrid_With_Blocks()
    {
        ...
        Assert.That(layoutItems[0].Areas, Has.Length.EqualTo(1));
        Assert.That(layoutItems[0].Areas[0].Items, Has.Length.EqualTo(1));
        ...
        Assert.That(layoutItems[0].Areas[0].Items[0].Areas, Has.Length.EqualTo(1));
        Assert.That(layoutItems[0].Areas[0].Items[0].Areas[0].Items, Has.Length.EqualTo(1));
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(deserialized.ContentData[0].ContentTypeAlias, Is.Empty); // explicitly annotated to be ignored by the serializer
            ...
            Assert.That(deserialized.ContentData[1].ContentTypeAlias, Is.Empty);
            ...
            Assert.That(deserialized.ContentData[2].ContentTypeAlias, Is.Empty);
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(deserialized.SettingsData[0].ContentTypeAlias, Is.Empty);
            ...
            Assert.That(deserialized.SettingsData[1].ContentTypeAlias, Is.Empty);
            ...
            Assert.That(deserialized.SettingsData[2].ContentTypeAlias, Is.Empty);
            ...
            Assert.That(deserialized.SettingsData[3].ContentTypeAlias, Is.Empty);
        });
    }
    ...
    public void Can_Serialize_BlockList_With_Blocks()
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(deserialized.ContentData.First().ContentTypeAlias, Is.Empty); // explicitly annotated to be ignored by the serializer
            ...
            Assert.That(deserialized.ContentData.Last().ContentTypeAlias, Is.Empty);
        });
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(deserialized.SettingsData.First().ContentTypeAlias, Is.Empty);
            ...
            Assert.That(deserialized.SettingsData.Last().ContentTypeAlias, Is.Empty);
        });
    }
    ...
    public void Can_Serialize_Richtext_With_Blocks()
    {
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(deserializedBlocks.ContentData.First().ContentTypeAlias, Is.Empty); // explicitly annotated to be ignored by the serializer
            ...
            Assert.That(deserializedBlocks.ContentData.Last().ContentTypeAlias, Is.Empty);
        });
        ...
        Assert.Multiple(() =>
        {
            ...
            Assert.That(deserializedBlocks.SettingsData.First().ContentTypeAlias, Is.Empty);
            ...
            Assert.That(deserializedBlocks.SettingsData.Last().ContentTypeAlias, Is.Empty);
        });
    }
...
""";
   ...
   ""settingsData"":[
        ...
        Assert.That(deserialized, Is.Not.Null);
        Assert.That(deserialized.ContentData, Has.Count.EqualTo(1));
        Assert.That(deserialized.ContentData[0].Values, Is.Empty);

        Assert.That(deserialized.Expose, Has.Count.EqualTo(1));
        Assert.That(deserialized.Expose[0].ContentKey, Is.EqualTo(Guid.Parse("6ad18441631140d48515ea0fc5b00425")));
        Assert.That(deserialized.Expose[0].Culture, Is.Null);
        Assert.That(deserialized.Expose[0].Segment, Is.Null);
    }
   ...
   ""expose"":[
        ...
        Assert.That(deserialized, Is.Not.Null);
        Assert.That(deserialized.ContentData, Has.Count.EqualTo(1));
        Assert.That(deserialized.Expose, Is.Empty);
    }
}
