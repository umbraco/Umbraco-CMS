...
public class BulkDataReaderTests
{
    ...
    public void ColumnMappingsTest()
    {
        using (var testReader = new BulkDataReaderSubclass())
        {
            ...
            Assert.That(columnMappings, Is.Not.Empty);
        ...
        using (var testReader = new BulkDataReaderSubclass())
        {
            ...
            for (var currentColumn = 0; currentColumn < testReader.FieldCount; currentColumn++)
            {
                ...
                Assert.That(
                    ...
                    Is.EqualTo(testReader.GetDataTypeName(currentColumn)));
            }
        }
    }
        ...
        using (var testReader = new BulkDataReaderSubclass())
        {
            ...
            for (var currentColumn = 0; currentColumn < testReader.FieldCount; currentColumn++)
            {
                ...
                Assert.That(
                    ...
                    Is.EqualTo(testReader.GetFieldType(currentColumn)));
            }
        }
    }
    ...
    public void GetOrdinalTest()
    {
        using (var testReader = new BulkDataReaderSubclass())
        {
            ...
            for (var currentColumn = 0; currentColumn < testReader.FieldCount; currentColumn++)
            {
                ...
                Assert.That(
                    currentColumn,
                    Is.EqualTo(testReader.GetOrdinal(testReader.GetName(currentColumn).ToUpperInvariant())));
            }
        }
    }
    ...
    public void GetSchemaTableTest()
    {
        using (var testReader = new BulkDataReaderSubclass())
        {
            ...
            Assert.That(schemaTable, Is.Not.Null);
            Assert.That(schemaTable.Rows, Is.Not.Empty);
        ...
        using (var testReader = new BulkDataReaderSubclass())
        {
            ...
            for (var column = 0; column < BulkDataReaderSubclass.ExpectedResultSet.Count; column++)
            {
                Assert.That(
                    ...
                    Is.EqualTo(testReader[testReader.GetName(column)]));

                Assert.That(
                    BulkDataReaderSubclass.ExpectedResultSet[column],
                    Is.EqualTo(testReader[testReader.GetName(column).ToUpperInvariant()]));
            }
            ...
            // GetValues
            {
                ...
                Assert.That(values, Has.Length.EqualTo(testReader.GetValues(values)));
            ...
            // Typed getters
            {
                ...
                Assert.That(
                    ...
                    Is.EqualTo(testReader.GetInt64(currentColumn)));
                currentColumn++;
                {
                ...
                Assert.That(
                    BulkDataReaderSubclass.ExpectedResultSet[currentColumn],
                    Is.EqualTo(testReader.GetBoolean(currentColumn)));
                currentColumn++;

                Assert.That(
                    BulkDataReaderSubclass.ExpectedResultSet[currentColumn] == null,
                    Is.EqualTo(testReader.IsDBNull(currentColumn)));
                currentColumn++;

                Assert.That(
                    BulkDataReaderSubclass.ExpectedResultSet[currentColumn],
                    Is.EqualTo(testReader.GetChar(currentColumn)));
                currentColumn++;
                ...
                Assert.That(
                    BulkDataReaderSubclass.ExpectedResultSet[currentColumn],
                    Is.EqualTo(testReader.GetString(currentColumn)));
                {
                    var expectedResult =
                ...
                Assert.That(
                    BulkDataReaderSubclass.ExpectedResultSet[currentColumn],
                    Is.EqualTo(testReader.GetDateTime(currentColumn)));
                currentColumn++;
                ...
                Assert.That(
                    BulkDataReaderSubclass.ExpectedResultSet[currentColumn],
                    Is.EqualTo(testReader.GetDateTimeOffset(currentColumn)));
                currentColumn++;
                ...
                Assert.That(
                    BulkDataReaderSubclass.ExpectedResultSet[currentColumn],
                    Is.EqualTo(testReader.GetDecimal(currentColumn)));
                currentColumn++;

                Assert.That(
                    BulkDataReaderSubclass.ExpectedResultSet[currentColumn],
                    Is.EqualTo(testReader.GetDouble(currentColumn)));
                currentColumn++;
                {
                    var expectedResult = (byte[])BulkDataReaderSubclass.ExpectedResultSet[currentColumn];
                    var expectedLength = expectedResult.Length;
                ...
                Assert.That(
                    BulkDataReaderSubclass.ExpectedResultSet[currentColumn],
                    Is.EqualTo(testReader.GetInt32(currentColumn)));
                currentColumn++;
                ...
                Assert.That(
                    BulkDataReaderSubclass.ExpectedResultSet[currentColumn],
                    Is.EqualTo(testReader.GetFloat(currentColumn)));
                currentColumn++;
                ...
                Assert.That(
                    BulkDataReaderSubclass.ExpectedResultSet[currentColumn],
                    Is.EqualTo(testReader.GetInt16(currentColumn)));
                currentColumn++;
                ...
                Assert.That(
                    BulkDataReaderSubclass.ExpectedResultSet[currentColumn],
                    Is.EqualTo(testReader.GetTimeSpan(currentColumn)));
                currentColumn++;
                ...
                Assert.That(
                    BulkDataReaderSubclass.ExpectedResultSet[currentColumn],
                    Is.EqualTo(testReader.GetByte(currentColumn)));
                currentColumn++;

                Assert.That(
                    BulkDataReaderSubclass.ExpectedResultSet[currentColumn],
                    Is.EqualTo(testReader.GetValue(currentColumn)));
                currentColumn++;

                Assert.That(
                    BulkDataReaderSubclass.ExpectedResultSet[currentColumn],
                    Is.EqualTo(testReader.GetGuid(currentColumn)));
                currentColumn++;
                {
                    var expectedResult = (byte[])BulkDataReaderSubclass.ExpectedResultSet[currentColumn];
                    var expectedLength = expectedResult.Length;
