...
public class UserEditorAuthorizationHelperTests
{
        ...
        string groupToAdd)
    {
        ...
        {
            new ReadOnlyUserGroup(1, Guid.NewGuid(), "CurrentUser", "icon-user", null, null, null, groupAlias, new int[0], new string[0], new HashSet<string>(), new HashSet<IGranularPermission>(), true),
        });
