...
public class BuilderTests
{
    ...
    public UmbracoVersion UmbracoVersion { get; set; } = new UmbracoVersion(new SemVersionFactory());
    ...
    public void GenerateSimpleType()
    {
        ...
        var builder = new TextBuilder(modelsBuilderConfig, types, UmbracoVersion);

        var sb = new StringBuilder();
        builder.Generate(sb, builder.GetModelsToGenerate().First());
        var gen = sb.ToString();

        var version = UmbracoVersion.SemanticVersion;
        var expected = @"//------------------------------------------------------------------------------
// <auto-generated>
...
";
    ...
    public void GenerateInheritedType()
    {
        ...
        var modelsBuilderConfig = new ModelsBuilderSettings();
        var builder = new TextBuilder(modelsBuilderConfig, docTypes, UmbracoVersion);
...
";
    ...
    public void WriteClrType(string expected, Type input)
    {
        ...
        var builder = new TextBuilder(new ModelsBuilderSettings(), new List<TypeModel>(), UmbracoVersion) { ModelsNamespaceForTests = "ModelsNamespace" };
        var sb = new StringBuilder();
    ...
    public void WriteClrTypeUsing(string expected, Type input)
    {
        // note - these assertions differ from the original tests in MB because in the embedded version, the result of Builder.IsAmbiguousSymbol is always true
        // which means global:: syntax will be applied to most things
        var builder = new TextBuilder(new ModelsBuilderSettings(), new List<TypeModel>(), UmbracoVersion);
