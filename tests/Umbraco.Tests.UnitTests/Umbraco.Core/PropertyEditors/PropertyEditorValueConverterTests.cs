...
public class PropertyEditorValueConverterTests
{
    ...
    {
        var converter = new CheckboxListValueConverter(new DefaultJsonSerializer());
    ...
    public void CanConvertDropdownListMultiplePropertyEditor(object value, IEnumerable<string> expected)
    {
        ...
        var converter = new FlexibleDropdownPropertyValueConverter(new DefaultJsonSerializer());
