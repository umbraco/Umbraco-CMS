...
{
    private readonly DateOnlyValueConverter _dateOnlyValueConverter = new(_jsonSerializer);

    [TestCaseSource(nameof(_validateDateReceivedTestCases))]
    public void DateOnly_Validates_Date_Received(object? value, bool expectedSuccess)
    {
        var editor = CreateDateOnlyValueEditor();
    ...
    public void DateOnly_Can_Parse_Values_From_Editor(
        object? value,
        ...
        string? expectedTimeZone)
    {
        ...
        var result = CreateDateOnlyValueEditor().FromEditor(
        ...
        string[]? timeZones = null)
    {
        ...
        var valueEditor = new DateTime2PropertyEditorBase.DateTime2DataValueEditor<DateOnlyValueConverter>(
            Mock.Of<IShortStringHelper>(),
            _jsonSerializer,
            Mock.Of<IIOHelper>(),
            new DataEditorAttribute(Constants.PropertyEditors.Aliases.DateOnly),
            localizedTextServiceMock.Object,
            _dateOnlyValueConverter)
        {
