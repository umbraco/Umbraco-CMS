...
public class ConvertersTests
{
    ...
    public void SimpleConverter3Test()
    {
        ...
        var contentNode = CreateContentNode("Element 1", 1234, elementType1, new Dictionary<string, object> { { "prop1", "val1" } }, identityRootId: 5678);
    ...
    private ContentNode CreateContentNode(string name, int id, IPublishedContentType contentType, Dictionary<string, object> properties, int? identityRootId = null)
    {
        var contentData = new ContentData(
            ...
            cultureInfos: null);
        return new ContentNode(id, Guid.NewGuid(), 1, DateTime.Today, -1, contentType, contentData, contentData, identityRootId);
    }
