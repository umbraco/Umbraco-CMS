...
public class ConvertersTests
{
    ...
    public void SimpleConverter3Test()
    {
        ...
        Assert.That(
            ...
            Is.EqualTo(typeof(IEnumerable<PublishedSnapshotTestObjects.TestContentModel1>)));
        ...
        Assert.That(((PublishedSnapshotTestObjects.TestElementModel1)model1).OwningContentId, Is.EqualTo(5678));
        ...
        Assert.That(
            ...
            Is.InstanceOf<PublishedSnapshotTestObjects.TestContentModel1[]>());
        Assert.That(
            ((PublishedSnapshotTestObjects.TestContentModel1[])model2.Value(Mock.Of<IPublishedValueFallback>(), "prop2")),
