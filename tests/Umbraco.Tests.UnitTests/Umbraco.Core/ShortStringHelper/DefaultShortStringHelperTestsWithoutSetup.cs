...
public class DefaultShortStringHelperTestsWithoutSetup
{
    ...
    public void Utf8Surrogates()
    {
        ...
        Assert.That(str, Has.Length.EqualTo(6));
    ...
    public void CleanStringEncoding()
    {
        ...
        Assert.That(helper.CleanString("中文测试", CleanStringType.Alias), Is.Empty);
    ...
    public void CleanStringCasing()
    {
        ...
        Assert.That(
            helper.CleanString("aaa BBB CCc Ddd E FF", CleanStringType.Alias),
            Is.EqualTo("aaa BBB CCc Ddd E FF")); // unchanged
        Assert.That(
            helper.CleanString("aaa BBB CCc Ddd E FF", CleanStringType.Alias | CleanStringType.CamelCase),
            Is.EqualTo("aaa Bbb Ccc Ddd E FF"));
