...
public class ComponentTests
{
    ...
    public void BrokenRequire()
    {
        ...
        catch (Exception e)
        {
            Assert.That(
                e.Message,
                Is.EqualTo("Broken composer dependency: Umbraco.Cms.Tests.UnitTests.Umbraco.Core.Components.ComponentTests+Composer2 -> Umbraco.Cms.Tests.UnitTests.Umbraco.Core.Components.ComponentTests+Composer4."));
        }
    }
    ...
    public void AttributesPriorities()
    {
        ...
        Composed.Clear();
        composers.Compose();
        Assert.That(Composed, Is.Empty); // 26 gone
