...
public class ContentTests
{
    ...
    public void Variant_Culture_Names_Track_Dirty_Changes(string newName, bool expectedDirty)
    {
        ...
        Assert.That(
            content.IsPropertyDirty("CultureInfos"),
            Is.True); // now it will be changed since the collection has changed
    ...
    public void Can_Set_Culture_Info_With_Normalized_Culture_Code_Casing(string culture, string expectedCulture)
    {
        ...
        Assert.That(content.CultureInfos[culture].Culture, Is.EqualTo(expectedCulture));
    }
    ...
    public void Can_Set_Publish_Info_With_Normalized_Culture_Code_Casing(string culture, string expectedCulture)
    {
        ...
        Assert.That(content.PublishCultureInfos[culture].Culture, Is.EqualTo(expectedCulture));
    }
    ...
    public void Can_Clone_Content_With_Reset_Identity()
    {
        ...
        Assert.That(content.Id, Is.Not.SameAs(clone.Id));
        Assert.That(content.VersionId, Is.Not.SameAs(clone.VersionId));
    ...
    public void Can_Deep_Clone()
    {
        ...
        Assert.That(content.PublishedState, Is.EqualTo(clone.PublishedState));
        Assert.That(content.TemplateId, Is.Not.SameAs(clone.TemplateId));
