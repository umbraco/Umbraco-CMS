...
public class VariationTests
{
    ...
    public void ContentPublishValues()
    {
        ...
        // can publish value
        // and get edited and published values
        Assert.IsTrue(content.PublishCulture(CultureImpact.All, _propertyEditorCollection));
        Assert.AreEqual("a", content.GetValue("prop"));
        ...
        // can publish value
        // and get edited and published values
        Assert.IsFalse(content.PublishCulture(CultureImpact.Explicit(langFr, false), _propertyEditorCollection)); // no name
        content.SetCultureName("name-fr", langFr);
        Assert.IsTrue(content.PublishCulture(CultureImpact.Explicit(langFr, false), _propertyEditorCollection));
        ...
        Assert.IsNull(content.GetValue("prop"));
        Assert.IsNull(content.GetValue("prop", published: true));
        Assert.IsTrue(content.PublishCulture(CultureImpact.All, _propertyEditorCollection)); // publishes invariant props if any
        Assert.IsNull(content.GetValue("prop"));
        Assert.IsNull(content.GetValue("prop", published: true));
    ...
    public void ContentPublishValuesWithMixedPropertyTypeVariations()
    {
        ...
        Assert.IsTrue(
            content.PublishCulture(langFrImpact, _propertyEditorCollection)); // succeeds because names are ok (not validating properties here)
        Assert.IsFalse(
        ...
        Assert.IsTrue(content.PublishCulture(langFrImpact, _propertyEditorCollection)); // still ok...
    ...
    public void ContentPublishVariations()
    {
        ...
        Assert.IsFalse(content.PublishCulture(CultureImpact.Explicit(langFr, false), _propertyEditorCollection));
