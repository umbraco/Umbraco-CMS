...
public class RangeTests
{
    ...
    public void RangeInt32_ToString(int minimum, int maximum, string expected) =>
        Assert.That(new Range<int> { Minimum = minimum, Maximum = maximum }.ToString(), Is.EqualTo(expected));
    ...
    public void RangeDouble_ToString(double minimum, double maximum, string expected) =>
        Assert.That(new Range<double> { Minimum = minimum, Maximum = maximum }.ToString(), Is.EqualTo(expected));

    [TestCase(0, 0, "0")]
    [TestCase(0, 1, "0,1")]
    [TestCase(1, 1, "1")]
    public void RangeInt32_ToStringFormatRange(int minimum, int maximum, string expected) =>
        Assert.That(new Range<int> { Minimum = minimum, Maximum = maximum }.ToString("{0}", "{0},{1}", CultureInfo.InvariantCulture), Is.EqualTo(expected));

    [TestCase(0, 0.5, "0,0.5")]
    [TestCase(0.5, 0.5, "0.5")]
    [TestCase(0.5, 1, "0.5,1")]
    public void RangeDouble_ToStringFormatRange(double minimum, double maximum, string expected) =>
        Assert.That(new Range<double> { Minimum = minimum, Maximum = maximum }.ToString("{0}", "{0},{1}", CultureInfo.InvariantCulture), Is.EqualTo(expected));

    [TestCase(0, 0, "0,0")]
    [TestCase(0, 1, "0,1")]
    [TestCase(1, 1, "1,1")]
    public void RangeInt32_ToStringFormat(int minimum, int maximum, string expected) =>
        Assert.That(new Range<int> { Minimum = minimum, Maximum = maximum }.ToString("{0},{1}", CultureInfo.InvariantCulture), Is.EqualTo(expected));

    [TestCase(0, 0.5, "0,0.5")]
    [TestCase(0.5, 0.5, "0.5,0.5")]
    [TestCase(0.5, 1, "0.5,1")]
    public void RangeDouble_ToStringFormat(double minimum, double maximum, string expected) =>
        Assert.That(new Range<double> { Minimum = minimum, Maximum = maximum }.ToString("{0},{1}", CultureInfo.InvariantCulture), Is.EqualTo(expected));
    ...
    public void RangeInt32_IsValid(int minimum, int maximum, bool expected) =>
        Assert.That(new Range<int> { Minimum = minimum, Maximum = maximum }.IsValid(), Is.EqualTo(expected));
    ...
    public void RangeInt32_ContainsValue(int minimum, int maximum, int value, bool expected) =>
        Assert.That(new Range<int> { Minimum = minimum, Maximum = maximum }.ContainsValue(value), Is.EqualTo(expected));
    ...
    public void RangeInt32_IsInsideRange(int minimum1, int maximum1, int minimum2, int maximum2, bool expected) =>
        Assert.That(new Range<int> { Minimum = minimum1, Maximum = maximum1 }.IsInsideRange(new Range<int>
            {
                Minimum = minimum2,
                Maximum = maximum2,
            }), Is.EqualTo(expected));
    ...
    public void RangeInt32_EqualsValues(int minimum1, int maximum1, int minimum2, int maximum2, bool expected) =>
        Assert.That(new Range<int> { Minimum = minimum1, Maximum = maximum1 }.Equals(minimum2, maximum2), Is.EqualTo(expected));
}
