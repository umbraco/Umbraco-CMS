...
public class EntityTests
{
    ...
    public void Setting_Key_From_Empty_On_Existing_Entity_Succeeds()
    {
        ...
        // Assert
        Assert.That(content.Key, Is.EqualTo(keyFromDb));
    }
    ...
    public void Setting_Key_To_Empty_On_Existing_Entity_Does_Not_Throw()
    {
        ...
        var originalKey = content.Key;
        Assert.That(originalKey, Is.Not.EqualTo(Guid.Empty));
        Assert.That(content.HasIdentity, Is.True);
    ...
    public void ResetIdentity_Clears_Key_And_HasIdentity()
    {
        ...
        // Assert
        Assert.That(content.HasIdentity, Is.False);
        Assert.That(content.Id, Is.EqualTo(0));
    ...
    public void DeepCloneWithResetIdentities_Creates_Valid_Clone_Without_Identity()
    {
        ...
        Assert.That(clone.Id, Is.EqualTo(0));
        // After ResetIdentity, the Key should be auto-generated when accessed
        // (not the same as the original)
        Assert.That(clone.Key, Is.Not.EqualTo(originalKey));
    }
    ...
    public void Fake_Entity_With_Id_Minus_One_And_Empty_Key_Succeeds()
    {
        ...
        // Assert
        Assert.That(fakeContent, Is.Not.Null);
        Assert.That(fakeContent!.Id, Is.EqualTo(-1));
        Assert.That(fakeContent.HasIdentity, Is.True); // Id = -1 != 0, so HasIdentity is true
    }
    ...
    public void After_DeepClone_Can_Set_New_Key()
    {
        ...
        // Assert
        Assert.That(clone.Key, Is.EqualTo(newKey));
        Assert.That(clone.HasIdentity, Is.False);
    }
    ...
    public void Setting_Key_After_Id_When_Key_Was_AutoGenerated_Succeeds()
    {
        ...
        Assert.That(autoGeneratedKey, Is.Not.EqualTo(Guid.Empty));
        ...
        // Assert
        Assert.That(content.Key, Is.EqualTo(specificKey));
    }
    ...
    public void Cannot_Change_Key_After_Serialization_Roundtrip()
    {
        ...
        Assert.That(entity.HasIdentity, Is.True);
        ...
        Assert.That(deserialized.HasIdentity, Is.True);
