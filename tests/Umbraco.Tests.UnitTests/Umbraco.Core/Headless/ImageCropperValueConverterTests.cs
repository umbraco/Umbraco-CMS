...
public class ImageCropperValueConverterTests : PropertyValueConverterTests
{
    ...
    public void ImageCropperValueConverter_ConvertsValueToImageCropperValue()
    {
        ...
        Assert.AreEqual(typeof(HeadlessImageCropperValue), valueConverter.GetHeadlessPropertyValueType(publishedPropertyType.Object));
        ...
        var result = valueConverter.ConvertIntermediateToHeadlessObject(Mock.Of<IPublishedElement>(), publishedPropertyType.Object, PropertyCacheLevel.Element, inter, false) as HeadlessImageCropperValue;
