...
public class MultiNodeTreePickerValueConverterTests : PropertyValueConverterTests
{
    ...
    public void MultiNodeTreePickerValueConverter_InSingleMode_ConvertsValueToLink()
    {
        ...
        var valueConverter = new MultiNodeTreePickerValueConverter(PublishedSnapshotAccessor, Mock.Of<IUmbracoContextAccessor>(), Mock.Of<IMemberService>(), PublishedUrlProvider, new HeadlessContentNameProvider());
