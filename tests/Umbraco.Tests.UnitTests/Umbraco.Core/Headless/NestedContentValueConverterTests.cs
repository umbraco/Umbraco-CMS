...
public class NestedContentValueConverterTests : PropertyValueConverterTests
{
    ...
    private IHeadlessElementBuilder _headlessElementBuilder;
    ...
    public void SetupThis()
    {
        ...
        _headlessElementBuilder = new HeadlessElementBuilder(new HeadlessPropertyMapper());
        ...
        publishedPropertyType
            .Setup(p => p.ConvertInterToHeadlessObject(It.IsAny<IPublishedElement>(), PropertyCacheLevel.Element, It.IsAny<object>(), It.IsAny<bool>()))
        ...
        _nestedContentSingleValueConverter = new NestedContentSingleValueConverter(PublishedSnapshotAccessor, _publishedModelFactory, profilingLogger, _headlessElementBuilder);
        _nestedContentManyValueConverter = new NestedContentManyValueConverter(PublishedSnapshotAccessor, _publishedModelFactory, profilingLogger, _headlessElementBuilder);
    }

    [Test]
    public void NestedContentSingleValueConverter_HasSingleElementAsHeadlessType()
        => Assert.AreEqual(typeof(IHeadlessElement), _nestedContentSingleValueConverter.GetHeadlessPropertyValueType(Mock.Of<IPublishedPropertyType>()));
    ...
    public void NestedContentSingleValueConverter_WithOneItem_ConvertsItemToElement()
    {
        ...
        var result = _nestedContentSingleValueConverter.ConvertIntermediateToHeadlessObject(Mock.Of<IPublishedElement>(), _publishedPropertyType, PropertyCacheLevel.Element, nestedContentValue, false) as IHeadlessElement;
    ...
    {
        var result = _nestedContentSingleValueConverter.ConvertIntermediateToHeadlessObject(Mock.Of<IPublishedElement>(), _publishedPropertyType, PropertyCacheLevel.Element, null, false) as IHeadlessElement;

        Assert.IsNull(result);
    }

    [Test]
    public void NestedContentManyValueConverter_HasMultipleElementsAsHeadlessType()
        => Assert.AreEqual(typeof(IEnumerable<IHeadlessElement>), _nestedContentManyValueConverter.GetHeadlessPropertyValueType(Mock.Of<IPublishedPropertyType>()));
    ...
    {
        var nestedContentValue = "[{\"ncContentTypeAlias\": \"contentType1\",\"key\": \"1E68FB92-727A-4473-B10C-FA108ADCF16F\",\"prop1\": \"Hello, world\"}]";
        var result = _nestedContentManyValueConverter.ConvertIntermediateToHeadlessObject(Mock.Of<IPublishedElement>(), _publishedPropertyType, PropertyCacheLevel.Element, nestedContentValue, false) as IEnumerable<IHeadlessElement>;
    ...
    {
        var result = _nestedContentManyValueConverter.ConvertIntermediateToHeadlessObject(Mock.Of<IPublishedElement>(), _publishedPropertyType, PropertyCacheLevel.Element, null, false) as IHeadlessElement;
