...
public class ImageCropperValueConverterTests : PropertyValueConverterTests
{
    ...
    public void ImageCropperValueConverter_ConvertsValueToImageCropperValue()
    {
        ...
        Assert.AreEqual(typeof(ApiImageCropperValue), valueConverter.GetContentApiPropertyValueType(publishedPropertyType.Object));
        ...
        var result = valueConverter.ConvertIntermediateToContentApiObject(Mock.Of<IPublishedElement>(), publishedPropertyType.Object, PropertyCacheLevel.Element, inter, false) as ApiImageCropperValue;
