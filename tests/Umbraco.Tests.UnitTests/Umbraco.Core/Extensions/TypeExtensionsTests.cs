...
public class TypeExtensionsTests
{
    ...
    public void Can_Get_Public_Methods_Of_Class()
    {
        ...
        Assert.That(methods, Has.Length.EqualTo(3 + _publicObjectMethodNames.Length));
    ...
    public void Get_Public_Methods_Of_Class_Contains_Inherited_Methods()
    {
        ...
        Assert.That(methods, Has.Length.EqualTo(7 + _publicObjectMethodNames.Length));
    ...
    public void Can_Get_All_Methods_Of_Class()
    {
        ...
        Assert.That(methods, Has.Length.EqualTo(4 + _publicObjectMethodNames.Length + _nonPublicObjectMethodNames.Length));
    ...
    public void Get_All_Methods_Of_Class_Contains_Inherited_Methods()
    {
        ...
        Assert.That(methods, Has.Length.EqualTo(9 + _publicObjectMethodNames.Length + _nonPublicObjectMethodNames.Length));
