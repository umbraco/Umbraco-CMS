...
public class ModelTypeTests
{
    ...
    public void TypeFullNameTests()
    {
        ...
        Assert.That(
            ...
            Is.EqualTo($"System.Collections.Generic.IEnumerable`1[[System.Int32[], System.Private.CoreLib, Version={typeof(IEnumerable).Assembly.GetName().Version}, Culture=neutral, PublicKeyToken=7cec85d7bea7798e]]"));
    }
    ...
    public void ModelTypeMapTests()
    {
        ...
        Assert.That(
            ...
            Is.EqualTo("Umbraco.Cms.Tests.Common.Published.PublishedSnapshotTestObjects+TestElementModel1"));
        Assert.That(
        ...
        Assert.That(
            ...
            Is.EqualTo("System.Collections.Generic.IEnumerable`1[Umbraco.Cms.Tests.Common.Published.PublishedSnapshotTestObjects+TestElementModel1]"));
        Assert.That(
