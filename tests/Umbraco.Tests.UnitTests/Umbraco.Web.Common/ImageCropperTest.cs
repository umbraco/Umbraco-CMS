...
public class ImageCropperTest
{
    ...
    public void GetCropUrl_CropAliasTest()
    {
        ...
        Assert.That(
            urlString,
            Is.EqualTo(MediaPath + "?c=0.58729977382575338,0.055768992440203169,0,0.32457553600198386&w=100&h=100"));
    }
    ...
    public void GetCropUrlFurtherOptionsTest()
    {
        ...
        Assert.That(
            urlString,
            Is.EqualTo(MediaPath + "?f=0.80827067669172936,0.96&w=200&h=300&filter=comic&roundedcorners=radius-26|bgcolor-fff"));
    }
