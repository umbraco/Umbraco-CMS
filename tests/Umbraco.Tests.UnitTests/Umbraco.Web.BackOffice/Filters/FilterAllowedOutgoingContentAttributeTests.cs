...
public class FilterAllowedOutgoingContentAttributeTests
{
    ...
    public void Filter_On_Permissions()
    {
        ...
        {
            new(9876, 1, new[] { ActionBrowse.ActionLetter }.ToHashSet()),
            new(9876, 2, new[] { ActionBrowse.ActionLetter }.ToHashSet()),
            new(9876, 3, new[] { ActionBrowse.ActionLetter }.ToHashSet()),
            new(9876, 4, new[] { ActionUpdate.ActionLetter }.ToHashSet()),
        };
