        ...
        IBuildPropertyTypes
{
    ...
    public static ContentType CreateAllTypesContentType(string alias, string name)
    {
        ...
        return (ContentType)builder
            ...
            .WithDataTypeKey(Constants.DataTypes.Guids.CheckboxGuid)
            ...
            .WithDataTypeKey(Constants.DataTypes.Guids.DatePickerWithTimeGuid)
            ...
            .WithDataTypeId(-37)
            .WithDataTypeKey(Constants.DataTypes.Guids.ApprovedColorGuid)
            ...
            .WithDataTypeKey(Constants.DataTypes.Guids.DropdownMultipleGuid)
            ...
            .WithDataTypeId(-40)
            .WithDataTypeKey(Constants.DataTypes.Guids.RadioboxGuid)
            ...
            .WithDataTypeKey(Constants.DataTypes.Guids.DropdownGuid)
            .WithPropertyEditorAlias(Constants.PropertyEditors.Aliases.DropDownListFlexible)
            .WithValueStorageType(ValueStorageType.Integer)
            .WithSortOrder(14)
            .Done()
            ...
            .WithDataTypeId(-43)
            .WithDataTypeKey(Constants.DataTypes.Guids.CheckboxListGuid)
            ...
            .WithDataTypeId(1047)
            .WithDataTypeKey(Constants.DataTypes.Guids.MemberPickerGuid)
            ...
            .WithDataTypeId(1050)
            .WithDataTypeKey(Constants.DataTypes.Guids.RelatedLinksGuid)
