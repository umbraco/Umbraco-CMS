...
<head>
    ...
    <link href="../../../umbraco_client/tinymce/plugins/advimage/css/advimage.css" rel="stylesheet"
        type="text/css" />
    <base target="_self" />
    ...
    <script language="javascript">
        ...
        function updateImageSource(src, alt, width, height) {
            ...
            var orgWidth = width;
            var maxWidth = parseInt(tinyMCE.settings["umbracoMaximumDefaultImageWidth"]);
    ...
    <div class="tabs">
        <ul>
            <li id="general_tab" class="current"><span><a href="javascript:mcTabs.displayTab('general_tab','general_panel');"
                onmousedown="return false;">{$lang_advimage_tab_general}</a></span></li>
            <li id="appearance_tab"><span><a href="javascript:mcTabs.displayTab('appearance_tab','appearance_panel');"
                onmousedown="return false;">{$lang_advimage_tab_appearance}</a></span></li>
            <li id="advanced_tab"><span><a href="javascript:mcTabs.displayTab('advanced_tab','advanced_panel');"
                onmousedown="return false;">{$lang_advimage_tab_advanced}</a></span></li>
        </ul>
    </div>
            ...
            <fieldset>
                ...
                <table class="properties">
                    ...
                    <tr id="imagelistsrcrow">
                        <td class="column1">
                            <label for="imagelistsrc">
                                {$lang_image_list}</label>
                        </td>
                        <td colspan="2" id="imagelistsrccontainer">
                            &nbsp;
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="column1">
                            <label id="alignlabel" for="align">
                                {$lang_insert_image_align}</label>
                        </td>
                        <td>
                            <select id="align" name="align" onchange="changeAppearance();">
                    ...
                    <tr>
                        <td class="column1">
                            <label id="widthlabel" for="width">
                                {$lang_insert_image_dimensions}</label>
                        </td>
                        <td nowrap="nowrap">
                            <input name="width" type="text" id="width" value="" size="5" maxlength="5" onchange="changeHeight();" />
                            x
                            <input name="height" type="text" id="height" value="" size="5" maxlength="5" onchange="changeWidth();" />
                            px
                        </td>
                    </tr>
                    <tr>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <label id="constrainlabel" for="constrain">
                                            {$lang_advimage_constrain_proportions}</label>
                                    </td>
                                </tr>
                            </table>
                        </td>
                    ...
                    <tr>
                        <td class="column1">
                            <label id="vspacelabel" for="vspace">
                                {$lang_insert_image_vspace}</label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td class="column1">
                            <label id="hspacelabel" for="hspace">
                                {$lang_insert_image_hspace}</label>
                        </td>
                        <td>
                    ...
                    <tr>
                        <td class="column1">
                            <label id="borderlabel" for="border">
                                {$lang_insert_image_border}</label>
                        </td>
                        <td>
                            <input id="border" name="border" type="text" value="" size="3" maxlength="3" onchange="changeAppearance();updateStyle();" />
                        </td>
                    </tr>
                    <tr>
                        <td>
                            <label id="classlabel" for="classlist">
                                {$lang_class_name}</label>
                        </td>
                        <td colspan="2">
                    ...
                    <tr>
                        <td class="column1">
                            <label id="stylelabel" for="style">
                                {$lang_advimage_style}</label>
                        </td>
                        <td colspan="2">
                            <input id="style" name="style" type="text" value="" onchange="styleUpdated();" />
                        </td>
                    </tr>
                    <!-- <tr>
        ...
        <div id="advanced_panel" class="panel">
            <fieldset>
                ...
                <label id="onmousemovechecklabel" for="onmousemovecheck">
                    {$lang_advimage_alt_image}</label>
                <table border="0" cellpadding="4" cellspacing="0" width="100%">
                    <tr>
                        <td class="column1">
                            <label id="onmouseoversrclabel" for="onmouseoversrc">
                                {$lang_advimage_mouseover}</label>
                        </td>
                        <td>
                            <table border="0" cellspacing="0" cellpadding="0">
                                <tr>
                    ...
                    <tr id="imagelistoverrow">
                        <td class="column1">
                            <label for="imagelistover">
                                {$lang_image_list}</label>
                        </td>
                        <td id="imagelistovercontainer">
                            &nbsp;
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr id="imagelistoutrow">
                        <td class="column1">
                            <label for="imagelistout">
                                {$lang_image_list}</label>
                        </td>
                        <td id="imagelistoutcontainer">
                            &nbsp;
                        </td>
                    </tr>
                </table>
